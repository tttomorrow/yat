...
drop table if exists datatype_tbl1;
create table datatype_tbl1 as select c_id,c_integer,null null_add1 from all_datatype_tbl01 union all select distinct c_id,c_integer,null null_add2 from all_datatype_tbl02;

select * from  datatype_tbl1 order by 1,2;
