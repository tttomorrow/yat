-- @testpoint: DQL语法，测试count distinct：多个列+多个distinct
...
drop table if exists datatype_tbl8;
create table datatype_tbl8 as select distinct count(distinct c_real) c1, count(distinct c_real) c2 from all_datatype_tbl;

select * from datatype_tbl8 order by 1;

drop table all_datatype_tbl;
drop table datatype_tbl8;