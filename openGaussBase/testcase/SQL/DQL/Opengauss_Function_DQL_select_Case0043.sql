-- @testpoint: DQL语法，结合内部操作符、内建函数、连接等
...
select distinct trunc(VARIANCE(distinct b.c3),-10), sum(distinct a.sal*a.deptno+100) from t_agg_join_003 a right join t_agg_join_004 b on a.id=b.id group by b.c2 order by 1,2;
