-- @testpoint: DQL语法，结合create table as select distinct：多个列
...
drop table if exists datatype_tbl2;
create table datatype_tbl2 as select distinct c_id,c_char,c_interval from all_datatype_tbl;
select * from datatype_tbl2;
