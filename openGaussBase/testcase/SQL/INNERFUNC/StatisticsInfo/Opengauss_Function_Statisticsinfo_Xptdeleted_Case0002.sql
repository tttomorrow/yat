...
select pg_stat_get_xact_partition_tuples_deleted(99999999999998789) from pg_partition  a, pg_class b where a.relname = 'sys_p2' and b.oid=a.parentid and b.relname='sales';
