...
"""
Case Type   : 功能测试
Case Name   : strpos函数入参为特殊字符
Description : 
    1.使用strpos函数对特殊字符进行处理
Expect      : 
    1.返回结果正确
History     : 
"""
...
class Function(unittest.TestCase):
    ...
    def setUp(self):
        logger.info("--------Opengauss_Function_Innerfunc_Strpos_Case0006.py开始执行--------")
    ...
    def tearDown(self):
        logger.info('--------Opengauss_Function_Innerfunc_Strpos_Case0006.py执行结束--------')