...
"""
Case Type   : 功能测试
Case Name   : strpos函数入参为中文字符
Description : 
    1.使用strpos函数对中文字符进行处理
Expect      : 
    1.返回结果正确
History     : 
"""
...
class Function(unittest.TestCase):
    ...
    def setUp(self):
        logger.info("--------Opengauss_Function_Innerfunc_Strpos_Case0005.py开始执行--------")
    ...
    def test_right(self):
        ...
        sql_cmd = "SELECT strpos('大吉大利万事胜意','胜');"
        result = ["19", "7"]
    ...
    def tearDown(self):
        logger.info('--------Opengauss_Function_Innerfunc_Strpos_Case0005.py执行结束--------')