...
"""
Case Type   : 功能测试
Case Name   : substrb函数入参是中文类型
Description : 
    1.使用substrb函数对中文字符进行处理
Expect      : 
    1.返回结果正确
History     : 
"""
...
class Function(unittest.TestCase):
    ...
    def setUp(self):
        logger.info("--------Opengauss_Function_Innerfunc_Substrb_Case0012.py开始执行--------")
    ...
    def test_right(self):
        ...
        sql_cmd = ["SELECT substrb('伟大祖国万岁',1);",
                   "SELECT substrb('伟大祖国万岁',7);",
                   "SELECT substrb('伟大祖国万岁',10);"]
        result = ["伟大祖国万岁", "祖国万岁", "国万岁"]
    ...
    def tearDown(self):
        logger.info('--------Opengauss_Function_Innerfunc_Substrb_Case0012.py执行结束--------')
