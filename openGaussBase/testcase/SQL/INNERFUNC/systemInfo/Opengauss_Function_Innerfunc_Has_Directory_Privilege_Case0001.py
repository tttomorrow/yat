...
"""
Case Type   : 功能测试
Case Name   : has_directory_privilege函数，将directory对象的特定权限赋予指定的角色
Description :
    1. 创建用户，赋予权限
...
class Function(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info('''---
        Opengauss_Function_Innerfunc_Has_Directory_Privilege_Case0001开始---''')
    ...
    def tearDown(self):
        ...
        self.log.info('''---
        Opengauss_Function_Innerfunc_Has_Directory_Privilege_Case0001结束---''')
