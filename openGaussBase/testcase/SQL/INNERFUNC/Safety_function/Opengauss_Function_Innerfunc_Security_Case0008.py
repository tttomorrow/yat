...
class Function(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info('-Opengauss_Function_Innerfunc_Security_Case0008开始-')
    ...
    def tearDown(self):
        ...
        self.log.info('-Opengauss_Function_Innerfunc_Security_Case0008结束-')
