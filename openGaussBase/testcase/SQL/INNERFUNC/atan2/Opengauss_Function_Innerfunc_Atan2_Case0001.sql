...
select atan2(f1,f2),atan2(f2,f3),atan2(f3,f4),atan2(f4,f5),atan2(f5,f1) from atan2_test_01;
select atan2(f6,f7),atan2(f7,f8),atan2(f8,f9),atan2(f9,f10),atan2(f10,f11),atan2(f11,f6) from atan2_test_01;
drop table if exists atan2_test_01;