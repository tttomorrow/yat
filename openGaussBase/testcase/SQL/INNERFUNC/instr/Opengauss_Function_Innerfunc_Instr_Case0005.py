...
class Function(unittest.TestCase):
    ...
    def setUp(self):
        logger.info('-Opengauss_Function_Innerfunc_Instr_Case0005.py开始执行-')
    ...
    def test_right(self):
        ...
        for i in range(2):
            ...
            cmd1 = f'source {self.DB_ENV_PATH};' \
                f'gsql -d aaa -p {self.userNode.db_port} -c "{sql_cmd}" '
    ...
    def tearDown(self):
        logger.info('-Opengauss_Function_Innerfunc_Instr_Case0005.py执行结束-')
