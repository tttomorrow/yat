...
'''
#--  @date:2020/9/17
#--  @testpoint:创建Thesaurus词典,子词典名定义多个，合理报错
'''
...
class Hostname(unittest.TestCase):
    ...
    def setUp(self):
        logger.info("------------------------Opengauss_BaseFunc_Full_Text_Search_dictionary_0025开始执行--------------------------")
    ...
    def test_directoary_1(self):
        ...
        SqlMdg = commonsh.execut_db_sql(f'''CREATE TEXT SEARCH DICTIONARY thesaurus_astro (
                                      ...
                                      Dictionary = pg_catalog.english_stem,pg_catalog.russian_stem,
    ...
    def tearDown(self):
        ...
        logger.info('------------------------Opengauss_BaseFunc_Full_Text_Search_dictionary_0025执行结束--------------------------')
