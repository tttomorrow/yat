...
"""
Case Type   : 全文检索
Case Name   : 创建Thesaurus词典,词典文件定义的sample words中，含有子词典中定义
              的停用词，合理报错
Description :
    1.创建thesaurus_astro.ths文件并定义了短语及其同义词
    2.创建词典
Expect      :
    1.创建成功
    2.合理报错
...
class Dictionary(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        logger.info(msg1)
        logger.info(
            '----Opengauss_Function_Dictionary_Case0027执行结束---')
