...
class Privategrant(unittest.TestCase):
    def setUp(self):
        logger.info('------------------------Opengauss_Function_Alter_System_Set_Case0007开始执行-----------------------------')
    ...
    def test_common_user_permission(self):
        ...
        sql_cmd = self.commonsh.execut_db_sql('''
                                            ...
                                            ALTER SYSTEM SET  enable_global_stats to off;
                                            ''')
        logger.info(sql_cmd)
    ...
    def tearDown(self):
        ...
        logger.info('------------------------Opengauss_Function_Alter_System_Set_Case0007执行结束--------------------------')