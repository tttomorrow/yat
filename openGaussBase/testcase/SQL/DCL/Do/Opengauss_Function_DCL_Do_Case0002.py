...
'''
--- Case Type： Do
--- Case Name： 执行匿名代码块，指定解析代码的程序语言为sql，合理报错
'''
...
class DCL_Do_test(unittest.TestCase):
    ...
    def test_dcl_do(self):
        ...
        logger.info("======指定解析代码的程序语言为sql，利用do执行代码块======")
        sql_cmd2 = f'''
                    do language sql
                    \$\$
                    declare
    ...
    def tearDown(self):
        ...
        logger.info(msg3)
        logger.info('---------------Opengauss_Function_DCL_Do_Case0002执行结束---------------')