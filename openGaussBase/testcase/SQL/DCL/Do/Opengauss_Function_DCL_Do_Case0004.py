...
'''
--- Case Type： Do
--- Case Name： 执行匿名代码块，指定解析代码的程序语言为c，合理报错
'''
...
class DCL_Do_test(unittest.TestCase):
    ...
    def test_dcl_do(self):
        ...
        logger.info("======指定解析代码的程序语言为c，利用do执行代码块======")
        sql_cmd2 = f'''
                    do language c
                    \$\$
                    declare
    ...
    def tearDown(self):
        ...
        logger.info(msg3)
        logger.info('---------------Opengauss_Function_DCL_Do_Case0004执行结束---------------')