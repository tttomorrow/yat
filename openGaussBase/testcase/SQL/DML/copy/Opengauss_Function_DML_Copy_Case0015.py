...
class CopyFile(unittest.TestCase):
    def setUp(self):
        logger.info('----------------------------Opengauss_Function_DML_Copy_Case0015开始执行-----------------------------')
    ...
    def tearDown(self):
        ...
        logger.info('------------------Opengauss_Function_DML_Copy_Case0015执行完成-----------------------------')
