...
"""
Case Type   : 拷贝数据
Case Name   : copy from模式下copy_option指定time_format参数
Description :
    1.创建测试表并插入数据
    2.构造数据文件
...
class CopyFile(unittest.TestCase):
    def setUp(self):
        ...
        self.tb_name = 't_copy_126'
        self.file_name = 'testcopy126.dat'
    ...
    def test_copy_file(self):
        ...
        sql_cmd = f"drop table if exists {self.tb_name};" \
            ...
            f"(001,'sk1','tt1','04:02:11');" \
            f"insert into {self.tb_name} values " \
            f"(002,'sk2','tt2','05:03:23');" \
            f"insert into {self.tb_name} values " \
            f"(003,'sk3','tt3','06:04:33');"
