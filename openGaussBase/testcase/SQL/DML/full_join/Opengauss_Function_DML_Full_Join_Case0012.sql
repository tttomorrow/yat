-- @testpoint:使用join...on语句，on条件为char和date类型比较，合理报错
...
--查询
select t1.c_char,t1.c_date,t2.c_char,t2.c_date from zsharding_tbl t1 full join zsharding_tbl t2 on t1.c_char=t2.c_date order by 1,2,3,4;
