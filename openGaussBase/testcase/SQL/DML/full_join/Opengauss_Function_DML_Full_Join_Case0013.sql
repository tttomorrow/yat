-- @testpoint: 使用join...on语句，on条件为整数和char类型比较，合理报错
--建表
...
--查询
select t1.c_integer,t1.c_char,t2.c_integer,t2.c_char from zsharding_tbl t1 full join zsharding_tbl t2 on t1.c_integer=t2.c_char order by 1,2,3,4;
--删表
drop table if exists zsharding_tbl;