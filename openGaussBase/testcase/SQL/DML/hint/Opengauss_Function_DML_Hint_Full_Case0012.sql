-- @testpoint:带一个FULL和INDEX hint语句查询该表的字段

drop index if exists idx;
create index idx on hint1_index_00000(id) local;
select /*+FULL(hint1_index_00000)*/ /*+INDEX(idx)*/ count(*) from hint1_index_00000 t1 right join hint1_index_00000 t2 on t1.id=t2.id
