-- @testpoint:explain plan语句结合merge语句和when match,not match中update语句使用 (不支持)，合理报错
...
--使用explain plan语句，合理报错，ERROR:  Subquery in WHERE clauses are not yet supported for MERGE INTO
