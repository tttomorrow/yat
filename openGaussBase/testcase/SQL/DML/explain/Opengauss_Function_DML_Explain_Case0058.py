...
"""
Case Type   : explain
Case Name   : explain使用参数plan,参数默认值为on
Description :
    1.建表
    2.向表中插入数据
    3.explain使用参数plan,参数默认值为on
    4.查询系统表plan_table数据
    5.清理环境
Expect      :
    1.建表成功
...
class SQL(unittest.TestCase):
    def setUp(self):
        ...
        self.table = 'explain_param_plan_0058'
