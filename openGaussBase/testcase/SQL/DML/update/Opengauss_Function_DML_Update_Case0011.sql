...
--修改数据
update all_datatype_tbl t1 set (c_integer,c_varchar) =(select count(c_integer) c1,count(c_varchar) c2 from all_datatype_tbl t2 where  t1.c_integer=t2.c_integer+1);
