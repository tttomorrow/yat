...
class SYS_Operation(unittest.TestCase):
    def setUp(self):
        logger.info('------------------------Opengauss_Function_DML_Set_Case0017开始执行-----------------------------')
    ...
    def test_set(self):
        ...
        # 设置时区为UTC;查看时区;查看时间
        sql_cmd2 = commonsh.execut_db_sql('''set time zone UTC;
                                      show time zone;
                                      select now(); ''')
    ...
    def tearDown(self):
        ...
        logger.info('------------------------Opengauss_Function_DML_Set_Case0017执行结束--------------------------')
