...
class SYS_Operation(unittest.TestCase):
    def setUp(self):
        logger.info('------------------------Opengauss_Function_DML_Set_Case0108开始执行-----------------------------')
    ...
    def test_analyze(self):
       ...
       insert into customer_info values(generate_series(1,2000),'a');''')
        ...
        # 使用analyze分别加表名和列名信息
        sql_cmd2 = commonsh.execut_db_sql('''analyze verbose customer_info;
    ...
    def tearDown(self):
        ...
        logger.info('------------------------Opengauss_Function_DML_Set_Case0108执行结束--------------------------')
