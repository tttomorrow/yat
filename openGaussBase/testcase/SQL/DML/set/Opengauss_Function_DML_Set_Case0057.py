...
"""
'''
--  @testpoint:VACUUM回收空间并更新统计信息，按顺序添加关键字full和analyze
'''
import sys
import unittest
...
class SYS_Operation(unittest.TestCase):
    def setUp(self):
        logger.info('------------------------Opengauss_Function_DML_Set_Case0057开始执行-----------------------------')
    ...
    def tearDown(self):
        ...
        logger.info('------------------------Opengauss_Function_DML_Set_Case0057执行结束--------------------------')
