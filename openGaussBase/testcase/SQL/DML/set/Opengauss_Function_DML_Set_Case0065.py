...
"""
'''
--  @testpoint:vacuum full analyze分析具体字段名称
'''
import sys
import unittest
...
class SYS_Operation(unittest.TestCase):
    def setUp(self):
        logger.info('------------------------Opengauss_Function_DML_Set_Case0065开始执行-----------------------------')
    ...
    def test_vacuum(self):
        ...
        # 分别插入数据，删除创建，执行vacuum后，查看系统表信息，行数更新为4001
        ...
        vacuum full analyze customer_info(WR_RETURNED_DATE_SK);
        select relpages,reltuples from pg_class where relname='customer_info';''')
    ...
    def tearDown(self):
        ...
        logger.info('------------------------Opengauss_Function_DML_Set_Case0065执行结束--------------------------')
