...
class SYS_Operation(unittest.TestCase):
    def setUp(self):
        logger.info('------------------------Opengauss_Function_DML_Set_Case0112开始执行-----------------------------')
    ...
    def test_analyze(self):
       ...
       CREATE TABLE customer_info(WR_RETURNED_DATE_SK INTEGER ,WR_RETURNED_TIME_name varchar(200));''')
        ...
        vacuum full analyze customer_info;
        vacuum full verbose analyze customer_info;
    ...
    def tearDown(self):
        ...
        logger.info(sql_cmd3)
        logger.info('------------------------Opengauss_Function_DML_Set_Case0112执行结束--------------------------')
