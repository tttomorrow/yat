...
'''
--  @date:2020/11/9
--  @testpoint:使用vacuum命令，依次按语法添加full，freeze，verbose参数
'''
import sys
import unittest
...
class SYS_Operation(unittest.TestCase):
    def setUp(self):
        logger.info('------------------------Opengauss_Function_DML_Set_Case0070开始执行-----------------------------')
    ...
    def test_vacuum(self):
      ...
      insert into customer_info values (generate_series(1,10),'a');''')
        ...
        # 查询表的xmin,xmax,age(xmin),txid_current()信息，将元组xmin设为2
        ...
        vacuum full freeze verbose customer_info;
    ...
    def tearDown(self):
        ...
        logger.info('------------------------Opengauss_Function_DML_Set_Case0070执行结束--------------------------')
