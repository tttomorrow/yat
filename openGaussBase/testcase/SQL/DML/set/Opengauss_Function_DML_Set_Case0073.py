...
'''
--  @date:2020/11/9
--  @testpoint:使用vacuum命令，依次按语法添加full，freeze，verbose参数加analyze verbose
'''
import sys
import unittest
...
class SYS_Operation(unittest.TestCase):
    def setUp(self):
        logger.info('------------------------Opengauss_Function_DML_Set_Case0073开始执行-----------------------------')
    ...
    def test_vacuum(self):
      ...
      insert into customer_info values (generate_series(1,10),'a');''')
        ...
        # 执行full freeze verbose analyze verbose,执行成功
        ...
        vacuum full freeze verbose analyze verbose customer_info;
    ...
    def tearDown(self):
        ...
        logger.info('------------------------Opengauss_Function_DML_Set_Case0073执行结束--------------------------')
