...
"""
'''
--  @testpoint:VACUUM回收空间，添加关键字full
'''
import sys
import unittest
...
class SYS_Operation(unittest.TestCase):
    def setUp(self):
        logger.info('------------------------Opengauss_Function_DML_Set_Case0063开始执行-----------------------------')
    ...
    def test_vacuum(self):
        ...
        sql_cmd2 = commonsh.execut_db_sql('''vacuum full customer_info;
    ...
    def tearDown(self):
        ...
        logger.info('------------------------Opengauss_Function_DML_Set_Case0063执行结束--------------------------')
