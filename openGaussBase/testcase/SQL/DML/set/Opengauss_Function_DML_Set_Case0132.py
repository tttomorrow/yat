...
'''
--  @date:2020/11/10
--  @testpoint:explain analyze语句分析delete语句
'''
import sys
import unittest
...
class SYS_Operation(unittest.TestCase):
    def setUp(self):
        logger.info('------------------------Opengauss_Function_DML_Set_Case0132开始执行-----------------------------')
    ...
    def test_explain(self):
      ...
      insert into my_table values(1,'Wiliian'),(2,'Nakli'),(3,'uisvc'),(4,'yuiy');''')
        ...
        sql_cmd2 = commonsh.execut_db_sql('''explain analyze delete from my_table  where id =4;
        start transaction;
        explain analyze VERBOSE delete from my_table  where id =3;
    ...
    def tearDown(self):
        ...
        logger.info('------------------------Opengauss_Function_DML_Set_Case0132执行结束--------------------------')
