...
class TransactionFile(unittest.TestCase):
    def setUp(self):
        logger.info('--------------------Opengauss_Function_DML_Transaction_Case0083开始执行--------------------')
    ...
    def test_transaction_file(self):
        ...
        sql_cmd = '''declare 
                        i varchar;
                      begin
                        i := gs_encrypt_aes128('MPPDB','haha@1234');
    ...
    def tearDown(self):
        ...
        logger.info('----------------------Opengauss_Function_DML_Transaction_Case0083执行完成--------------------')
