-- @testpoint: WITH RECURSIVE子句，使用INSERT ON DUPLICATE KEY UPDATE语句，合理报错
--建表
...
WITH RECURSIVE temp_t(id_1,name_1) AS (SELECT id,name FROM t_insert02) insert into t_insert02 values(1,'hello'),(1,'world') ON DUPLICATE KEY UPDATE name = 'hello';
--查询表，未插入数据
