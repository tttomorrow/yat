-- @testpoint: 对本地临时表创建触发器，不支持，合理报错
-- @modified at: 2020-12-15

----创建源表和触发表
DROP TABLE IF EXISTS test_trigger_src_tbl0;
DROP TABLE IF EXISTS test_trigger_des_tbl0;
CREATE LOCAL TEMPORARY TABLE  test_trigger_src_tbl0(id1 INT, id2 INT, id3 INT);
CREATE LOCAL TEMPORARY TABLE  test_trigger_des_tbl0(id1 INT, id2 INT, id3 INT);
