...
--创建触发器
CREATE CONSTRAINT TRIGGER insert_trigger01 AFTER INSERT ON test_trigger_src_tbl0 DEFERRABLE FOR EACH ROW EXECUTE PROCEDURE tri_insert_func01();
