-- @testpoint: AFTER--UPDATE在表上支持语句级触发器
--创建表
...
--创建触发器
CREATE TRIGGER update_trigger01 AFTER UPDATE ON test_trigger_src_tbl0 FOR EACH STATEMENT EXECUTE PROCEDURE tri_update_func01();
/
