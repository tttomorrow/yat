-- @testpoint: interval分区,预定义分区指定的表空间在STORE IN列表中,自动扩展分区使用的还是STORE IN中指定的表空间
...
(
partition table1_p2 values less than ('2020-04-01') tablespace tsp2,
partition table1_p3 values less than ('2020-05-01') tablespace tsp1
);
