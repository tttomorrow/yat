-- @testpoint: interval分区,ALTER TABLE MOVE PARTITION 将指定值所在分区移动至自定义表空间
...
alter table my_ptb1 move partition for ('2020-03-01') tablespace mytsp3;
alter table my_ptb1 move partition for ('2020-04-01') tablespace mytsp3;
alter table my_ptb1 move partition for ('2020-05-01') tablespace mytsp3;
