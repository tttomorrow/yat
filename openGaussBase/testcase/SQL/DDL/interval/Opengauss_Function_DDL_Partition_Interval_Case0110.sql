-- @testpoint: interval分区,EXCHANGE PARTITION普通表中的数据不满足指定分区的分区键范围，指定WITHOUT VALIDATION
...
-- exchange partition
alter table par_tb exchange partition (par_tb_p1) with table com_tb without validation;
