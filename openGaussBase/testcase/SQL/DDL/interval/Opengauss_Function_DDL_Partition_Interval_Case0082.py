...
"""
Case Type   : 功能测试
Case Name   : interval分区,ANALYZE PARTITION
Description :
    1. 创建表,插入数据
    2. analyze partition
Expect      :
...
class Function(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info('Opengauss_Function_DDL_Partition_Interval_Case0082开始')
    ...
    def test_copy(self):
        ...
        self.log.info('--步骤2 analyze partition--')
        cmd2 = 'analyze verbose test9 partition (test9_p1);'
        msg2 = self.commonsh.execut_db_sql(cmd2)
        self.log.info(msg2)
        self.assertTrue(msg2.find('ANALYZE') > -1)

    def tearDown(self):
        self.commonsh.execut_db_sql('drop table if exists test9;')
        self.log.info('Opengauss_Function_DDL_Partition_Interval_Case0082结束')