-- @testpoint: interval分区,MERGE PARTITIONS语法校验，分区数小于2或者合并后分区个数大于1合理报错
...
-- merge partitions
alter table pttb merge partitions pttb_p1 into partition pttb_p4;
alter table pttb merge partitions sys_p1, sys_p2 into partition sys_p4,sys_p5;
