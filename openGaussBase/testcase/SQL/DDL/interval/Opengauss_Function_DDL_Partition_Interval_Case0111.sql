-- @testpoint: interval分区,EXCHANGE PARTITION普通表中的数据不满足指定分区的分区键范围，指定WITH VALIDATION VERBOSE
...
insert into tb_p values (4,'ddd',4,'2020-03-01',false,'ddd',4.4);
insert into tb_p values (5,'eee',5,'2020-04-01',true,'eee',5.5);

-- tb_c插入数据
insert into tb_c values (1,'fff',1,'2019-12-31',true,'fff',1.1);
insert into tb_c values (2,'ggg',2,'2020-01-01',false,'ggg',2.2);
insert into tb_c values (3,'hhh',3,'2020-02-01',true,'hhh',3.3);
insert into tb_c values (4,'iii',4,'2020-03-01',false,'iii',4.4);
insert into tb_c values (5,'jjj',5,'2020-04-01',true,'jjj',5.5);
...
select * from tb_p partition (sys_p3)order by c4;
select * from tb_p partition (sys_p4)order by c4;
select * from tb_c;

alter table tb_p exchange partition (sys_p1) with table tb_c with validation verbose;
