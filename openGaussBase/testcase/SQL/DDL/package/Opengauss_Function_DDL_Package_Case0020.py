...
"""
Case Type   : PACKAGE
Case Name   : 非A风格数据库下package定义函数,合理报错
Description :
    1.创建B风格数据库
    2.新建数据库下声明package
    3.清理环境
...
class PACKAGE(unittest.TestCase):
    def setUp(self):
        ...
        self.Con = Constant()
        self.database = 'd_package_0020'
        self.package = 'p_test_0020'
        self.function = 'f_package_0020'
    ...
    def test_package(self):
        ...
        spec_package = self.primary_sh.execut_db_sql(
            ...
            function {self.function}(c_int integer) return integer ;
