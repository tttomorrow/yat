...
"""
Case Type   : 功能
Case Name   : 创建哈希索引后导出与恢复，检查HASH索引是否存在
Description :
    1.创建测试库和表并创建hash索引
    2.dump数据
    3.恢复数据
...
class DDL(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info('-Opengauss_Function_DDL_Hash_Index_Case0005start-')
        self.constant = Constant()
        self.primary_node = Node('PrimaryDbUser')
        self.pri_sh = CommonSH('PrimaryDbUser')
        self.tb_name = "t_hash_index_0005"
        self.id_name = "i_hash_index_0005"
        self.db_name = "db_hash_index_0005"
    ...
    def test_hash_index(self):
        ...
        text = '---step3:导入之前导出的数据;expect:导出成功-------'
        self.log.info(text)
        ...
        text = '--step4:查看hash索引;expect:索引存在--'
        self.log.info(text)
    ...
    def tearDown(self):
        ...
        self.log.info(msg)
        self.log.info('-Opengauss_Function_DDL_Hash_Index_Case0005finish--')
