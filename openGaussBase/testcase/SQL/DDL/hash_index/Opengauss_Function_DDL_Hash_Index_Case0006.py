...
"""
Case Type   : 功能
Case Name   : 创建哈希索引后dump，删除表后， 恢复数据
Description :
    1.创建测试库和表并创建hash索引
    2.dump数据
    3.删表
...
class DDL(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info('-Opengauss_Function_DDL_Hash_Index_Case0006start-')
        self.constant = Constant()
        self.primary_node = Node('PrimaryDbUser')
        self.pri_sh = CommonSH('PrimaryDbUser')
        self.tb_name = "t_hash_index_0006"
        self.id_name = "i_hash_index_0006"
        self.db_name = "db_hash_index_0006"
    ...
    def tearDown(self):
        ...
        self.log.info(msg)
        self.log.info('-Opengauss_Function_DDL_Hash_Index_Case0006finish--')
