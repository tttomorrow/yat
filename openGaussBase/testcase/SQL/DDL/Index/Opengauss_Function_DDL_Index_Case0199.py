...
"""
Case Type   : 功能测试
Case Name   : SYSTEM：重建数据库上所有系统表的索引
Description :
    1. 重建数据库上所有系统表的索引
Expect      :
    1. 合理报错，不支持
...
class Function(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info('''---Opengauss_Function_DDL_Index_Case0199开始---''')
    ...
    def test_copy(self):
        ...
        self.log.info(msg1)
        self.assertTrue(msg1.find('REINDEX') > -1)

    def tearDown(self):
        self.log.info('''---Opengauss_Function_DDL_Index_Case0199结束---''')