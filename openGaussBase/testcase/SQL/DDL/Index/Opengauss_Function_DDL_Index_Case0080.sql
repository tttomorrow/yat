--  @testpoint:column_name：列存分区表常用数据类型31列

DROP TABLE if EXISTS test_index_table_080 CASCADE;
create table test_index_table_080(
...
create index index_080_01 on test_index_table_080 using psort(c_float1,
...
select relname from pg_class where relname like 'index_080_%' order by relname;

--btree：合理报错
drop index if exists index_080_01;

create index index_080_01 on test_index_table_080 using btree(c_float1,
c_float2,c_float3,c_float4,c_float5,c_float6,c_float7,c_float8,c_float9,c_float10,c_float11,c_float12,
c_float13,c_float14,c_float15,c_float16,c_float17,c_float18,c_float19,c_float20,c_float21,c_float22,
c_float23,c_float24,c_float25,c_float26,c_float27,c_float28,c_float29,c_float30,c_float31);
...
create index index_080_01 on test_index_table_080 using gist(c_float1,
c_float2,c_float3,c_float4,c_float5,c_float6,c_float7,c_float8,c_float9,c_float10,c_float11,c_float12,
c_float13,c_float14,c_float15,c_float16,c_float17,c_float18,c_float19,c_float20,c_float21,c_float22,
c_float23,c_float24,c_float25,c_float26,c_float27,c_float28,c_float29,c_float30,c_float31);
...
create index index_080_01 on test_index_table_080 using gin(to_tsvector('english', c_float1),
