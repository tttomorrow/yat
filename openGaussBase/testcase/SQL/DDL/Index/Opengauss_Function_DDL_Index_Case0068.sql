--  @testpoint: column_name：行存普通表常用数据类型32列：successs
DROP TABLE if EXISTS test_index_table_068 CASCADE;
create table test_index_table_068(
c_int1 INTEGER,
c_int2 INTEGER,
c_int3 INTEGER,
c_int4 INTEGER,
...
--建psort索引
drop index if exists index_068_01;

create index index_068_01 on test_index_table_068(c_int1,
c_int2,
c_int3,
c_int4,
c_int5,
...
select relname from pg_class where relname like 'index_068_%' order by relname;

--btree
drop index if exists index_068_01;


create index index_068_01 on test_index_table_068 using btree(c_int1,
c_int2,
c_int3,
c_int4,
c_int5,
...
--gin
drop index if exists index_068_01;
drop index if exists index_068_02;
drop index if exists index_068_03;
drop index if exists index_068_04;
drop index if exists index_068_05;
drop index if exists index_068_06;
drop index if exists index_068_07;
drop index if exists index_068_08;
drop index if exists index_068_09;
drop index if exists index_068_10;

create index index_068_01 on test_index_table_068 using gin(to_tsvector('english', c_int1),
