...
class Concurrently(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tblname = 'ddl_index_case0219'
        self.tblname_no_rel = 'ddl_index_case0219_no_rel'
        self.idxname = 'ddl_index_case0219_idx'
        self.log.info('----------------------Opengauss_Function_DDL_Index_Case0219.py start-----------------------')
    ...
    def test_in_select(self):
        ...
        result = self.primary_sh.execut_db_sql(f'delete  FROM {self.tblname_no_rel} where id=712; ')
