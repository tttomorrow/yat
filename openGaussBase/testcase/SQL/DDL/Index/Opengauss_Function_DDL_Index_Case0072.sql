--  @testpoint: column_name：列存临时表常用数据类型32列：successs

DROP TABLE if EXISTS test_index_table_072 CASCADE;
create temporary table test_index_table_072(
c_int1 INTEGER,
c_int2 INTEGER,
c_int3 INTEGER,
c_int4 INTEGER,
...
--建psort索引
drop index if exists index_072_01;
create index index_072_01 on test_index_table_072(c_int1,
...
c_int23,c_int24,c_int25,c_int26,c_int27,c_int28,c_int29,c_int30,c_int31,c_int32);

select relname from pg_class where relname like 'index_072_%' order by relname;

--btree
drop index if exists index_072_01;
create index index_072_01 on test_index_table_072 using btree(c_int1,
c_int2,c_int3,c_int4,c_int5,c_int6,c_int7,c_int8,c_int9,c_int10,c_int11,c_int12,
c_int13,c_int14,c_int15,c_int16,c_int17,c_int18,c_int19,c_int20,c_int21,c_int22,
c_int23,c_int24,c_int25,c_int26,c_int27,c_int28,c_int29,c_int30,c_int31,c_int32);
...
--gist
drop index if exists index_072_01;
create index index_072_01 on test_index_table_072 using gist(c_int1,
c_int2,c_int3,c_int4,c_int5,c_int6,c_int7,c_int8,c_int9,c_int10,c_int11,c_int12,
c_int13,c_int14,c_int15,c_int16,c_int17,c_int18,c_int19,c_int20,c_int21,c_int22,
c_int23,c_int24,c_int25,c_int26,c_int27,c_int28,c_int29,c_int30,c_int31,c_int32);
...
--gin
drop index if exists index_072_01;
create index index_072_01 on test_index_table_072 using gin(to_tsvector('english', c_int1),
