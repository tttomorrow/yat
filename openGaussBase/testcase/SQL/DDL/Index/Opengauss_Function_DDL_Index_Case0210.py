...
class Concurrently(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tblname = 'ddl_index_case0210'
        self.idxname = 'ddl_index_case0210_idx'
        self.log.info(
            '------------------------------------Opengauss_Function_ddl_index_case0210.py start------------------------------------')
...
update {self.tblname} set first_name=\'测试查询不阻塞\', last_name=\'测试%%不阻塞\' where id = 712;')
        ...
        result = self.primary_sh.execut_db_sql(
            f'update {self.tblname} set first_name=\'测试 test 查询不阻塞\', last_name=\'测试--不阻塞\' where id = 712;')
