...
class Concurrently(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tblname = 'ddl_index_case0220'
        self.tblname_no_rel = 'ddl_index_case0220_no_rel'
        self.idxname = 'ddl_index_case0220_idx'
        self.log.info('------------------Opengauss_Function_ddl_index_case0220.py start---------------------')
    ...
    def test_in_select(self):
        ...
        result = self.primary_sh.execut_db_sql(
            f'insert into {self.tblname_no_rel} values(200000001,\'^c test 号\',\'\\test--\'); ')
        ...
        result = self.primary_sh.execut_db_sql(f'SET ENABLE_SEQSCAN=off;SELECT * FROM {self.tblname_no_rel} where id=200000001;')
        self.log.info(result)
