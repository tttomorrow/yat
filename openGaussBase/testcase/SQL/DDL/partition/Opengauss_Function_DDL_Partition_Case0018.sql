-- @testpoint: 范围分区表，删除分区，测试analyze收集统计信息功能

drop table if exists partition_range00024;
create table partition_range00024(
field1   integer,
field2   bigint,
field3   real,
field4   decimal(10,2),
...
begin
  loop
    i:=i+1;
insert into partition_range00024  values(256,10000000,123.3212,123456.123,12345633333333333333333333333333333333,'b','957',
'简自豪',lpad('345abc',50,'abc'),'151515',null,'2010-09-11 00:00:00',
...
/
ALTER TABLE partition_range00024 DROP PARTITION part01;
analyze verbose partition_range00024;
drop table if exists partition_range00024;