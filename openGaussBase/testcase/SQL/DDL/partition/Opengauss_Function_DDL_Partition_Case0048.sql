...
create index index_partition_range032  on partition_range032(field1,field7,field11,field12,field17) local;---多列局部索引
create index index_partition_range0321 on partition_range032(field19,field18,field11) local;---多列局部索引
...
analyze verbose  partition_range032 ;  --12月份只支持此命令
drop table if exists partition_range032;