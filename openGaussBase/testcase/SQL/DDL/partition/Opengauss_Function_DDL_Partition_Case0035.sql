-- @testpoint: 范围分区全部数据类型，测试多列索引空表的analyze功能

drop table if exists partition_range002;
create table partition_range002(
field1   integer,
field2   bigint,
field3   real,
field4   decimal(10,2),
...
create index index_partition_range002 on partition_range002(field1,field7,field11,field12,field17) local;
create index index_partition_range0021 on partition_range002(field10) local;
create index index_partition_range0022 on partition_range002(field19,field18,field11) local;

analyze verbose  partition_range002 ;
drop table if exists partition_range002;