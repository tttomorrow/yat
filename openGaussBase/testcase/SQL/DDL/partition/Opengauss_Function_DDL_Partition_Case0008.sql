-- @testpoint: 范围分区表，分区键为数值(timestamp with time zone)，测试analyze收集统计信息功能

drop table if exists partition_range00017;
create table partition_range00017(
field1   integer,
field2   bigint,
field3   real,
field4   decimal(10,2),
...
begin
  loop
    i:=i+1;
insert into partition_range00017  values(256,10000000,123.3212,123456.123,12345633333333333333333333333333333333,'b','957',
'简自豪',lpad('345abc',50,'abc'),'13515151',null,'2008-09-11 00:00:00',
...
analyze verbose  partition_range00017 ;
drop table partition_range00017;