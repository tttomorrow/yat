-- @testpoint: 范围分区全部数据类型，测试raw单列索引空表的analyze功能

drop table if exists PARTITION_RANGE013;
create table PARTITION_RANGE013(
field1   integer,
field2   bigint,
field3   real,
field4   decimal(10,2),
...
create index index_PARTITION_RANGE0137 on PARTITION_RANGE013(field19) local;
analyze verbose  PARTITION_RANGE013 ;
drop table if exists PARTITION_RANGE013;