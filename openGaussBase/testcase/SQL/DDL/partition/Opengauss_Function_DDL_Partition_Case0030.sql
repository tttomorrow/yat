-- @testpoint: 范围分区全部数据类型，测试二进制单列索引空表的analyze功能

drop table if exists PARTITION_RANGE011;
create table PARTITION_RANGE011(
field1   integer,
field2   bigint,
field3   real,
field4   decimal(10,2),
...
create index index_PARTITION_RANGE0116 on PARTITION_RANGE011(field18) local;
analyze verbose  PARTITION_RANGE011;
drop table if exists PARTITION_RANGE011;