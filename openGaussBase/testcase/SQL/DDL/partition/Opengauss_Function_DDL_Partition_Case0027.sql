-- @testpoint: 范围分区全部数据类型，测试lob单列索引空表的analyze功能

drop table if exists PARTITION_RANGE008;
create table PARTITION_RANGE008(
field1   integer,
field2   bigint,
field3   real,
field4   decimal(10,2),
...
create index index_PARTITION_RANGE0083 on PARTITION_RANGE008(field10) local;
analyze verbose  PARTITION_RANGE008 ;
drop table if exists PARTITION_RANGE008;