...
drop table if exists PARTITION_RANGE009;
create table PARTITION_RANGE009(
field1   integer,
field2   bigint,
field3   real,
field4   decimal(10,2),
...
create index index_PARTITION_RANGE0094 on PARTITION_RANGE009(field12) local;
analyze verbose  PARTITION_RANGE009;
drop table if exists PARTITION_RANGE009;