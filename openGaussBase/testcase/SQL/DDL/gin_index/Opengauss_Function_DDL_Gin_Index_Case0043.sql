--  @testpoint: create gin index:多字段索引(4)分区表
...
explain SELECT * FROM test_gin_student_column WHERE to_tsvector('english', data1) @@ to_tsquery('english', 'Mexico') and  to_tsvector('english', data2) @@ to_tsquery('english', 'Mexico') and to_tsvector('english', test2) @@ to_tsquery('english', 'China');
SELECT * FROM test_gin_student_column WHERE to_tsvector('english', data1) @@ to_tsquery('english', 'Mexico') and  to_tsvector('english', data2) @@ to_tsquery('english', 'Mexico') and to_tsvector('english', test2) @@ to_tsquery('english', 'China');
explain SELECT * FROM test_gin_student_column WHERE to_tsvector('english', data1) @@ to_tsquery('english', 'Mexico') and  to_tsvector('english', data2) @@ to_tsquery('english', 'Mexico') and to_tsvector('english', test2) @@ to_tsquery('english', 'Mexico');
SELECT * FROM test_gin_student_column WHERE to_tsvector('english', data1) @@ to_tsquery('english', 'Mexico') and  to_tsvector('english', data2) @@ to_tsquery('english', 'Mexico') and to_tsvector('english', test2) @@ to_tsquery('english', 'Mexico');
