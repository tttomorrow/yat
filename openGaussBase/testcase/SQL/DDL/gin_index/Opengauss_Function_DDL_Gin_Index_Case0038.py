...
"""
Case Type   : 功能
Case Name   : 分区表创建索引后dump，删除表， 恢复数据
Description :
...
class set_search_limit(unittest.TestCase):
    ...
    dump_file_name = 'Opengauss_Gin_Index_0038.tar'


    def setUp(self):
        logger.info("-----------this is setup-----------")
        logger.info("-----------Opengauss_Gin_Index_0038 start-----------")
    ...
    def tearDown(self):
        ...
        logger.info(result)
        logger.info("-----------Opengauss_Gin_Index_0038 end-----------")
