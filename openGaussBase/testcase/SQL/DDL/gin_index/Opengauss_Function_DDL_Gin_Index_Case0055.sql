...
--alter 
alter index test_gin_student_index_row2 rename to test_gin_student_index_row1;
alter index test_gin_student_index_row1 rename to test_gin_student_index_row2;
...
SELECT * FROM test_gin_student_row partition(num1) WHERE to_tsvector('english', data2) @@ to_tsquery('english', 'America');
explain SELECT * FROM test_gin_student_row partition(num1) WHERE to_tsvector('english', data2) @@ to_tsquery('english', 'America');
