...
class set_search_limit(unittest.TestCase):
    ...
    dump_file_name = 'Opengauss_Gin_Index_0036.tar'

    def setUp(self):
        logger.info("-----------this is setup-----------")
        logger.info("-----------Opengauss_Gin_Index_0036 start-----------")
    ...
    def tearDown(self):
        ...
        logger.info(result)
        logger.info("-----------Opengauss_Gin_Index_0036 end-----------")
