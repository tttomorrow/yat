...
(
	a int  default SYN_FUN_SYN_001('uyfuigilhlgig'),
	b varchar(1024) default SYN_FUN_SYN_002('abcd')
);
--修改表4数据，分别使用表1和表2的同义词数据
alter table SYN_TAB_004 alter a SET default SYN_FUN_SYN_001('abcd');
alter table SYN_TAB_004 alter b set default SYN_FUN_SYN_002('uyfuigilhlgig');
insert into SYN_TAB_004(b) values('gugolo');
