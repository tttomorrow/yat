...
alter table test_modify MODIFY (c_char not null);
alter table test_modify MODIFY (c_id null,c_char not null);
alter table test_modify MODIFY (c_char not null,c_varchar varchar(20));
