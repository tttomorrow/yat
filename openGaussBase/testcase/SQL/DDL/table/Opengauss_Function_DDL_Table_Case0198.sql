...
-- @testpoint: alter table references_clause (default '')
drop table if exists al_table_1;
drop table if exists al_table_2;
CREATE TABLE al_table_1 (c1 VARCHAR(255) default '',c2 int default '');
...
drop table if exists al_table_2;
CREATE TABLE al_table_2(c1 VARCHAR(255) default '',c2 int default '');
