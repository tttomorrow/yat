-- @testpoint: 修改列的约束为null,列名与null之间带数据类型时合理报错
...
alter table test_modify MODIFY (c_id null);

--报错，gaussdb支持，opengauss不支持
alter table test_modify MODIFY (c_id int null);
