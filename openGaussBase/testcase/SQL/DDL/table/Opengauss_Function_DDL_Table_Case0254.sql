...
create temporary table ct_as as (select c_char c1,c_varchar2 c2 from ct_tbl_as) union (select c_char c3,c_varchar2 c4 from ct_tbl_as);
drop table if exists ct_as;
drop table if exists ct_tbl_as;
