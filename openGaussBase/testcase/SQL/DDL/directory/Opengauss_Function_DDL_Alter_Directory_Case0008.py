...
Case Name   : enable_access_server_directory=off时，无sysadmin权限的用户修改属主失败，合理报错
Description :
...
class AlterDirectory(unittest.TestCase):
    def setUp(self):
        ...
        self.common = Common()
        self.user_name_1 = 'u_alter_directory_0008_01'
        self.user_name_2 = 'u_alter_directory_0008_02'
        self.user_name_3 = 'u_alter_directory_0008_03'
        self.dir_name = 'dir_alter_directory_0008'
        self.dir_path = os.path.join('/tmp', 'dir_alter_directory_0008')
