...
Case Name   : enable_access_server_directory=on时，directory属主删除目录对象成功
Description :
    1.创建目录
...
class DropDirectory(unittest.TestCase):
    def setUp(self):
        ...
        self.common = Common()
        self.dir_name = 'dir_object_drop_directory_0008'
        self.dir_path = os.path.join('/tmp', 'dir_drop_directory_0008')
        self.guc_result = ''
        self.user_name = 'u_object_drop_directory_0008'
    ...
    def test_drop_directory(self):
        ...
        text = "-----step4:directory属主删除目录对象，expect:删除成功-----"
        self.logger.info(text)
