...
class DropDirectory(unittest.TestCase):
    def setUp(self):
        ...
        self.common = Common()
        self.user_name_1 = 'u_drop_directory_0012_01'
        self.user_name_2 = 'u_drop_directory_0012_02'
        self.user_name_3 = 'u_drop_directory_0012_03'
        self.dir_name = 'dir_object_drop_directory_0012'
        self.dir_path = os.path.join('/tmp', 'dir_drop_directory_0012')
        ...
        text = "-----step2:修改guc参数enableSeparationOfDuty=on;expect:修改参数成功-----"
    ...
    def tearDown(self):
        text_5 = "-----step5:删除目录对象，删除用户，删除目录;expect:删除成功-----"
