...
Expect      :
    ...
    2.修改参数成功
    3.创建用户成功，创建目录对象成功
    4.系统管理员修改成功，安全管理员和审计管理员修改失败，合理报错
    5.删除成功
    6.恢复参数成功
History     :
"""
...
class AlterDirectory(unittest.TestCase):
    def setUp(self):
        ...
        self.common = Common()
        self.user_name_1 = 'u_alter_directory_0010_01'
        self.user_name_2 = 'u_alter_directory_0010_02'
        self.user_name_3 = 'u_alter_directory_0010_03'
        self.dir_name = 'dir_alter_directory_0010'
        self.dir_path = os.path.join('/tmp', 'dir_alter_directory_0010')
    ...
    def test_alter_directory(self):
        ...
        text = "-----step4:系统管理员、安全管理员和审计管理员用户修改目录对象; " \
               "expect:系统管理员修改成功，安全管理员和审计管理员修改失败，合理报错-----"
        self.logger.info(text)
