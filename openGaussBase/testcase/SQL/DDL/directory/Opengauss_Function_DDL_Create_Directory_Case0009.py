...
Case Name   : enable_access_server_directory=off，无SYSADMIN权限的非初始用户创建directory
Description :
    1.创建目录
...
class CreateDirectory(unittest.TestCase):
    def setUp(self):
        ...
        self.common = Common()
        self.user_name = 'u_create_directory_0009'
        self.dir_name = 'dir_object_create_directory_0009'
        self.dir_path = os.path.join('/tmp', 'dir_create_directory_0009')
