...
Case Name   : enable_access_server_directory=on时，有sysadmin权限的用户修改属主
Description :
...
class AlterDirectory(unittest.TestCase):
    def setUp(self):
        ...
        self.common = Common()
        self.user_name_1 = 'u_alter_directory_0005_01'
        self.user_name_2 = 'u_alter_directory_0005_02'
        self.user_name_3 = 'u_alter_directory_0005_03'
        self.dir_name = 'dir_alter_directory_0005'
        self.dir_path = os.path.join('/tmp', 'dir_alter_directory_0005')
    ...
    def test_alter_directory(self):
        ...
        text = "-----step3:有sysadmin权限的用户将属主修改为自己; expect:修改成功-----"
        self.logger.info(text)
