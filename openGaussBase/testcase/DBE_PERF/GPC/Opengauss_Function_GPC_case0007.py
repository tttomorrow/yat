...
class Gpcclass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info("Opengauss_Function_GPC_case0007 start")
    ...
    def test_index(self):
        ...
        cmd = f"ALTER TABLE {self.tb_name} DROP PARTITION p1;"
        result = self.commonshpri.execut_db_sql(cmd)
        self.log.info(result)
    ...
    def tearDown(self):
        ...
        self.log.info("-Opengauss_Function_GPC_case0007 end-")
