...
class Gpcclass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info("Opengauss_Function_GPC_case0005 start")
    ...
    def test_index(self):
        ...
        cmd = f"drop table if exists {self.tb_name1};" \
            ...
            f"insert into {self.tb_name1} values(1);"
        ...
        self.log.info("-----------7.vacuum表2------------------")
        cmd = f"vacuum {self.tb_name2};"
        result = self.commonshpri.execut_db_sql(cmd)
        self.log.info(result)
        ...
        self.log.info("-----------9.vacuum表1------------------")
        cmd = f"vacuum {self.tb_name1};"
        result = self.commonshpri.execut_db_sql(cmd)
        self.log.info(result)
        self.assertIn(self.constant.VACUUM_SUCCESS_MSG, result)
    ...
    def tearDown(self):
        ...
        self.log.info("-Opengauss_Function_GPC_case0005 end-")
