...
"""
Case Type   : 基础功能
Case Name   : refcount为0 plancache为invalid 5min中内使用plan，且为valid
Description :
    1.开启GPC
    2.重启数据库
    3.创建表
...
class Gpcclass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info("Opengauss_Function_GPC_case0052 start")
    ...
    def tearDown(self):
        ...
        self.log.info("-Opengauss_Function_GPC_case0052 end-")
