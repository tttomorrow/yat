...
"""
Case Type   : 基础功能
Case Name   : 行存表update语句session间共享
Description :
    1.开启GPC
    2.重启数据库
    3.创建表
    4.开启三个session update
...
class Gpcclass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info("Opengauss_Function_GPC_case0018 start")
    ...
    def tearDown(self):
        ...
        self.log.info("-Opengauss_Function_GPC_case0018 end-")
