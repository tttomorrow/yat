...
"""
Case Type   : 基础功能
Case Name   : 全局临时表insert语句session间共享
Description :
    1.开启GPC
    2.重启数据库
    3.创建表
...
class Gpcclass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info("Opengauss_Function_GPC_case0011 start")
    ...
    def test_index(self):
        ...
        self.log.info("---------------3.创建表----------------------")
        cmd = f"create global temp table {self.tb_name}(i int);"
    ...
    def tearDown(self):
        ...
        self.log.info("-Opengauss_Function_GPC_case0011 end-")
