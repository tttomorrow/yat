...
class Gpcclass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info("Opengauss_Function_GPC_case0057 start")
    ...
    def tearDown(self):
        ...
        self.log.info("-Opengauss_Function_GPC_case0057 end-")
