...
"""
Case Type   : 基础功能
Case Name   : 列分区update语句session间无法共享
Description :
    1.开启GPC
    2.重启数据库
    3.创建表
...
class Gpcclass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info("Opengauss_Function_GPC_case0042 start")
    ...
    def test_index(self):
        ...
        for i in range(3):
            ...
            self.log.info(result)
            flg = 'have been deleted or updated' in result \
                  or 'UPDATE' in result
            self.assertTrue(flg)
    ...
    def tearDown(self):
        ...
        self.log.info("-Opengauss_Function_GPC_case0042 end-")
