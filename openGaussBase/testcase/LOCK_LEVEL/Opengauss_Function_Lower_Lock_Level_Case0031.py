...
"""
Case Type   : 分区表锁降级
Case Name   : 分区表某一分区delete数据,同时不相邻分区update数据
Description :
    1、创建范围分区表;
    2、向分区1、分区3中插入数据;
...
class LockLevel(unittest.TestCase):
    ...
    def setUp(self):
        self.log = Logger()
        self.log.info('--Opengauss_Function_Lower_Lock_Level_Case0031开始执行--')
        self.constant = Constant()
        self.comsh = CommonSH('PrimaryDbUser')
        self.comSQL = CommonSQL('PrimaryDbUser')
        self.table_name = 't_locklevel_0031'
        self.i_function_name = 'f_insert_locklevel_0031'
        self.d_function_name = 'f_delete_locklevel_0031'
        self.u_function_name = 'f_update_locklevel_0031'
    ...
    def test_lock_level(self):
        ...
        text = '---step4 & step5:session2中在分区3中update数据; expect:更新数据成功---'
        self.log.info(text)
    ...
    def tearDown(self):
        ...
        text = '------Opengauss_Function_Lower_Lock_Level_Case0031执行完成------'
        self.log.info(text)
