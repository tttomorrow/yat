...
class LockLevel(unittest.TestCase):
    ...
    def setUp(self):
        self.log = Logger()
        self.log.info('--Opengauss_Function_Lower_Lock_Level_Case0001开始执行--')
        self.constant = Constant()
        self.comsh = CommonSH('PrimaryDbUser')
        self.comSQL = CommonSQL('PrimaryDbUser')
        self.table_name = 't_locklevel_0001'
        self.function_name = 'f_locklevel_0001'
    ...
    def test_lock_level(self):
        ...
        self.log.info(text)
        insert_cmd2 = f'''select {insert_func}(39999);
    ...
    def tearDown(self):
        ...
        self.log.info('--Opengauss_Function_Lower_Lock_Level_Case0001执行完成--')
