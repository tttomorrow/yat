...
class LockLevel(unittest.TestCase):
    ...
    def setUp(self):
        self.log = Logger()
        self.log.info('--Opengauss_Function_Lower_Lock_Level_Case0012开始执行--')
        self.constant = Constant()
        self.comsh = CommonSH('PrimaryDbUser')
        self.comSQL = CommonSQL('PrimaryDbUser')
        self.table_name = 't_locklevel_0012'
        self.i_function_name = 'f_insert_locklevel_0012'
        self.u_function_name = 'f_update_locklevel_0012'
    ...
    def test_lock_level(self):
        ...
        self.log.info(text)
        update_cmd2 = f'''select {update_func}(20100);
    ...
    def tearDown(self):
        ...
        text = '------Opengauss_Function_Lower_Lock_Level_Case0012执行完成------'
        self.log.info(text)
