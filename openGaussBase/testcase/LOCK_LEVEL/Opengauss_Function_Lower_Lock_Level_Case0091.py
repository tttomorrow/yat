...
class LockLevel(unittest.TestCase):
    ...
    def setUp(self):
        self.log = Logger()
        self.log.info('--Opengauss_Function_Lower_Lock_Level_Case0091开始执行--')
        self.constant = Constant()
        self.comsh = CommonSH('PrimaryDbUser')
        self.comSQL = CommonSQL('PrimaryDbUser')
        self.table_name = 't_locklevel_0091'
        self.i_function_name = 'f_insert_locklevel_0091'
        self.d_function_name = 'f_delete_locklevel_0091'
    ...
    def test_lock_level(self):
        ...
        self.assertTrue(self.d_function_name in session_2_result and
                        '(0 rows)' in session_2_result.splitlines()[-1],
                        "执行失败:" + text)
        ...
        self.assertTrue(self.i_function_name in session_1_result and
                        self.constant.START_TRANSACTION_SUCCESS_MSG
    ...
    def tearDown(self):
        ...
        self.assertTrue(
            ...
            '执行失败' + text)
        text = '------Opengauss_Function_Lower_Lock_Level_Case0091执行完成------'
        self.log.info(text)
