...
class LockLevel(unittest.TestCase):
    ...
    def setUp(self):
        self.log = Logger()
        self.log.info('--Opengauss_Function_Lower_Lock_Level_Case0004开始执行--')
        self.constant = Constant()
        self.comsh = CommonSH('PrimaryDbUser')
        self.comSQL = CommonSQL('PrimaryDbUser')
        self.table_name = 't_locklevel_0004'
        self.i_function_name = 'f_insert_locklevel_0004'
        self.u_function_name = 'f_update_locklevel_0004'
    ...
    def test_lock_level(self):
        ...
        self.log.info(text)
        sql = f'''select {insert_func}(45000);
            select count(*) from {self.table_name} partition for (45000);'''
        self.log.info(sql)
        ...
        self.log.info(text)
        update_cmd = f'''select {update_func}(45000);
            select * from {self.table_name} partition for (45000) limit 1;'''
    ...
    def tearDown(self):
        ...
        text = '------Opengauss_Function_Lower_Lock_Level_Case0004执行完成------'
        self.log.info(text)
