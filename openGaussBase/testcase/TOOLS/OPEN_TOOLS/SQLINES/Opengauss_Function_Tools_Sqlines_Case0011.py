...
"""
Case Type   : sqlines工具
Case Name   : sqlines工具，-in参数值使用相对路径
Description :
    1、sqlines安装
    2、创建测试脚本
...
class SqlinesTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.in_file = 'Opengauss_Function_Tools_Sqlines_Case0011.sql'
        self.out_file = 'Opengauss_Function_Tools_Sqlines_Case0011_out.sql'
        self.log_file = 'Opengauss_Function_Tools_Sqlines_Case0011.log'
