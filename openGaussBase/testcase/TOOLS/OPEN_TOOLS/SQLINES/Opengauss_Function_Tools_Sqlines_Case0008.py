...
"""
Case Type   : sqlines工具
Case Name   : sqlines工具-t参数值设置为无效值
Description :
    1、sqlines安装
    2、创建测试脚本
    3、sqlines -s=oracle -t=fasdfa -in={self.in_file} -out={self.out_file}
     -log={self.log_file}
...
class SqlinesTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.in_file = 'Opengauss_Function_Tools_Sqlines_Case0008.sql'
        self.out_file = 'Opengauss_Function_Tools_Sqlines_Case0008_out.sql'
        self.log_file = 'Opengauss_Function_Tools_Sqlines_Case0008.log'
    ...
    def test_main(self):
        ...
        cmd1 = f"{self.source_path};" \
            f"sqlines -s=oracle -t=fasdfa -in={self.in_file} " \
