...
class SqlinesTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.in_file = 'Opengauss_Function_Tools_Sqlines_Case0016.sql'
        self.out_file = 'Opengauss_Function_Tools_Sqlines_Case0016_out.sql'
        self.log_file = 'Opengauss_Function_Tools_Sqlines_Case0016.log'
