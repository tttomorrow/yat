...
class SqlinesTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.in_file = 'Opengauss_Function_Tools_Sqlines_Case0007.sql'
        self.out_file = 'Opengauss_Function_Tools_Sqlines_Case0007_out.sql'
        self.log_file = 'Opengauss_Function_Tools_Sqlines_Case0007.log'
