...
class SqlinesTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.in_file = 'Opengauss_Function_Tools_Sqlines_Case0005.sql'
        self.out_file = 'Opengauss_Function_Tools_Sqlines_Case0005_out.sql'
        self.log_file = 'Opengauss_Function_Tools_Sqlines_Case0005.log'
