...
Case Name   : 主备切换后，新主节点执行导出及导入，-h指定新主节点
Description :
        1.主备切换，备机执行
        2.新主节点创建工具所在目录
...
class ToolsBackup(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info(
            '---Opengauss_Function_JdbcGsBackup_Case0060start---')
        ...
        self.db_name = "db_jdbcgsbackup_0060"
        self.user = "u_jdbcgsbackup_0060"
        self.tb_name = "t_jdbcgsbackup_0060"
    ...
    def tearDown(self):
        ...
        self.assertTrue("Degraded" in result or "Normal" in result,
                        '执行失败:' + text)
        self.log.info(
            '---Opengauss_Function_JdbcGsBackup_Case0060finish---')
