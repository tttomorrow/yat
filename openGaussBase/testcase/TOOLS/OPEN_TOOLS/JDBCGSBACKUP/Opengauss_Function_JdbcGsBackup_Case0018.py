...
Case Name   :  JdbcGsBackup -m dump,用户密码错误，合理报错
Description :
        1.创建数据库
        2.指定数据库下建表，建用户
        3.修改信任方式为sha256
...
class ToolsBackup(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info(
            '---Opengauss_Function_JdbcGsBackup_Case0018start---')
    ...
    def tearDown(self):
        ...
        self.log.info(sql_cmd)
        self.log.info(
            '---Opengauss_Function_JdbcGsBackup_Case0018finish---')
