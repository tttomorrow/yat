...
class ToolsBackup(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info(
            '---Opengauss_Function_JdbcGsBackup_Case0068start---')
        ...
        self.pg_hba_path_bak = os.path.join(macro.DB_INSTANCE_PATH,
                                            'pg_hba.conf_t_bak')
        self.db_name = "db_jdbcgsbackup_0068"
        self.user = "u_jdbcgsbackup_0068"
        self.tb_name = "t_jdbcgsbackup_0068"
    ...
    def test_tools_backup(self):
        ...
        text = '---step6:主节点导出时停止备节点,-h备节点;expect:导出报错---'
        self.log.info(text)
    ...
    def tearDown(self):
        ...
        self.log.info(sql_cmd)
        self.log.info(
            '---Opengauss_Function_JdbcGsBackup_Case0068finish---')
