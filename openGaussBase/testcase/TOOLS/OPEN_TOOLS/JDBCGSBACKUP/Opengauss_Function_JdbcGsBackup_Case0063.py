...
class ToolsBackup(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info(
            '---Opengauss_Function_JdbcGsBackup_Case0063start---')
        ...
        self.db_name = "db_jdbcgsbackup_0063"
        self.user = "u_jdbcgsbackup_0063"
        self.tb_name = "t_jdbcgsbackup_0063"
    ...
    def test_tools_backup(self):
        ...
        text = '---step6:主节点导出时停止主节点;expect:导出报错---'
        self.log.info(text)
    ...
    def tearDown(self):
        ...
        self.log.info(sql_cmd)
        self.log.info(
            '---Opengauss_Function_JdbcGsBackup_Case0063finish---')
