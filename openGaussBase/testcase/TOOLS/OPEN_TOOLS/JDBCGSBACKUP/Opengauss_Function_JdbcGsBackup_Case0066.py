...
class ToolsBackup(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info(
            '---Opengauss_Function_JdbcGsBackup_Case0066start---')
        ...
        self.db_name = "db_jdbcgsbackup_0066"
        self.user = "u_jdbcgsbackup_0066"
        self.tb_name = "t_jdbcgsbackup_0066"
    ...
    def tearDown(self):
        ...
        self.log.info(sql_cmd)
        self.log.info(
            '---Opengauss_Function_JdbcGsBackup_Case0066finish---')
