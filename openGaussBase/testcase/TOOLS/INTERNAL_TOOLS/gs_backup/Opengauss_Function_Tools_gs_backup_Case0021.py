...
"""
Case Type   : 系统内部使用工具
Case Name   : 主备备份后指定备数据库hostname执行gs_backup进行恢复
Description :
    1.新建备份目录
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('---Opengauss_Function_Tools_gs_backup_Case0021开始执行---')
    ...
    def tearDown(self):
        ...
        if 'Standby' not in query_msg:
            ...
            LOG.info(clear_msg2)
        LOG.info('---Opengauss_Function_Tools_gs_backup_Case0021执行完成---')
