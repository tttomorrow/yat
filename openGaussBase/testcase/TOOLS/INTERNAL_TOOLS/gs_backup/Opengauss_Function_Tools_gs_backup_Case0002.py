...
"""
Case Type   : 系统内部使用工具
Case Name   : 使用系统用户执行gs_backup进行备份
Description :
    1.使用系统用户执行gs_backup进行备份
Expect      :
    1.使用系统用户执行gs_backup进行备份成功
History     :
"""
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('---Opengauss_Function_Tools_gs_backup_Case0002开始执行---')
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('---Opengauss_Function_Tools_gs_backup_Case0002执行完成---')
