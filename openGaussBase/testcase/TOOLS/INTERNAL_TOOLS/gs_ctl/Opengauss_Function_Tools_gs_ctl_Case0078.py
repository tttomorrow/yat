...
"""
Case Type   : 系统内部使用工具
Case Name   : 执行switchover时不添加-W参数，是否显示switchover结束的提示信息
Description :
    1.在备机上执行switchover
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('---Opengauss_Function_Tools_gs_ctl_Case0078开始执行-----')
    ...
    def tearDown(self):
        ...
        if 'Standby' in self.node_msg:
            ...
            return '主备节点正常'
        LOG.info('---Opengauss_Function_Tools_gs_ctl_Case0078执行完成---')
