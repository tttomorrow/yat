...
"""
Case Type   : 系统内部使用工具
Case Name   : gs_ctl restart指定-t的值足够大，重新启动主机是否成功
Description :
    1.查看集群状态是否正常
    2.指定-t设置值为120，使用restart重新启动主机，是否启动成功
    3.查看集群状态主机是否正常
Expect      :
    1.查看集群状态为正常成功
    2.指定-t设置值为120，使用restart重新启动主机，启动成功
    3.查看集群状态主机状态正常
History     :
"""
...
class LogicalReplication(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info(
            '---Opengauss_Function_Tools_gs_ctl_Case0025开始执行-----')
    ...
    def test_system_internal_tools(self):
        ...
        excute_cmd = f'''
                    ...
                    gs_ctl restart -D {self.instance_path} -M primary -t 120 ;
                        '''
        LOG.info(excute_cmd)
    ...
    def tearDown(self):
        ...
        LOG.info(is_start)
        LOG.info(
            '-----Opengauss_Function_Tools_gs_ctl_Case0025执行完成---')
