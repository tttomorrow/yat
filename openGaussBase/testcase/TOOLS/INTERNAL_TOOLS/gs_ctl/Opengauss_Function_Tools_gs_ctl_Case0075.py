...
"""
Case Type   : 系统内部使用工具
Case Name   : 执行switchover后执行gs_om -t refreshconf，重启后查看切换是否成功
Description :
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('---Opengauss_Function_Tools_gs_ctl_Case0075开始执行-----')
    ...
    def tearDown(self):
        ...
        if 'Standby' in self.node_msg:
            ...
            return '主备节点正常'
        LOG.info('----Opengauss_Function_Tools_gs_ctl_Case0075执行完成---')
