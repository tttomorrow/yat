...
"""
Case Type   : 系统内部使用工具
Case Name   : gs_ctl status使用-D指定正确数据库实例目录查看主机运行状态是否成功
Description :
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('----Opengauss_Function_Tools_gs_ctl_Case0058开始执行---')
    ...
    def tearDown(self):
        ...
        # 无需清理环境
        LOG.info('---Opengauss_Function_Tools_gs_ctl_Case0058执行完成----')
