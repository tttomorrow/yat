...
"""
Case Type   : 系统内部使用工具
Case Name   : 备机执行gs_ctl query使用-D指定正确数据库实例目录是否成功
Description :
    1.指定正确的数据库实例目录备机执行query
Expect      :
    1.指定正确的数据库实例目录备机执行query成功
History     :
"""
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('---Opengauss_Function_Tools_gs_ctl_Case0090开始执行-----')
    ...
    def tearDown(self):
        ...
        # 无需清理环境
        LOG.info('---Opengauss_Function_Tools_gs_ctl_Case0090执行完成---')
