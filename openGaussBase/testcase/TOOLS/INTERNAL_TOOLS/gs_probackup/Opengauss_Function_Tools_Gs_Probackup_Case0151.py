...
"""
Case Type   : 系统内部使用工具
Case Name   : 使用gs_probackup add-instance命令只添加远程模式相关参数，
              用户不存在，初始化一个新的备份实例成功
Description :
    1.创建备份目录
    2.进行初始化
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        self.gs_probackup_path = os.path.join(macro.DB_INSTANCE_PATH,
                                              'gs_probackup_testdir0151')
        self.log.info(
            '----Opengauss_Function_Tools_Gs_Probackup_Case0151 start----')
    ...
    def test_server_tools(self):
        ...
        add_cmd = f"source {macro.DB_ENV_PATH};" \
                  ...
                  f"--instance=test_0151 " \
                  f"--remote-user='us_gs_probackup_0151' " \
        ...
        self.assertIn("'test_0151' " + self.constant.init_success, exec_msg,
                      '执行失败:' + text)
    ...
    def tearDown(self):
        ...
        self.log.info(
            '----Opengauss_Function_Tools_Gs_Probackup_Case0151 end----')
