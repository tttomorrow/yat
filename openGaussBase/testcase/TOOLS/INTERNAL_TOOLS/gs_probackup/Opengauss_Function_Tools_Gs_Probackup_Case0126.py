...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0126开始执行-')
    ...
    def test_system_internal_tools(self):
        ...
        fullback_cmd = f"source {macro.DB_ENV_PATH};" \
            ...
            f"--expire-time='2022-01-01 00:00:00+03';"
        ...
        self.row_msg = self.show_msg.splitlines()[-8].strip()
        LOG.info(self.row_msg)
        self.time_msg = self.row_msg.split('=')[1].strip()
        LOG.info(self.time_msg)
        self.assertEqual("'2022-01-01 05:00:00+08'", f'{self.time_msg}')
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0126执行完成-')
