...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0139开始执行-')
    ...
    def test_system_internal_tools(self):
        ...
        fullback_msg = self.dbuserNode.sh(fullback_cmd).result()
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0139执行完成-')
