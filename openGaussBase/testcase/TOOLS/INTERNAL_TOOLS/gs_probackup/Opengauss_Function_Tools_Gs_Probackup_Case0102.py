...
"""
Case Type   : 系统内部使用工具
Case Name   : 指定-j、--progress，验证备份文件
Description :
    1.新建目录
    2.进行初始化
    3.在备份路径内初始化一个新的备份实例
...
Expect      :
    ...
    4.进行备份成功
    5.执行validate成功,显示4个具体线程与详细的进展信息
    6.删除新建目录成功
History     :
"""
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0102开始执行-')
    ...
    def test_system_internal_tools(self):
        ...
        validate_cmd = f"source {macro.DB_ENV_PATH};" \
            ...
            f" --instance=pro1 -i {self.backupid}  -j 4 --progress ;"
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0102执行完成-')
