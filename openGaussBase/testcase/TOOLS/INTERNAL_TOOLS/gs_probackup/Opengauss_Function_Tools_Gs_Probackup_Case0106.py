...
"""
Case Type   : 系统内部使用工具
Case Name   : 检查是否可以从备份副本恢复到指定的xid事务ID
Description :
    1.新建目录
    2.进行初始化
    3.在备份路径内初始化一个新的备份实例
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0106开始执行-')
    ...
    def test_system_internal_tools(self):
        ...
        validate_cmd = f"source {macro.DB_ENV_PATH};" \
            ...
            f" --instance=pro1 --recovery-target-xid='{self.xid_msg}';"
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0106执行完成-')
