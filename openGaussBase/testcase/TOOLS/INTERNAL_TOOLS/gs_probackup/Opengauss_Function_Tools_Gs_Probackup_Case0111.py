...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0111开始执行-')
    ...
    def test_system_internal_tools(self):
        ...
        self.row_msg = self.show_msg.splitlines()[-13].strip()
        ...
        self.assertIn('option can be applied only when either of ',
                      validate_msg)
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0111执行完成-')
