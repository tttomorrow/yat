...
"""
Case Type   : 系统内部使用工具
Case Name   : gs_probackup初始化备份路径已存在并且为空
Description :
    1.新建备份目录
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('---Opengauss_Function_Tools_Gs_Probackup_Case0008开始执行---')
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('---Opengauss_Function_Tools_Gs_Probackup_Case0008执行完成---')
