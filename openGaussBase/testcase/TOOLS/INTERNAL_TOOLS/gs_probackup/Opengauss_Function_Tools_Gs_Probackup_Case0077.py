...
"""
Case Type   : 系统内部使用工具
Case Name   : 指定的--external-mapping=OLDDIR=NEWDIR 选项中含有“=”，
              使用反斜杠转义后执行restore
Description :
    1.新建目录
    2.进行初始化
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0077开始执行-')
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0077执行完成-')
