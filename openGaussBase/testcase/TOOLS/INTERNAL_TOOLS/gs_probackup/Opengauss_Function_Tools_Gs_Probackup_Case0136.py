...
"""
Case Type   : 系统内部使用工具
Case Name   : 使用help显示gs_probackup merge命令的摘要信息
Description :
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('--Opengauss_Function_Tools_Gs_Probackup_Case0136开始执行-')
        ...
        self.except_msg = ['gs_probackup merge -B backup-path '
                           ...
                           '-i, --backup-id=backup-id        backup to merge',
    ...
    def tearDown(self):
        ...
        # 无须清理环境
        LOG.info('--Opengauss_Function_Tools_Gs_Probackup_Case0136执行完成--')
