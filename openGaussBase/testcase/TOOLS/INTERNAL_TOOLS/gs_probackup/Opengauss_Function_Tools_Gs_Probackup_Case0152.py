...
"""
Case Type   : 系统内部使用工具
Case Name   : 使用gs_probackup add-instance命令添加--remote-path参数，
              路径不存在
Description :
    1.创建备份目录
    2.进行初始化
...
class SystemInternalTools(unittest.TestCase):
    ...
    def test_server_tools(self):
        ...
        self.assertIn("'test_0152' " + self.constant.init_success, exec_msg,
                      '执行失败:' + text)
    ...
    def tearDown(self):
        ...
        self.log.info(
            '----Opengauss_Function_Tools_Gs_Probackup_Case0152 end----')
