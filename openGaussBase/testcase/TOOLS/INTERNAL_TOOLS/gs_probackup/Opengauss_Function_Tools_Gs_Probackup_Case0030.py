...
"""
Case Type   : 系统内部使用工具
Case Name   : 查看gs_probackup delete命令的摘要信息
Description :
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0030开始执行-')
    ...
    def test_system_internal_tools(self):
        LOG.info('step1 执行命令显示gs_probackup delete命令的摘要信息')
        help_cmd = f"source {macro.DB_ENV_PATH};" \
            f"gs_probackup delete --help;"
        LOG.info(help_cmd)
    ...
    def tearDown(self):
        ...
        # 无须清理环境
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0030执行完成-')
