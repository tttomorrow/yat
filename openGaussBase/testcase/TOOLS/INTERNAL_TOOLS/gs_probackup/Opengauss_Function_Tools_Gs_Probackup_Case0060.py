...
"""
Case Type   : 系统内部使用工具
Case Name   : 不指定--no-validate，执行备份
Description :
    1.新建目录
    2.进行初始化
    3.在备份路径内初始化一个新的备份实例
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0060开始执行-')
    ...
    def test_system_internal_tools(self):
        ...
        self.assertIn('data files are valid', back_msg)
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0060执行完成-')
