...
Description :
    ...
    4.进行备份
    5.查看备份信息
    6.执行validate（目标恢复时间和backup_id 时间匹配）
    7.删除新建目录
Expect      :
    1.新建目录成功
    2.进行初始化成功
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0103开始执行-')
    ...
    def test_system_internal_tools(self):
        ...
        validate_cmd = f"source {macro.DB_ENV_PATH};" \
            ...
            f"--recovery-target-time='{self.time_msg1} {self.time_msg2}';"
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0103执行完成-')
