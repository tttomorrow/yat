...
"""
Case Type   : 系统内部使用工具
Case Name   : 不将备份文件同步到磁盘、增加备份注释，指定--no-sync、
              --note选项执行备份
Description :
    1.新建目录
    2.进行初始化
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0051开始执行-')
    ...
    def test_system_internal_tools(self):
        ...
        LOG.info(back_msg)
        self.assertIn('Adding note to backup', back_msg)
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0051执行完成-')
