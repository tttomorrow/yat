...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        self.gs_probackup_path = os.path.join(macro.DB_INSTANCE_PATH,
                                              'gs_probackup_testdir0157')
        self.log.info(
            '----Opengauss_Function_Tools_Gs_Probackup_Case0157 start----')
    ...
    def test_server_tools(self):
        ...
        self.assertIn("'test_0157' " + self.constant.init_success, exec_msg,
                      '执行失败:' + text)
    ...
    def tearDown(self):
        ...
        self.log.info(
            '----Opengauss_Function_Tools_Gs_Probackup_Case0157 end----')
