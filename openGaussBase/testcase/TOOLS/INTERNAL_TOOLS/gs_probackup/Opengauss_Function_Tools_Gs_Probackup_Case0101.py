...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0101开始执行-')
    ...
    def test_system_internal_tools(self):
        ...
        LOG.info('增量备份ID为：' + self.backupid)
        ...
        LOG.info(show_msg)
        self.assertIn(f'Backup {self.backupid} is valid', show_msg)
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0101执行完成-')
