...
"""
Case Type   : 系统内部使用工具
Case Name   : 显示pg_probackup.conf配置文件的内容,默认情况下是否为纯文本格式
Description :
    1.新建目录
    2.进行初始化
    3.在备份路径内初始化一个新的备份实例
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0032开始执行-')
    ...
    def test_system_internal_tools(self):
        ...
        cat_cmd = f"source {macro.DB_ENV_PATH};" \
            ...
            f"{macro.DB_BACKUP_PATH}/testdir --instance=pro1"
        LOG.info(cat_cmd)
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('-Opengauss_Function_Tools_Gs_Probackup_Case0032执行完成-')
