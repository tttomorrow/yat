...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        self.gs_probackup_path = os.path.join(
            ...
            'gs_probackup_testdir0196')
        self.gs_probackup_log = os.path.join(macro.DB_INSTANCE_PATH,
                                             'gs_probackup_log0196')
        self.log.info(
            '----Opengauss_Function_Tools_Gs_Probackup_Case0196 start----')
    ...
    def test_server_tools(self):
        ...
        self.log.info(exec_msg)
        self.assertIn('ERROR: Option is not found',
                      exec_msg, '执行失败:' + text)
    ...
    def tearDown(self):
        ...
        self.log.info(
            '----Opengauss_Function_Tools_Gs_Probackup_Case0196 end----')
