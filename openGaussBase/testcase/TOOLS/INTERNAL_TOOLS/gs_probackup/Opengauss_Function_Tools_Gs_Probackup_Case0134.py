...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('--Opengauss_Function_Tools_Gs_Probackup_Case0134开始执行-')
        self.constant = Constant()
        self.PrimaryNode = Node('PrimaryDbUser')
        self.except_msg = ['gs_probackup backup -B backup-path --instance='
                           'instance_name -b backup-mode',
                           ...
                           '--log-rotation-size=log-rotation-size',
                           'rotate logfile if its size exceeds this '
                           'value; 0 disables; (default: 0)',
                           ...
                           '(default: 0)',
                           '--retention-window=retention-window',
                           'number of days of recoverability; 0 disables; '
                           '(default: 0)',
                           '--wal-depth=wal-depth        number of latest '
                           'valid backups per timeline that must',
                           'retain the ability to perform PITR; '
                           '0 disables; (default: 0)',
                           ...
                           "--compress                   alias for --compress"
                           "-algorithm='zlib' and --compress-level=1",
                           '', 'Connection options:',
                           '-U, --pguser=username            '
                           ...
                           '--remote-host=destination    remote '
                           ...
                           '--remote-user=username       user name '
                           'for ssh connection (default: current user)',
                           '--ssh-options=ssh_options    additional '
                           'ssh options (default: none)',
    ...
    def tearDown(self):
        ...
        # 无须清理环境
        LOG.info('--Opengauss_Function_Tools_Gs_Probackup_Case0134执行完成--')
