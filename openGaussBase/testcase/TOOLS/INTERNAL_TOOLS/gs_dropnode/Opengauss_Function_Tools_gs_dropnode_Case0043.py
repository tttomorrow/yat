...
class Gstoolstestcase(unittest.TestCase):
    def setUp(self):
        LOGGER.info("==Opengauss_Function_Tools_gs_dropnode_Case0043 start==")
    ...
    def tearDown(self):
        ...
        LOGGER.info("==Opengauss_Function_Tools_gs_dropnode_Case0043 finish=")
