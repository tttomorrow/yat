...
"""
Case Type   : tools
Case Name   : 启动gaussdb进程时，使用-N参数设置服务器接受的客户端连接的最大数为小数，
                启动是否成功
Description :
    1.查看当前最大连接数
    ...
    gaussdb -D /opt/openGauss_zl/cluster/dn1 -p 19701 -N 10.1  -M primary &
    5.恢复-重启数据库
...
Expect      :
    ...
    FATAL:  invalid value for parameter "max_connections": "10.1"
    5.重启数据库成功
History     :
"""
import unittest
...
class Tools(unittest.TestCase):
    ...
    def test_systools(self):
        ...
        self.logger.info("-----使用gaussdb工具指定指定-N参数设置最大连接数为小数----")
