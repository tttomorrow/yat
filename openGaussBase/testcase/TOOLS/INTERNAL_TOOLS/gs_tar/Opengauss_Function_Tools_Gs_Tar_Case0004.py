...
class Tarclass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info("Opengauss_Function_Tools_Gs_Tar_Case0004 start")
    ...
    def test_tar0004(self):
        text = '-step1: 新建备份目录 expect:新建备份目录成功--'
        self.log.info(text)
        ...
        result = self.primary_user_node.sh(cmd).result()
        self.log.info(result)
        self.assertIn('No such file or directory', result, '执行失败:' + text)
    ...
    def tearDown(self):
        ...
        self.log.info("-Opengauss_Function_Tools_Gs_Tar_Case0004 end-")
