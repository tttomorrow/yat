...
class Tarclass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info("Opengauss_Function_Tools_Gs_Tar_Case0005 start")
    ...
    def test_tar0005(self):
        ...
        cmd = f"chmod -R 000 {self.tar_path}"
        self.log.info(cmd)
        ...
        result = self.primary_user_node.sh(cmd).result()
        self.log.info(result)
        self.assertIn('Segmentation fault', result, '执行失败:' + text)
    ...
    def tearDown(self):
        ...
        self.log.info("-Opengauss_Function_Tools_Gs_Tar_Case0005 end-")
