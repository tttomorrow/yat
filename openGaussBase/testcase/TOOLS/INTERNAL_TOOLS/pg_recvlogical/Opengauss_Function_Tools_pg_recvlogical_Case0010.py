...
class Tools(unittest.TestCase):
    def setUp(self):
        ...
        self.u_name = 'u_pg_recvlogical_0010'
        self.slot_name = 'solt_pg_recvlogical_0010'
    ...
    def test_standby(self):
        ...
        sql_cmd = self.pri_sh.execut_db_sql(create_cmd)
        ...
        action_option = ['--create', '--start -s 2 -f - -v']
    ...
    def tearDown(self):
        ...
        self.log.info(text)
        del_cmd = self.pri_sh.execut_db_sql(f"drop user if exists "
                                            f"{self.u_name};"
                                            f"select * from "
                                            f"pg_drop_replication_slot"
                                            f"('{self.slot_name}');")
        ...
        mod_msg2 = self.pri_sh.execute_gsguc('set',
                                             self.constant.GSGUC_SUCCESS_MSG,
                                             f'enable_slot_log='
