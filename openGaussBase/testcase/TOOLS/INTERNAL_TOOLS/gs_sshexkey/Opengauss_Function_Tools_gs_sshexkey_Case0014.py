...
Case Name   : 普通用户下，执行gs_sshexkey -? 命令
Description :
    1、普通用户下，执行gs_sshexkey -?
    2、检查选项和用法
Expect      :
    1、命令执行成功
    2、用法和参数选项齐全且描述正确
...
class ToolsTestCase(unittest.TestCase):
    ...
    def test_gs_sshexkey(self):
        logger.info("===Opengauss_Function_Tools_gs_sshexkey_Case0014开始执行===")
    ...
    def tearDown(self):
        ...
        logger.info("===Opengauss_Function_Tools_gs_sshexkey_Case0014执行结束===")
