...
"""
Case Type   : 系统内部使用工具
Case Name   : 使用pg_controldata工具pg_controldata的版本信息然后退出
Description :
...
class LogicalReplication(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info(
            '---Opengauss_Function_Tools_pg_controldata_Case0003开始执行-----')
    ...
    def tearDown(self):
        ...
        # 无需清理环境
        LOG.info(
            '-----Opengauss_Function_Tools_pg_controldata_Case0003执行完成---')
