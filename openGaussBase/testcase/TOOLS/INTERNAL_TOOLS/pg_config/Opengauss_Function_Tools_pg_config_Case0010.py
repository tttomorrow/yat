...
"""
Case Type   : 系统内部使用工具
Case Name   : 指定--mandir参数打印手册页的位置是否成功
Description :
    1.执行命令打印手册页的位置
Expect      :
    1.执行命令打印手册页的位置成功
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('---Opengauss_Function_Tools_pg_config_Case0010开始执行---')
