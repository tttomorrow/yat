...
"""
Case Type   : 系统内部使用工具
Case Name   : 指定--pkgincludedir参数打印其它C头文件的位置是否成功
Description :
    1.执行命令打印其它C头文件的位置
Expect      :
    1.执行命令打印其它C头文件的位置
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('---Opengauss_Function_Tools_pg_config_Case0005开始执行---')
