...
"""
Case Type   : 系统内部使用工具
Case Name   : 指定--libdir参数打印目标代码库的路径是否成功
Description :
    1.执行命令打印目标代码库的路径
Expect      :
    1.执行命令打印目标代码库的路径成功
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('---Opengauss_Function_Tools_pg_config_Case0007开始执行---')
