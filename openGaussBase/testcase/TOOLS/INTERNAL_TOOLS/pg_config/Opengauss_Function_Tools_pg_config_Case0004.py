...
"""
Case Type   : 系统内部使用工具
Case Name   : 指定--includedir参数打印客户端接口C头文件的路径是否成功
Description :
    1.执行命令打印客户端接口C头文件的路径
Expect      :
    1.执行命令打印客户端接口C头文件的路径成功
History     :
"""
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('---Opengauss_Function_Tools_pg_config_Case0004开始执行---')
