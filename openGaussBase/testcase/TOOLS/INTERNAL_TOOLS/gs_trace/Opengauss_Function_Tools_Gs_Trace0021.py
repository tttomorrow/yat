...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('---Opengauss_Function_Tools_Gs_Trace0021开始执行-----')
    ...
    def test_system_internal_tools(self):
        ...
        perf_cmd = f'''source {macro.DB_ENV_PATH};
            ...
            {macro.DB_BACKUP_PATH}/gs_trace.perf -t 1.1;
            '''
        LOG.info(perf_cmd)
    ...
    def tearDown(self):
        ...
        LOG.info(stop_msg)
        LOG.info('---Opengauss_Function_Tools_Gs_Trace0021执行完成---')
