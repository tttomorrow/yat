...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('---Opengauss_Function_Tools_Gs_Trace0015开始执行-----')
    ...
    def tearDown(self):
        ...
        LOG.info(stop_msg)
        LOG.info('---Opengauss_Function_Tools_Gs_Trace0015执行完成---')
