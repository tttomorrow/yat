...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('---Opengauss_Function_Tools_Gs_Trace0003开始执行-----')
    ...
    def test_system_internal_tools(self):
        ...
        LOG.info(stop_msg)
        self.assertIn('Attach to trace config failed', stop_msg)
    ...
    def tearDown(self):
        ...
        stop_msg = self.PrimaryNode.sh(stop_cmd).result()
        LOG.info(stop_msg)
        LOG.info('---Opengauss_Function_Tools_Gs_Trace0003执行完成---')
