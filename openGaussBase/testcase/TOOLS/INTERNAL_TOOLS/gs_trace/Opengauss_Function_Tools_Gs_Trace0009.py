...
"""
Case Type   : 系统内部使用工具
Case Name   : trace开启，解析dump detail信息
Description :
    1.查看gaussdb进程号
    2.启动trace
...
Expect      :
    ...
    4.解析dump detail信息成功，对应目录下生成detail文件
    5.关闭trace成功
History     :
"""
...
class SystemInternalTools(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info('---Opengauss_Function_Tools_Gs_Trace0009开始执行-----')
    ...
    def tearDown(self):
        ...
        LOG.info(stop_msg)
        LOG.info('---Opengauss_Function_Tools_Gs_Trace0009执行完成---')
