...
Description :
    1.关掉enable_incremental_checkpoint
    2.建mot表并插入数据create foreign table mot_table(a int);，插入数据
    3.执行备份：gs_basebackup -D /usr2/chenchen/basebackup/bak_default
...
class GsBaseBackUpCase36(unittest.TestCase):
    def setUp(self):
        ...
        self.gs_basebackup_bak_path = os.path.join(macro.DB_BACKUP_PATH,
                                                   'gs_basebackup')
        self.gs_basebackup_bak_name = 'gs_basebackup_Case0036.bak'
    ...
    def test_server_tools(self):
        ...
        self.LOG.info('----关掉enable_incremental_checkpoint---')
        ...
        self.assertIn('CREATE FOREIGN TABLE', sql_result)
