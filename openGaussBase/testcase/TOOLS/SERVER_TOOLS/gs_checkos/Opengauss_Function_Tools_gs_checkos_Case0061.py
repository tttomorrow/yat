...
"""
Case Type   : 服务端工具
Case Name   : 检查操作系统版本，内核版本,Unicode状态
Description :
    检查操作系统版本，内核版本,Unicode状态
Expect      :
    检查完成
History     :
"""
...
class Tools(unittest.TestCase):
    def setUp(self):
        logger.info('--------------Opengauss_Function_Tools_gs_checkos_Case0061start-------------------')
    ...
    def tearDown(self):
        logger.info('--------------无需清理环境-------------------')
        logger.info('------------------Opengauss_Function_Tools_gs_checkos_Case0061finish------------------')
