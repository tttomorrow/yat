...
"""
Case Type   : 服务端工具
Case Name   : 指定多个需要检查的主机名称（无主备关系），主机之间使用“英文逗号”分割, 检查磁盘配置状态
Description :
    1.指定多个需要检查的主机名称（无主备关系），主机之间使用“英文逗号”分割，检查磁盘配置状态
Expect      :
    2.无主备关系的磁盘配置状态检查失败
History     :
"""
...
class Tools(unittest.TestCase):
    ...
    def test_server_tools1(self):
        self.log.info('-Opengauss_Function_Tools_gs_checkos_Case0042开始-')
        ...
        self.log.info('指定多个需要检查的主机名称（无主备关系），主机之间使用“英文逗号”分割，检查磁盘配置状态')
    ...
    def tearDown(self):
        ...
        self.log.info('-Opengauss_Function_Tools_gs_checkos_Case0042结束-')
