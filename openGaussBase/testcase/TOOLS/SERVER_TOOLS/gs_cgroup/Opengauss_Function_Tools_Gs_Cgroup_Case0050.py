...
Case Name   : 设置CPUSkewPercent为0-100的unint型，
              且设置QualificationTime为[0-4294967295]的uint型，指定异常操作--a
Description :
...
class Tools(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info('----Opengauss_Function_Gs_Cgroup_Case0050开始执行----')
        self.primary_node = Node('PrimaryDbUser')
        self.Class_Name = 'Cgroup_Case0050_class'
        self.Grp_Name = 'Cgroup_Case0050_grp'
        ...
        for percent1 in percent1_lis:
            for percent2 in percent2_lis:
                ...
                if percent2 == percent1 == 0:
                    ...
                    self.assertEqual(f'ABORT: QualificationTime={percent2} '
    ...
    def tearDown(self):
        ...
        self.log.info(
            '----Opengauss_Function_Gs_Cgroup_Case0050执行完成----')
