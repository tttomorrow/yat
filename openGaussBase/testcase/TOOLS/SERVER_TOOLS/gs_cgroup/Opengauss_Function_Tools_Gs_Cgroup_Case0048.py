...
"""
Case Type   : 服务端工具
Case Name   : 设置CPUSkewPercent为!=[0-100]的unint型，
              且设置QualificationTime为1-4294967295的uint型，不指定异常操作
Description :
...
class Tools(unittest.TestCase):
    ...
    def test_gs_cgroup(self):
        ...
        text = '----step2:设置CPUSkewPercent为!=[0-100]的unint型，且设置' \
        ...
        for percent1 in percent1_lis:
            ...
            if percent1 == -1:
                ...
                error_msg = f'ERROR: threshold \'CPUSkewPercent\', value ' \
                            f'\'{percent1}\' is invalid, it must be 0~100!'
