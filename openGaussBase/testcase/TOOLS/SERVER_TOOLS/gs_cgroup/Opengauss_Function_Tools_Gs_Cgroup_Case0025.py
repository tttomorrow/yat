...
Case Name   : 执行gs_cgroup -S {classname}
              -E "blocktime={0-4294967295}" --penalty
              设置异常参数blocktime为uint型0-4294967295，异常操作为--penalty
Description :
...
class Tools(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info('----Opengauss_Function_Gs_Cgroup_Case0025开始执行----')
        self.primary_node = Node('PrimaryDbUser')
        self.Class_Name = 'Cgroup_Case0025_class'
        self.Grp_Name = 'Cgroup_Case0025_grp'
    ...
    def tearDown(self):
        ...
        self.log.info(
            '----Opengauss_Function_Gs_Cgroup_Case0025执行完成----')
