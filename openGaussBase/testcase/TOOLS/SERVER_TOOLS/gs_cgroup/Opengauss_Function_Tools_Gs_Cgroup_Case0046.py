...
class Tools(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info('----Opengauss_Function_Gs_Cgroup_Case0046开始执行----')
        self.primary_node = Node('PrimaryDbUser')
        self.Class_Name = 'Cgroup_Case0046_class'
        self.Grp_Name = 'Cgroup_Case0046_grp'
    ...
    def test_gs_cgroup(self):
        ...
        text = '----step2:设置异常参数QualificationTime为uint [0-4294967295]，' \
               '不指定异常操作  expect:修改失败----'
        self.log.info(text)
        ...
        for percent in percent_lis:
            ...
            if percent == 0:
                ...
                error_msg = 'ERROR: exception key string ' \
                            '\'QualificationTime\' ' \
    ...
    def tearDown(self):
        ...
        self.log.info(
            '----Opengauss_Function_Gs_Cgroup_Case0046执行完成----')
