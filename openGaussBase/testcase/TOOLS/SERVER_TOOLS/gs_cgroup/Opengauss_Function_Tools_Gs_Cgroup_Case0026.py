...
class Tools(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info('----Opengauss_Function_Gs_Cgroup_Case0026开始执行----')
        self.primary_node = Node('PrimaryDbUser')
        self.Class_Name = 'Cgroup_Case0026_class'
        self.Grp_Name = 'Cgroup_Case0026_grp'
    ...
    def test_gs_cgroup(self):
        ...
        text = '----step2:设置异常参数blocktime为uint型0-4294967295，' \
               '异常操作为--a  expect:修改成功----'
        self.log.info(text)
        ...
        if percent == 0:
            ...
            self.assertIn(f'BlockTime={percent}', msg1, '执行失败' + text)
    ...
    def tearDown(self):
        ...
        self.log.info(
            '----Opengauss_Function_Gs_Cgroup_Case0026执行完成----')
