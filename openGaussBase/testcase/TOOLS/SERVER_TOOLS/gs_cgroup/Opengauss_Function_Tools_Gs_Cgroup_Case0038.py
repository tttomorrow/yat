...
Description :
    ...
    设置异常参数spillsize为uint型 = [0-4294967295] 指定异常操作--a
...
class Tools(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info('----Opengauss_Function_Gs_Cgroup_Case0038开始执行----')
        self.primary_node = Node('PrimaryDbUser')
        self.Class_Name = 'Cgroup_Case0038_class'
        self.Grp_Name = 'Cgroup_Case0038_grp'
    ...
    def test_gs_cgroup(self):
        ...
        for percent in percent_lis:
            ...
            if percent == 0:
                ...
                self.assertIn(f'SpillSize={percent}', msg1, '执行失败' + text)
    ...
    def tearDown(self):
        ...
        self.log.info(
            '----Opengauss_Function_Gs_Cgroup_Case0038执行完成----')
