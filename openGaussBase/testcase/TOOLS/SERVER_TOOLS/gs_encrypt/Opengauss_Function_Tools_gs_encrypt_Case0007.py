...
"""
Case Type   : 服务端工具
Case Name   : gs_encrypt工具单独使用参数-f加密明文字符串
Description :
    1.执行命令:
...
class Tools(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('Opengauss_Function_Tools_gs_encrypt_Case0007 start')
    ...
    def test_gs_encrypt(self):
        ...
        step = "step1:执行命令,在$GAUSSHOME/bin目录下生成加密文件cipher,rand " \
               "except:成功生成文件"
        ...
        step = "step2:执行命令,单独使用参数-f加密明文字符串 " \
    ...
    def tearDown(self):
        ...
        self.logger.info('Opengauss_Function_Tools_gs_encrypt_Case0007 finish')
