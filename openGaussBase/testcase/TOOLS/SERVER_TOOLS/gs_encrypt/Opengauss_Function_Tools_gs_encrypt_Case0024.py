...
"""
Case Type   : 服务端工具
Case Name   : gs_encrypt工具加密纯数字字符串
Description :
    1.执行命令:
...
class Tools(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('Opengauss_Function_Tools_gs_encrypt_Case0024 start')
    ...
    def tearDown(self):
        ...
        self.logger.info('Opengauss_Function_Tools_gs_encrypt_Case0024 finish')
