...
Description :
    ...
    2.执行命令，组合使用参数--key，--vector，--key-base64加密明文字符串
      gs_encrypt --key=[用户输入的口令] --vector=[用户输入的盐值] --key-base64=
