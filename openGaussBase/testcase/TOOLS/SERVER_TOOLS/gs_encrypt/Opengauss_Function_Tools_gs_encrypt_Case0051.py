...
"""
Case Type   : 服务端工具
Case Name   : gs_encrypt工具使用参数-B，-D加明文字符串，-B后输入只包含数字的口令
Description :
    1.生成8位纯数字口令以base64方式编码的密钥；
...
class GsEncrypt51(unittest.TestCase):
    def setUp(self):
        self.con = Constant()
        self.logger = Logger()
    ...
    def test_gs_encrypt(self):
        ...
        step = "step1-2:生成8位纯数字口令以base64方式编码的密钥,生成以base64方" \
