...
"""
Case Type   : 服务端工具
Case Name   : gs_encrypt工具使用参数-B，-D加明文字符串，-B后输入加密口令长度为15
Description :
    1.生成长度为15的口令以base64方式编码的密钥；
...
class Tools(unittest.TestCase):
    ...
    def test_gs_encrypt(self):
        ...
        step = "step1-2:生成长度为15的口令以base64方式编码的密钥,生成以base64" \
               "方式编码的16位字符串密文  except:成功生成密钥，成功生成密文"
        self.logger.info(step)
        str1 = 'test'
        encrypt = 'gg33##FFgg44##f'
        rand = '1234567891234569'
        ...
        step = "step3:执行命令，使用-B，-D参数加密明文字符串 except:执行成" \
               "功，输出加密后的密文"
        self.logger.info(step)
        ...
        self.assertTrue(len(msg1) == 64, "执行失败" + step)
