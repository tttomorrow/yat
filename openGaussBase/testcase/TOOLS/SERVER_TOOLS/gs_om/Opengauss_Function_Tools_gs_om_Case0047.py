...
"""
Case Type   : 服务端工具
Case Name   : 数据库关闭时，设置关闭模式为--mode=fast方式
Description :
    1.查看数据库状态：gs_om -t status --detail
    2.关闭数据库时，设置-关闭模式--mode=fast方式：gs_om -t stop --mode=fast;
...
class Tools(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('--Opengauss_Function_Tools_gs_om_Case0047start--')
    ...
    def tearDown(self):
        ...
        self.logger.info('--Opengauss_Function_Tools_gs_om_Case0047finish--')
