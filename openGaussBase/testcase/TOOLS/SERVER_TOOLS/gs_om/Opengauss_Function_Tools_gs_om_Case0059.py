...
class Tools(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('--Opengauss_Function_Tools_gs_om_Case0059start--')
    ...
    def test_server_tools1(self):
        ...
        self.logger.info('----步骤1：查询指定服务器数据库状态----')
    ...
    def tearDown(self):
        ...
        self.logger.info('--Opengauss_Function_Tools_gs_om_Case0059finish--')
