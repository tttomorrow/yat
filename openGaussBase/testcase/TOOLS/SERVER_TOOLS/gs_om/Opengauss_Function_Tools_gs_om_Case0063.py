...
class Tools(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('--Opengauss_Function_Tools_gs_om_Case0063start--')
    ...
    def test_server_tools1(self):
        ...
        self.assertIn('instance_id', msg2)

    def tearDown(self):
        self.logger.info('--------------无需清理环境------------------')
        self.logger.info('--Opengauss_Function_Tools_gs_om_Case0063finish--')
