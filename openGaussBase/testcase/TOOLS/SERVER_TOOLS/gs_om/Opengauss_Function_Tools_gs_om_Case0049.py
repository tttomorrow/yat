...
"""
Case Type   : 服务端工具
Case Name   : 数据库关闭时，指定服务器名称和日志存放路径
Description :
    1.查看数据库状态：gs_om -t status --detail
    2.关闭数据库指定-h参数的值和-l是否可以关闭成功
    3.查看日志文件
...
class Tools(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info('---Opengauss_Function_Tools_gs_om_Case0049start---')
    ...
    def test_server_tools1(self):
        ...
        self.log.info('----------关闭数据库指定-h参数的值和-l是否可以关闭成功----------')
    ...
    def tearDown(self):
        ...
        self.log.info(start_cmd)
        self.log.info('--Opengauss_Function_Tools_gs_om_Case0049finish--')
