...
"""
Case Type   : 服务端工具
Case Name   : 开启集群内安装kerberos客户端认证（未安装服务端）
Description :
    1.开启集群内安装kerberos客户端认证
...
class Tools(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('--Opengauss_Function_Tools_gs_om_Case0088start--')
    ...
    def test_server_tools1(self):
        ...
        self.assertIn(".xml does not exist", msg1)
    ...
    def tearDown(self):
        ...
        self.logger.info('--Opengauss_Function_Tools_gs_om_Case0088finish--')
