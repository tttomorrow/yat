...
"""
Case Type   : 服务端工具
Case Name   : 查询数据库状态时，将显示状态的详细信息
Description :
    1.查询数据库状态:gs_om -t status
    2.查询数据库状态时，显示详细信息:gs_om -t status --detail --all
Expect      :
    1.只提示该服务器正常
    2.显示数据库详细信息,状态正常
History     :
...
class Tools(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('--Opengauss_Function_Tools_gs_om_Case0071start--')
    ...
    def tearDown(self):
        ...
        self.logger.info('--Opengauss_Function_Tools_gs_om_Case0071finish--')
