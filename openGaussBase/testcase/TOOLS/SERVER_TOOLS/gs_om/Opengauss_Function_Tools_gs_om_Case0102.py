...
"""
Case Type   : 系统内部工具
Case Name   : 数据库状态异常时(停止数据库主节点),查询数据库状态及节点信息
Description :
    1、停止数据库主节点,gs_ctl stop -D {dn1} -M primary
...
class Tools(unittest.TestCase):
    ...
    def setUp(self):
        logger.info("======Opengauss_Function_Tools_gs_om_Case0102开始执行======")
    ...
    def test_server_tools(self):
        ...
        logger.info("======主机停止成功 && port正确======")
        try:
            if 'Down' in new_status_list[0]:
                logger.info("======主节点停止成功======")
        except Exception as e:
            logger.info("======主节点未停止成功======")
            raise e
        finally:
            logger.info("======主机状态校验完成======")
        ...
        logger.info("======步骤4:结合-h,-o参数，-h指定主机，查看状态信息======")
        ...
        logger.info("======当前指定节点(主节点)状态为Down======")
    ...
    def tearDown(self):
        ...
        if 'Normal' not in status_msg.splitlines()[10]:
            ...
            logger.info("======主备节点正常======")
        logger.info("======Opengauss_Function_Tools_gs_om_Case0102执行结束======")
