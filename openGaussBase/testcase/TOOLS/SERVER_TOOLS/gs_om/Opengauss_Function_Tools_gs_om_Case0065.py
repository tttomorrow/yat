...
"""
Case Type   : 服务端工具
Case Name   : 查询数据库状态时，显示指定服务器数据库详细信息
Description :
    1.查询数据库状态时，显示指定服务器数据库详细信息
    2.查看显示是否正确
Expect      :
    1.查询成功
    2.显示正确
...
class Tools(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('--Opengauss_Function_Tools_gs_om_Case0065start--')
    ...
    def test_server_tools1(self):
        ...
        self.logger.info('------查询数据库状态时，显示指定服务器数据库详细信息-------')
    ...
    def tearDown(self):
        ...
        self.logger.info('--Opengauss_Function_Tools_gs_om_Case0065finish--')
