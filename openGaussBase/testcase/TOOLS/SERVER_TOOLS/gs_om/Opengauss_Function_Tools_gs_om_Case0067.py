...
class Tools(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('--Opengauss_Function_Tools_gs_om_Case0067start--')
    ...
    def test_server_tools1(self):
        ...
        self.logger.info('----查询数据库状态时，指定服务器名称并指定日志文件和结果输出文件及存放路径----')
    ...
    def tearDown(self):
        ...
        self.logger.info('--Opengauss_Function_Tools_gs_om_Case0067finish--')
