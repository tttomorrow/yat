...
"""
Case Type   : 系统内部工具
Case Name   : 主备切换--switchover后,查询数据库状态，校验节点信息
Description :
    1、主备正常情况下，进行主备切换;
...
class Tools(unittest.TestCase):
    ...
    def test_server_tools(self):
        ...
        logger.info("======步骤1:switchover进行主备切换，刷新动态配置文件，重启数据库======")
        ...
        logger.info("======步骤4:结合-h,-o参数，-h指定切换后的备机，查看状态信息======")
