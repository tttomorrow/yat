...
"""
Case Type   : 服务端工具
Case Name   : 导出纯文本格式内容的数据库全量信息时指定用户
Description :
    1.连接数据库：
    2.创建数据库
    3.切换到数据库test
...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----Opengauss_Function_Tools_gs_dump_Case0025start----')
    ...
    def test_server_tools(self):
        ...
        LOG.info('-----导出纯文本格式内容的数据库全量信息时指定用户-----')
    ...
    def tearDown(self):
        ...
        LOG.info(msg4)
        LOG.info('----Opengauss_Function_Tools_gs_dump_Case0025finish----')
