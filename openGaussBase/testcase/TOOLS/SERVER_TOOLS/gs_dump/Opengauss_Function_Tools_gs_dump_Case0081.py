...
Description :
    ...
    5.退出数据库
    6.source环境变量
    7.备份结果不包含指定对象自身的信息(--exclude-self同-t数关联使用)
    8.连接数据库，清理环境
Expect      :
    1.数据库连接成功
    2.创建数据库test成功
...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----opengauss_function_tools_gs_dump_case0081start------')
    ...
    def tearDown(self):
        ...
        LOG.info(msg4)
        LOG.info('----opengauss_function_tools_gs_dump_case0081finish----')
