...
"""
Case Type   : 服务端工具
Case Name   : 备份结果依赖指定对象自身的信息
              (--include-depend-objs同-t参数关联使用)
Description :
    1.连接数据库
    2.创建数据库test
    3.切换到数据库test
...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----opengauss_function_tools_gs_dump_case0080start------')
    ...
    def tearDown(self):
        ...
        LOG.info(msg4)
        LOG.info('----opengauss_function_tools_gs_dump_case0080finish----')
