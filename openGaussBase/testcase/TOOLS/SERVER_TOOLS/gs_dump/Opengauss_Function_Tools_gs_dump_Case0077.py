...
"""
Case Type   : 服务端工具
Case Name   : 使用参数--binary-upgrade是否可以导出数据
Description :
    1.连接数据库
    2.创建数据库test
    3.切换到数据库test
...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----Opengauss_Function_Tools_gs_dump_Case0077start------')
    ...
    def test_server_tools(self):
        ...
        LOG.info('-------使用参数--binary-upgrade是否可以导出数据---------')
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('---Opengauss_Function_Tools_gs_dump_Case0077finish---')
