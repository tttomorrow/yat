...
"""
Case Type   : 服务端工具
Case Name   : 任何匹配pattern的表数据都不会导出
Description :
    1.连接数据库
    2.创建数据库test
    3.切换到数据库test
...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('------Opengauss_Function_Tools_gs_dump_Case0051start------')
    ...
    def tearDown(self):
        ...
        LOG.info(msg4)
        LOG.info('----Opengauss_Function_Tools_gs_dump_Case0051finish----')
