...
"""
Case Type   : 服务端工具
Case Name   : 修改dump导出的数据文件后，再导入(目录归档格式:dir.lock文件)
Description :
    1.创建数据
    2.执行导出操作
...
class Tools(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info(
            '---Opengauss_Function_Tools_gs_dump_Case0107start---')
        ...
        self.db_name1 = "db_dump0107_01"
        self.db_name2 = "db_dump0107_02"
        self.tb_name = "t_dump0107"
    ...
    def test_tools_dump(self):
        ...
        sed_cmd = f"sed -i '$a qweweewrrcxcbgvhzjggsdggcsss" \
            f"case modified success' {self.dump_dir1}/dir.lock ;"
    ...
    def tearDown(self):
        ...
        self.log.info(sql_cmd)
        self.log.info(
            '------Opengauss_Function_Tools_gs_dump_Case0107finish------')