...
"""
Case Type   : 服务端工具
Case Name   : 导出数据库时输出一个自定义格式的文件,不指定-f参数
Description :
    1.连接数据库：
    2.创建数据库
    3.切换到数据库test
...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----Opengauss_Function_Tools_gs_dump_Case0008start----')
    ...
    def test_server_tools(self):
        ...
        LOG.info('--导出数据库时输出一个自定义格式的文件，不指定-f参数--')
    ...
    def tearDown(self):
        ...
        LOG.info(msg4)
        LOG.info('----Opengauss_Function_Tools_gs_dump_Case0008finish----')
