...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('-----Opengauss_Function_Tools_gs_dump_Case0045start----')
    ...
    def test_server_tools(self):
        ...
        LOG.info('---------不转储任何与-T选项匹配的视图----------')
        excute_cmd3 = f'''source {macro.DB_ENV_PATH} ;
        gs_dump -p {self.dbuser_node.db_port} test -F p -T view1 -T view2;
                      '''
    ...
    def tearDown(self):
        ...
        LOG.info(msg5)
        LOG.info('-----Opengauss_Function_Tools_gs_dump_Case0045finish-----')
