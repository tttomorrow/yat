...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----Opengauss_Function_Tools_gs_dump_Case0031start-----')
    ...
    def test_server_tools(self):
        ...
        gs_dump -p {self.dbuser_node.db_port} test --format=p -E GBK ; '''
        ...
        gs_dump -p {self.dbuser_node.db_port} test --format=p -c -E UTF-8; '''
    ...
    def tearDown(self):
        ...
        LOG.info(msg5)
        LOG.info('----Opengauss_Function_Tools_gs_dump_Case0031finish----')
