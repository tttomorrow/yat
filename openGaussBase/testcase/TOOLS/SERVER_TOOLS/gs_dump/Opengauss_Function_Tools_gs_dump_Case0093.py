...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----opengauss_function_tools_gs_dump_case0093start------')
    ...
    def tearDown(self):
        ...
        LOG.info(msg4)
        LOG.info('---opengauss_function_tools_gs_dump_case0093finish---')
