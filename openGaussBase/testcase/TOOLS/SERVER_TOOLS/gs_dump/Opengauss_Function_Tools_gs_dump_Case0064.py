...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----opengauss_function_tools_gs_dump_case0064start------')
    ...
    def test_server_tools(self):
        ...
        gs_dump -p {self.dbuser_node.db_port} test -F p\
         -f {macro.DB_INSTANCE_PATH}/dump_qm\
                      '''
    ...
    def tearDown(self):
        ...
        LOG.info(msg5)
        LOG.info('----opengauss_function_tools_gs_dump_case0064finish----')
