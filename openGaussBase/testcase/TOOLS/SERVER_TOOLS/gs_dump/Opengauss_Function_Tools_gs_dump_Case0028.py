...
"""
Case Type   : 服务端工具
Case Name   : 导出数据库对象的指令输出到备份文件之前，先将删除数据库对象
              的指令输出到文件（导出文件格式为文本格式以外的其他格式）
Description :
    1.连接数据库
    2.创建数据库
    3.切换到数据库test
...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----Opengauss_Function_Tools_gs_dump_Case0028start ---')
    ...
    def tearDown(self):
        ...
        LOG.info(msg9)
        LOG.info('----Opengauss_Function_Tools_gs_dump_Case0028finish----')
