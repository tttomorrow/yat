...
"""
Case Type   : 服务端工具
Case Name   : 备份结果不包含指定对象自身的信息，分别指定表
Description :
    1.连接数据库
    2.创建数据库test
    3.切换到数据库test
...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----opengauss_function_tools_gs_dump_case0082start------')
    ...
    def test_server_tools(self):
        ...
        LOG.info('-----在创建好的数据库中创建表插入数据，创建视图----')
        sql_cmd2 = ''' 
    ...
    def tearDown(self):
        ...
        LOG.info(msg4)
        LOG.info('----opengauss_function_tools_gs_dump_case0082finish----')
