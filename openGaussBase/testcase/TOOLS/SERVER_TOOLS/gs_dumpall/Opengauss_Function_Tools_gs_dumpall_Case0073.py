...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----Opengauss_Function_Tools_gs_dumpall_Case0073start----')
    ...
    def test_server_tools(self):
        ...
        sql_cmd1 = '''drop table if exists test1; 
            ...
            create role role2 identified by 'qwer@123';
            '''
        ...
        LOG.info(cat_msg)
        self.assertIn('CREATE ROLE role1', cat_msg)
        self.assertIn('CREATE ROLE role2', cat_msg)

    def tearDown(self):
        LOG.info('---清理环境---')
        sql_cmd2 = '''drop role  role1; 
            drop role  role2; 
            drop table test1;
            '''
        ...
        LOG.info(clear_msg)
        LOG.info('----Opengauss_Function_Tools_gs_dumpall_Case0073finish----')
