...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----Opengauss_Function_Tools_gs_dumpall_Case0074start----')
    ...
    def test_server_tools(self):
        ...
        self.assertIn('CREATE TABLESPACE tbspace ', cat_msg)
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('----Opengauss_Function_Tools_gs_dumpall_Case0074finish----')
