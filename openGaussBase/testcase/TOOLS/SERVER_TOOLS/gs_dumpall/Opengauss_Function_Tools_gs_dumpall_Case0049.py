...
class Tools(unittest.TestCase):
    ...
    def test_server_tools(self):
        ...
        LOG.info('--在导出的角色相关指令前添加清理指令--')
        dumpall_cmd = f'''source {macro.DB_ENV_PATH} ;
            gs_dumpall -p {self.dbuser_node.db_port}  -r -c;
            '''
        ...
        self.assertIn('DROP ROLE IF EXISTS', dumpall_msg)
        self.assertIn('CREATE ROLE', dumpall_msg)
