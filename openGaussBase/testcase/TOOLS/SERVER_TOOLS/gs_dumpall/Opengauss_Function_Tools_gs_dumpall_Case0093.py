...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----Opengauss_Function_Tools_gs_dumpall_Case0093start----')
        self.dbuser_node = Node('dbuser')
        self.constant = Constant()
        self.templatedb_msg = "dump database dbname='template1' successfully"
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('----Opengauss_Function_Tools_gs_dumpall_Case0093finish----')
