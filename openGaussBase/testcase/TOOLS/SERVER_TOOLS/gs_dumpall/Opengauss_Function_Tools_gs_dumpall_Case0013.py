...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----Opengauss_Function_Tools_gs_dumpall_Case0013start----')
    ...
    def test_server_tools(self):
        ...
        insert into test2 values (3,'cc'),(4,'dd');
                                '''
        excute_cmd1 = f'''   
        ...
        LOG.info('------导出每个表的对象标识符-----')
        excute_cmd2 = f'''
                source {macro.DB_ENV_PATH} ;
                gs_dumpall -p {self.dbuser_node.db_port} -O ;
                          '''
        ...
        self.assertIn('CREATE TABLE test2', msg2)
        self.assertIn('COPY test1', msg2)
        self.assertIn('COPY test2', msg2)
    ...
    def tearDown(self):
        ...
        LOG.info(msg3)
        LOG.info('----Opengauss_Function_Tools_gs_dumpall_Case0013finish----')
