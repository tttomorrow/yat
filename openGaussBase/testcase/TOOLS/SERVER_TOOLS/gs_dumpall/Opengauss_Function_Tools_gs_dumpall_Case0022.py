...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----Opengauss_Function_Tools_gs_dumpall_Case0022start----')
    ...
    def test_server_tools(self):
        ...
        excute_cmd2 = f'''
                ...
                gs_dumpall -p {self.dbuser_node.db_port}  -g -t;
                          '''
...
-t/--tablespaces-only cannot be used together', msg2)
    ...
    def tearDown(self):
        ...
        LOG.info(msg3)
        LOG.info('----Opengauss_Function_Tools_gs_dumpall_Case0022finish----')
