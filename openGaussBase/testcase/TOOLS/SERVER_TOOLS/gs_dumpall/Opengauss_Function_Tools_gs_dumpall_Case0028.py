...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----Opengauss_Function_Tools_gs_dumpall_Case0028start----')
    ...
    def test_server_tools(self):
        ...
        self.assertIn('INSERT INTO t1 VALUES (1);', msg2)
        self.assertIn('INSERT INTO t2 VALUES (8);', msg2)
    ...
    def tearDown(self):
        ...
        LOG.info(msg3)
        LOG.info('----Opengauss_Function_Tools_gs_dumpall_Case0028finish----')
