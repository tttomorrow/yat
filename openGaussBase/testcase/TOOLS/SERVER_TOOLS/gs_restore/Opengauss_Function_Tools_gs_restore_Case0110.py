...
class Tools(unittest.TestCase):
    ...
    def test_server_tools1(self):
        self.log.info("--Opengauss_Function_Tools_gs_restore_Case0110开始执行--")
        self.log.info("-----------------创建数据--------------")
        ...
        check_cmd = f"source {macro.DB_ENV_PATH};" \
            ...
            f"-d {self.db_name} " \
            f"{macro.DB_INSTANCE_PATH}/test.tar -s " \
            f"-I index1 -I index2"
    ...
    def tearDown(self):
        ...
        self.log.info('-Opengauss_Function_Tools_gs_restore_Case0110执行结束-')
