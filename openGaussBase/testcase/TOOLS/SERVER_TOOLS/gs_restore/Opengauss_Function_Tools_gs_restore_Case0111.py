...
class Tools(unittest.TestCase):
    ...
    def test_server_tools1(self):
        self.log.info("--Opengauss_Function_Tools_gs_restore_Case0111开始执行--")
        self.log.info("-----------------创建数据--------------")
        ...
        dump_cmd = f"source {macro.DB_ENV_PATH};" \
            ...
            f"{self.db_name} -f " \
            f"{macro.DB_INSTANCE_PATH}/test.tar -F t"
        ...
        restore_cmd = f"source {macro.DB_ENV_PATH};" \
            ...
            f"-n schema1 -n schema2 -n schema3 -I index1 ; " \
        ...
        self.log.info(msg)
        self.assertIn('ERROR:  relation "index1" already exists', msg)
    ...
    def tearDown(self):
        ...
        self.log.info("-Opengauss_Function_Tools_gs_restore_Case0111执行结束-")
