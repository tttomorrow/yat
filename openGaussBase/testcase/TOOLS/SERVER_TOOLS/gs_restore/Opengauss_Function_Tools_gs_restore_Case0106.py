...
class Tools(unittest.TestCase):
    ...
    def test_server_tools1(self):
        self.log.info("--Opengauss_Function_Tools_gs_restore_Case0106开始执行--")
        self.log.info("-----------------创建数据--------------")
        ...
        self.log.info(msg)
        self.assertIn('ERROR:  relation "test4" already exists', msg)
    ...
    def tearDown(self):
        ...
        self.log.info("-Opengauss_Function_Tools_gs_restore_Case0106执行结束-")
