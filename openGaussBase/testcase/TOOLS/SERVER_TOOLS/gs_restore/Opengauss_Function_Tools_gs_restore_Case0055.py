...
"""
Case Type   : 服务端工具
Case Name   : 导入到数据库，创建表的命令失败（如表已经存在），会报错，数据不被导入
Description :
    1.创建数据
    2.导出数据
    3.导入数据
...
class Tools(unittest.TestCase):
    ...
    def test_server_tools1(self):
        self.log.info("--Opengauss_Function_Tools_gs_restore_Case0055开始执行--")
        self.log.info("----------------------创建数据-----------------------")
    ...
    def tearDown(self):
        ...
        self.log.info("--Opengauss_Function_Tools_gs_restore_Case0055执行结束--")
