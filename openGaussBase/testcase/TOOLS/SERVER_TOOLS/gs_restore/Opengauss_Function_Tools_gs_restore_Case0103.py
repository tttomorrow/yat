...
class Tools(unittest.TestCase):
    ...
    def test_server_tools1(self):
        self.log.info("--Opengauss_Function_Tools_gs_restore_Case0103开始执行--")
        self.log.info("-----------------创建数据--------------")
        ...
        self.assertIn('3 rows', restore_msg)
    ...
    def tearDown(self):
        ...
        self.log.info("-Opengauss_Function_Tools_gs_restore_Case0103执行结束-")
