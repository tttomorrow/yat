...
class Tools(unittest.TestCase):
    def setUp(self):
        Log.info("--Opengauss_Function_Tools_gs_restore_Case0036开始执行--")
    ...
    def test_server_tools1(self):
        ...
        restore_cmd = f"source {macro.DB_ENV_PATH};" \
            ...
            f"-n schema1 -n schema2 -t test1 -t test4"
    ...
    def tearDown(self):
        ...
        Log.info(msg)
        Log.info("---Opengauss_Function_Tools_gs_restore_Case0036执行结束---")
