...
class Tools(unittest.TestCase):
    def setUp(self):
        Log.info("--Opengauss_Function_Tools_gs_restore_Case0030开始执行--")
    ...
    def test_server_tools1(self):
        ...
        restore_cmd = f"source {macro.DB_ENV_PATH};" \
            ...
            f"/home/test_restore/test2.tar -i"
        Log.info(restore_cmd)
        msg = self.dbuser_node.sh(restore_cmd).result()
        Log.info(msg)
        self.assertIn("gs_restore: invalid option -- 'i'", msg)
    ...
    def tearDown(self):
        ...
        Log.info(msg)
        Log.info("---Opengauss_Function_Tools_gs_restore_Case0030执行结束---")
