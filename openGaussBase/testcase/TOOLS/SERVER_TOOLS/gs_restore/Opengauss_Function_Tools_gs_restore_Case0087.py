...
class Tools(unittest.TestCase):
    ...
    def test_server_tools1(self):
        self.log.info("--Opengauss_Function_Tools_gs_restore_Case0087开始执行--")
        self.log.info("-----------------创建数据--------------")
        ...
        restore_cmd = f"source {macro.DB_ENV_PATH};" \
            ...
            f"schema1 -n schema2 -n schema4 -a"
        ...
        sql_cmd = self.commonsh.execut_db_sql(f'''
            ...
            select * from test5;''', dbname=self.db_name)
        self.log.info(sql_cmd)
    ...
    def tearDown(self):
        ...
        self.log.info("-Opengauss_Function_Tools_gs_restore_Case0087执行结束-")
