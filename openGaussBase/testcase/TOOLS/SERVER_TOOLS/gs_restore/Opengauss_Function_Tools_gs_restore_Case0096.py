...
class Tools(unittest.TestCase):
    ...
    def test_server_tools1(self):
        self.log.info("--Opengauss_Function_Tools_gs_restore_Case0096开始执行--")
        self.log.info("-----------------创建数据--------------")
        ...
        restore_cmd = f"source {macro.DB_ENV_PATH}; " \
            ...
            f"-d test  {macro.DB_INSTANCE_PATH}/test.tar " \
            f"-n schema1 -n schema2 -n schema4 -c"
        ...
        self.log.info("--------查看导入数据，只导test1、test2----")
        ...
        self.assertIn('schema "schema3" does not exist', msg)
    ...
    def tearDown(self):
        ...
        self.log.info("-Opengauss_Function_Tools_gs_restore_Case0096执行结束-")
