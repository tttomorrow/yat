...
"""
Case Type   : 服务端工具
Case Name   : gs_checkperf工具显示帮助信息(正常)
Description :
    1.显示帮助信息(-？)
    2.显示帮助信息(--help)
Expect      :
...
class Tools(unittest.TestCase):
    def setUp(self):
        logger.info('--------------Opengauss_Function_Tools_gs_checkperf_Case0001start-------------------')
    ...
    def test_server_tools1(self):
        ...
        for cmd in cmd_list:
            ...
            parameter = ['-U', '-o', '-i', '-i', '-i', '--detail', '-l', '-?,', '--help', '-V,', '--version']
    ...
    def tearDown(self):
        logger.info('--------------无需清理环境-------------------')
        logger.info('------------------Opengauss_Function_Tools_gs_checkperf_Case0001finish------------------')