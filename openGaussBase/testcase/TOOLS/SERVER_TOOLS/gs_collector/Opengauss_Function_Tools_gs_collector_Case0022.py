...
class Tools(unittest.TestCase):
    ...
    def setUp(self):
        self.log = Logger()
        self.log.info(
            '-----Opengauss_Function_Tools_gs_collector_Case0022start------')
        self.dbusernode = Node('PrimaryDbUser')
        self.standby1dbuser = Node('Standby1DbUser')
    ...
    def test_server_tools1(self):
        ...
        test_str = r'''{{"Collect":[{{"TypeName": "System", "Content":
            "RunTimeInfo, HardWareInfo","Interval":"3", "Count":"2"}}]}}'''
        ...
        self.log.info('-----步骤2：收集现在操作系统的状态信息-----')
    ...
    def tearDown(self):
        ...
        self.log.info(
            '------Opengauss_Function_Tools_gs_collector_Case0022finish-----')