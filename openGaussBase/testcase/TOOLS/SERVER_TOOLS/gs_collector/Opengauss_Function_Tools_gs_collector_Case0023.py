...
class Tools(unittest.TestCase):
    ...
    def setUp(self):
        self.log = Logger()
        self.log.info(
            '-----Opengauss_Function_Tools_gs_collector_Case0023start-----')
    ...
    def test_server_tools1(self):
        ...
        test_str = r'''{{"Collect":[{{"TypeName": "Database", "Content":
            "pg_locks","Interval":"3", "Count":"2"}}]}}'''
        ...
        self.log.info('-----步骤2：收集系统视图或者系统表的内容-----')
    ...
    def tearDown(self):
        ...
        self.log.info(
            '-----Opengauss_Function_Tools_gs_collector_Case0023finish-----')
