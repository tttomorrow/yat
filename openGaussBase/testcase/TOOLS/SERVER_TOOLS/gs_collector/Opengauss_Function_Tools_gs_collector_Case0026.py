...
class Tools(unittest.TestCase):
    ...
    def setUp(self):
        self.log = Logger()
        self.log.info(
            '-----Opengauss_Function_Tools_gs_collector_Case0026start-----')
    ...
    def test_server_tools1(self):
        ...
        test_str = r'''{{"Collect":[{{"TypeName": "Config", "Content":
            "DataNode", "Interval":"0", "Count":"1"}}]}}'''
        ...
        self.log.info('-----步骤2：收集DataNode的配置信息-----')
    ...
    def tearDown(self):
        ...
        self.log.info(
            '-----Opengauss_Function_Tools_gs_collector_Case0026finish-----')