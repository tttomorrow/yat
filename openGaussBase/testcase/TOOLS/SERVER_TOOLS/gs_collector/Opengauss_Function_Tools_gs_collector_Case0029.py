...
class Tools(unittest.TestCase):
    ...
    def setUp(self):
        self.log = Logger()
        self.log.info(
            '-----Opengauss_Function_Tools_gs_collector_Case0029start-----')
    ...
    def test_server_tools1(self):
        ...
        test_str = r'''{{"Collect":[{{"TypeName": "Plan", "Content":
            "*","Interval":"3", "Count":"2"}}]}}'''
        ...
        self.log.info('-----步骤2：收集所有数据库上的计划复现信息-----')
    ...
    def tearDown(self):
        ...
        self.log.info(
            '-----Opengauss_Function_Tools_gs_collector_Case0029finish-----')