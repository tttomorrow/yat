...
class Tools(unittest.TestCase):
    ...
    def test_server_tools1(self):
        self.log.info(
            '-----Opengauss_Function_Tools_gs_collector_Case0024start-----')
        ...
        text = '---step2:收集log类型信息下的DataNode信息;expect:收集成功---'
        self.log.info(text)
        self.log.info('获取信息收集的开始和结束时间')
    ...
    def tearDown(self):
        ...
        self.log.info(
            '-----Opengauss_Function_Tools_gs_collector_Case0024finish-----')
