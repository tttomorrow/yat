...
class Tools(unittest.TestCase):
    ...
    def setUp(self):
        self.log = Logger()
        self.log.info(
            '-----Opengauss_Function_Tools_gs_collector_Case0030start-----')
    ...
    def test_server_tools1(self):
        ...
        test_str = r'''{{"Collect" : [{{"TypeName" : "Plan", "Content" : "%s",
            "Interval" : "3", "Count" : "2"}}]}}''' % (
            self.dbusernode.db_name)
        ...
        self.log.info('-----步骤2：收集指定数据库上的计划复现信息-----')
    ...
    def tearDown(self):
        ...
        self.log.info(
            '-----Opengauss_Function_Tools_gs_collector_Case0030finish-----')
