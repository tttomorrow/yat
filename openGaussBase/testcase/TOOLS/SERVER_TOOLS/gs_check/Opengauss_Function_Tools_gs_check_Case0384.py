...
"""
Case Type   : 服务端工具
Case Name   : 升级巡检场景检查，跳过root权限检查项，并生成log文件
Description :
     1.升级巡检场景检查，跳过root权限检查项，并生成log文件
     2.检查指定路径下是否生成log文件
     3.删除生成的log文件
Expect      :
...
class Tools(unittest.TestCase):
    ...
    def setUp(self):
        self.log = Logger()
        self.log.info('---Opengauss_Function_Tools_gs_check_Case0384start---')
        self.dbuser_node = Node('dbuser')
        self.constant = Constant()

    def test_server_tools1(self):
        self.log.info('----------升级巡检场景检查，跳过root权限检查项，并生成log文件----------')
    ...
    def tearDown(self):
        ...
        self.log.info('--Opengauss_Function_Tools_gs_check_Case0384finish--')
