...
"""
Case Type   : 服务端工具
Case Name   : gs_check工具显示帮助信息(--h)
Description : 显示帮助信息(--h)
Expect      : 显示失败，合理报错
History     : 
"""
import unittest
...
class Tools(unittest.TestCase):
    def setUp(self):
        logger.info('--------------Opengauss_Function_Tools_gs_check_Case0341start-------------------')
    ...
    def tearDown(self):
        logger.info('--------------无需清理环境-------------------')
        logger.info('------------------Opengauss_Function_Tools_gs_check_Case0341finish------------------')