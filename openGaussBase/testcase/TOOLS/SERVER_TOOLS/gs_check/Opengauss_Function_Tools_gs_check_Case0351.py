...
"""
Case Type   : 服务端工具
Case Name   : 健康检查巡检场景（health）
Description :
     健康检查巡检场景：gs_check -e health
Expect      :
     检查完成
History     :
"""
...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('----Opengauss_Function_Tools_gs_check_Case0351start----')
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('-----------------产生的文件清理完成------------------')
        LOG.info('---Opengauss_Function_Tools_gs_check_Case0351finish---')
