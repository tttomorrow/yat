...
"""
Case Type   : 服务端工具
Case Name   : root用户检查comm_max_datanode参数值范围小于数据库节点个数
Description :
...
class Tools(unittest.TestCase):
    def setUp(self):
        LOG.info('-----Opengauss_Function_Tools_gs_check_Case0068start-----')
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('-----------------产生的文件清理完成------------------')
        LOG.info('----Opengauss_Function_Tools_gs_check_Case0068finish----')