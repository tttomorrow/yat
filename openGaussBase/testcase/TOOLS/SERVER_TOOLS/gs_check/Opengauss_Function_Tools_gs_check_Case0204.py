...
Description :
    1.运行openGauss的用户检查指定检查项： gs_check -i CheckFirewall -U
...
class Tools(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info(
            '-----Opengauss_Function_Tools_gs_check_Case0204_start-----')
    ...
    def test_server_tools(self):
        text = '-----step1:运行openGauss的用户检查指定检查项:防火墙状态;expect:检查完成-----'
        self.log.info(text)
    ...
    def tearDown(self):
        ...
        self.log.info(
            '----Opengauss_Function_Tools_gs_check_Case0204_finish----')
