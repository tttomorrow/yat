...
"""
Case Type   : 服务端工具
Case Name   : omm用户进行健康检查巡检场景检查（health）
Description :
     健康检查巡检场景检查：gs_check -e health  -U omm
Expect      :
     检查完成
History     :
"""
...
class Tools(unittest.TestCase):
    ...
    def setUp(self):
        LOG.info('----Opengauss_Function_Tools_gs_check_Case0361start----')
    ...
    def test_server_tools1(self):
        ...
        check_cmd1 = f'''source {macro.DB_ENV_PATH};
            gs_check -e health  -U {self.dbuserNode.ssh_user};
            '''
        LOG.info(check_cmd1)
    ...
    def tearDown(self):
        ...
        LOG.info(clear_msg)
        LOG.info('-----------------产生的文件清理完成------------------')
        LOG.info('---Opengauss_Function_Tools_gs_check_Case0361finish---')
