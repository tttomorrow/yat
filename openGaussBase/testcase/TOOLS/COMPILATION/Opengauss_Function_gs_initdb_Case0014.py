...
"""
Case Type   : tools
Case Name   : 执行初始化数据库命令gs_initdb：指定参数--dbcompatibility，兼容Mysql
Description :
...
class Tools(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('----Opengauss_Function_gs_initdb_Case0014 start----')
    ...
    def test_systools(self):
        ...
        excute_cmd1 = f'source {self.DB_ENV_PATH};gs_initdb -D ' \
                      ...
                      f'{self.userNode.ssh_password} --dbcompatibility=B'
    ...
    def tearDown(self):
        ...
        self.logger.info('---Opengauss_Function_gs_initdb_Case0014 finish---')
