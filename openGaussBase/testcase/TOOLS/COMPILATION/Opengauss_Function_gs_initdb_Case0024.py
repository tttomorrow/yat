...
Description :
    ...
    --text-search-config=pg_catalog.english
Expect      :
    1.初始化成功，在屏幕上显示当前设置为The default text search configuration will
    be set to "pg_catalog.english"的相关信息
History     :
"""
import os
import unittest
...
class Tools(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('----Opengauss_Function_gs_initdb_Case0024 start----')
    ...
    def test_systools(self):
        ...
        excute_cmd1 = f'source {self.DB_ENV_PATH};gs_initdb -D ' \
                      ...
                      f'--text-search-config=pg_catalog.english'
    ...
    def tearDown(self):
        ...
        self.logger.info('---Opengauss_Function_gs_initdb_Case0024 finish---')
