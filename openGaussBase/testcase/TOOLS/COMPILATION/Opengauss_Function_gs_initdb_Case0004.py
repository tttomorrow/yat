...
"""
Case Type   : tools
Case Name   : 执行初始化数据库命令gs_initdb：指定参数--nodename为大写字母
Description :
...
class Tools(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('----Opengauss_Function_gs_initdb_Case0004 start----')
    ...
    def tearDown(self):
        self.logger.info('---Opengauss_Function_gs_initdb_Case0004 finish---')
