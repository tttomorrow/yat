...
class IndexFileDamaged(unittest.TestCase):
    def setUp(self):
        ...
        logger.info('--------------Opengauss_Function_System_Table_Case0037开始执行--------------')
        self.userNode = Node('dbuser')
        self.DB_ENV_PATH = macro.DB_ENV_PATH
        self.com = Common()
        self.comsh = CommonSH('dbuser')
        self.expect_result_dict = {'Column': ['job_id', 'what'], 'Type': ['integer', 'text']}
    ...
    def tearDown(self):
        ...
        # 无须清理环境
        logger.info('-----------------------Opengauss_Function_System_Table_Case0037执行完成-----------------------------')
