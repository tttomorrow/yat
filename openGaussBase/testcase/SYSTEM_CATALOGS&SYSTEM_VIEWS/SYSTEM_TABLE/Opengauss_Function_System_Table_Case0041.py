...
class SystemTable(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info(
            '------Opengauss_Function_System_Table_Case0041start-------')
        self.userNode = Node('dbuser')
        self.DB_ENV_PATH = macro.DB_ENV_PATH
        self.com = Common()
        self.comsh = CommonSH('dbuser')
        self.expect_result_dict = {
            'Column': ['nspname', 'nspowner', 'nsptimeline', 'nspacl',
                       'in_redistribution', 'nspblockchain'],
    ...
    def tearDown(self):
        self.log.info(
            '-------Opengauss_Function_System_Table_Case0041finish-------')
