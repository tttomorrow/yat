...
class IndexFileDamaged(unittest.TestCase):
    def setUp(self):
        ...
        logger.info('--------------Opengauss_Function_System_View_Case0035开始执行--------------')
        self.com = Common()
        self.comsh = CommonSH('dbuser')
        self.expect_result_dict = {
            'Column': ['query_id', 'mincurriops', 'maxcurriops', 'minpeakiops', 'maxpeakiops', 'io_limits',
                       'io_priority', 'query', 'node_group'],
            'Type': ['bigint', 'integer', 'integer', 'integer', 'integer', 'integer', 'text', 'text', 'text']}
    ...
    def tearDown(self):
        ...
        # 无须清理环境
        logger.info('-----------------------Opengauss_Function_System_View_Case0035执行完成-----------------------------')
