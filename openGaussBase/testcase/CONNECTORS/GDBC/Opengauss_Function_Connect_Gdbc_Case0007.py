...
class ConnGO7(unittest.TestCase):
    def setUp(self):
    ...
    def test_1(self):
        ...
        text = '----step3: 连接数据库，delete多表 expect: 成功----'
        self.log.info(text)
        ...
        s_sql = f'{clean_sql}' \
            ...
            f'delete from {self.t_name}_1 a using {self.t_name}_2 b ' \
            f'where a.id=b.id and a.id<10;'
