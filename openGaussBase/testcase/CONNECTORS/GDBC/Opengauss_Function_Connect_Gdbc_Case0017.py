...
class ConnGO17(unittest.TestCase):
    def setUp(self):
    ...
    def test_1(self):
        ...
        text = '----step3: 连接数据库，匿名块 expect: 成功----'
        self.log.info(text)
        ...
        s_sql = f'{clean_sql}' \
            ...
            f'generate_series(1,100000),\'c-\'||generate_series(1,10));' \
            f'end;'
        ...
        self.assertIn('100000', res, f'执行失败: {text}')
