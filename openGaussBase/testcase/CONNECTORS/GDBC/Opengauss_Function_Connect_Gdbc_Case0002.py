...
"""
Case Type   : go驱动
Case Name   : md5认证方法连接数据库
Description :
    1.新建用户并赋权
    2.配置pg_hba入口, md5认证方法
    3.连接数据库
    4.还原pg_hba文件
    5.删除用户
    6.刪除go_conn.go
...
class ConnGO2(unittest.TestCase):
    def setUp(self):
