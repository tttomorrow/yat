...
"""
Case Type   : 数据库系统
Case Name   : 预编译sql为查询*所有数据，执行预编译sql语句过程中修改表结构-增加字段
Description :
    1.创建配置文件
    2.编译java文件
...
class JDBCPrepareStatement(unittest.TestCase):
    ...
    def test_main(self):
        ...
        alter_sql = f'alter table {self.tb_name} add ' \
            f'column c_customer_bak2 char(40) ;\d {self.tb_name}'
    ...
    def tearDown(self):
        ...
        self.log.info(
            '----Opengauss_Function_JDBC_PrepareStatement_Case0021:end----')
