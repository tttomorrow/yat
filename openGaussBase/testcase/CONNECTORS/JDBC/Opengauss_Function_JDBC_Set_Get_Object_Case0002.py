...
"""
Case Type   : 数据库系统
Case Name   : 数据库兼容A模式，localdatetime类型setObject插入Date类型数据，并使用getObject获取结果
Description :
    1.写配置文件
    2.编译java工具
    3.运行java工具
...
class Jdbcisreadonly(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info("Opengauss_Function_JDBC_Set_Get_Object_Case0002 start")
        ...
        self.java_name = "jdbc_set_get_object_case0002"
        self.common = Common()
    ...
    def test_index(self):
        ...
        self.assertIn(f'第5行结果：1970-01-01T00:00', result)
        self.assertIn(f'第6行结果：2021-01-29T21:59', result)
        self.assertIn(f'第7行结果：{today}', result)
        self.assertIn('第8行结果：2020-02-29T23:59:59', result)
    ...
    def tearDown(self):
        ...
        self.log.info("Opengauss_Function_JDBC_Set_Get_Object_Case0002 end")