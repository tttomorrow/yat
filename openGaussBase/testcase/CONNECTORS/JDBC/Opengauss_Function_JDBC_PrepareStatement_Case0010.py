...
"""
Case Type   : 数据库系统
Case Name   : 预编译sql为删除数据，执行预编译sql语句过程中修改表结构-修改字段名称
Description :
    1.创建配置文件
    2.编译java文件
...
class JDBCPrepareStatement(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        self.log.info(
            '----Opengauss_Function_JDBC_PrepareStatement_Case0010:end----')
