...
class Jdbcisreadonly(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info("Opengauss_Function_JDBC_Set_Get_Object_Case0009 start")
        ...
        self.java_name = "jdbc_set_get_object_case0009"
        self.common = Common()
    ...
    def test_index(self):
        ...
        yesterday = \
            (date.today() + timedelta(days=-2)).strftime("%Y-%m-%dT16:00")
    ...
    def tearDown(self):
        ...
        self.log.info("Opengauss_Function_JDBC_Set_Get_Object_Case0009 end")