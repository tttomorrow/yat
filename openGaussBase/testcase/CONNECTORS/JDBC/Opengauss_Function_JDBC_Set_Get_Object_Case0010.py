...
class Jdbcisreadonly(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info("Opengauss_Function_JDBC_Set_Get_Object_Case0010 start")
        ...
        self.java_name = "jdbc_set_get_object_case0010"
        self.common = Common()
    ...
    def test_index(self):
        ...
        today = (date.today() +
                 timedelta(days=-1)).strftime("%Y-%m-%dT16:00")
        self.assertIn(f'第12行结果：{today}', result)
        tomorrow = (date.today()).strftime("%Y-%m-%dT16:00")
        self.assertIn(f'第13行结果：{tomorrow}', result)
        yesterday = (date.today() +
                     timedelta(days=-2)).strftime("%Y-%m-%dT16:00")
    ...
    def tearDown(self):
        ...
        self.log.info("Opengauss_Function_JDBC_Set_Get_Object_Case0010 end")
