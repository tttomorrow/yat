...
class Jdbcisreadonly(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info("Opengauss_Function_JDBC_Set_Get_Object_Case0015 start")
    ...
    def test_index(self):
        ...
        for index in range(50):
            ...
            for i in range(9):
                ...
                self.assertIn(f"第0行结果：{today}", select_result)
                self.assertIn(f"第1行结果：2020-03-01", select_result)
                self.assertIn(f"第2行结果：2020-02-29", select_result)
                self.assertIn(f"第3行结果：1970-01-01", select_result)
            time.sleep(3)
    ...
    def tearDown(self):
        ...
        self.log.info("-Opengauss_Function_JDBC_Set_Get_Object_Case0015 end-")
