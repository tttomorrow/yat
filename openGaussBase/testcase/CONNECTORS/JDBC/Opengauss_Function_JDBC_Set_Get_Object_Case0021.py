...
class Jdbcisreadonly(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info("Opengauss_Function_JDBC_Set_Get_Object_Case0021 start")
        ...
        self.java_name = "jdbc_set_get_object_case0021"
        self.tb_name = "jdbc_set_get_object_case0021"
        self.common = Common()
    ...
    def tearDown(self):
        ...
        self.log.info("-Opengauss_Function_JDBC_Set_Get_Object_Case0021 end-")
