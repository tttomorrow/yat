...
class ConnPython4(unittest.TestCase):
    def setUp(self):
        ...
        text = '----Opengauss_Function_Connect_Python_Case0004 start----'
        self.LOG.info(text)
    ...
    def test_conn(self):
        ...
        conn_info = f'pq://{self.db_user}:{pwd}@' \
    ...
    def tearDown(self):
        ...
        text = '----Opengauss_Function_Connect_Python_Case0004 end----'
        self.LOG.info(text)
