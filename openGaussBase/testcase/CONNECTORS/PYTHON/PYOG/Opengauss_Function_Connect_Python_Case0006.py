...
class ConnPython6(unittest.TestCase):
    def setUp(self):
        ...
        text = '----Opengauss_Function_Connect_Python_Case0006 start----'
        self.LOG.info(text)
    ...
    def tearDown(self):
        ...
        text = '----Opengauss_Function_Connect_Python_Case0006 end----'
        self.LOG.info(text)
