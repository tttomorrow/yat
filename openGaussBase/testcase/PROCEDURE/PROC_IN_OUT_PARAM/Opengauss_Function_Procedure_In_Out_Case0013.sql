-- @testpoint: 测试入参类型为binary_double，出参类型为binary_double的存储过程
...
--创建存储过程
create or replace procedure proc_in_out_param_0013(
p1 in binary_double,
p2 out binary_double
)
as
begin
...
declare
	v_p2 binary_double;
begin
	proc_in_out_param_0013('1234.56',v_p2);
end;
/
--清理环境
drop procedure proc_in_out_param_0013;
drop table test_001;