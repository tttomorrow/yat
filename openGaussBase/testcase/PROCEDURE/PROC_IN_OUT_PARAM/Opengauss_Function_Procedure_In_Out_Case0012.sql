-- @testpoint: 测试入参类型为binary_double，出参类型为decimal的存储过程
...
--创建存储过程
create or replace procedure proc_in_out_param_0012(
p1 in binary_double,
p2 out decimal
)
as
...
v_p2 decimal;
begin
proc_in_out_param_0012('1234.56',v_p2);
end;
/
--清理环境
drop procedure proc_in_out_param_0012;
