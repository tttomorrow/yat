-- @testpoint: 测试入参类型为number(12,6)，出参类型为binary_double的存储过程
...
--创建存储过程
create or replace procedure proc_in_out_param_0010(
p1 in number,
...
declare
	v_p2 binary_double;
begin
	proc_in_out_param_0010('12.345679',v_p2);
end;
/
--清理环境
drop procedure proc_in_out_param_0010;
drop table test_001;