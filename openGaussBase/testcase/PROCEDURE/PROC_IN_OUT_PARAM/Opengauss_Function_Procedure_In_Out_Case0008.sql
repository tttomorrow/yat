-- @testpoint: 测试入参类型为number(12,2)，出参类型为number(12,6)的存储过程
...
--创建存储过程
create or replace procedure proc_in_out_param_0008(
p1 in number,
p2 out number
)
as
...
declare
	v_p2 number(12,6);
begin
	proc_in_out_param_0008('12345.68',v_p2);
end;
/
--清理环境
drop procedure proc_in_out_param_0008;
drop table test_001;