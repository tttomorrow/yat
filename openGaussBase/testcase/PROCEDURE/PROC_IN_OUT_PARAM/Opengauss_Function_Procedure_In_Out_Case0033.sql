...
create or replace procedure proc_in_out_param_0033(
p1 in int,
p2 in integer,
p3 out number
)
as
begin
	for i in(select t4 from test_001 where t1>p1 and t2>p2) 
	loop
...
declare
	v_p3 number;
begin
	proc_in_out_param_0033('12','58813',v_p3);
end;
/
--清理环境
drop procedure proc_in_out_param_0033;
drop table test_001;