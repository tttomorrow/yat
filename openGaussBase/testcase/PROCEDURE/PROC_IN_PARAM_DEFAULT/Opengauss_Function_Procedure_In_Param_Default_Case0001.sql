-- @testpoint: 测试入参为int default的存储过程
...
--创建存储过程
create or replace procedure proc_in_param_default_001(p1 in int default 12) as
v1 test_001.t2%type;
begin
...
--调用存储过程
begin
    proc_in_param_default_001();
end;
/
--清理环境
drop table if exists test_001;
drop procedure proc_in_param_default_001;