-- @testpoint: 测试入参为binary_double default的存储过程
...
--创建存储过程
create or replace procedure proc_in_param_default_007(p1 in binary_double default 1234.67)
as
v1 test_001.t1%type;
begin
...
--调用存储过程
begin
	proc_in_param_default_007();
end;
/
--清理环境
drop table if exists test_001;
drop procedure if exists proc_in_param_default_007;
