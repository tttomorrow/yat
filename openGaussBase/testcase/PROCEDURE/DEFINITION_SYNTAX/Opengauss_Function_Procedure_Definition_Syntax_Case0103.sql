-- @testpoint:数据类型转换 NUMBER 转换为 VARCHAR2
...
BEGIN
alter table FVT_PROC_SCALAR_TYPE_table_002 modify (T23 VARCHAR2);
INSERT INTO FVT_PROC_SCALAR_TYPE_table_002 VALUES(12,58812,554,1234567.89,12345.6789,12.3456789,1234.56,2345.67,12345.6789,12.3456789,12.33,'dbcd','abcde','1999-01-01','ab','adc',123.45,'2005-08-08','2000-01-01 15:12:21.11','2000-08-01 15:12:21.32',true,'b1555253312');
EXCEPTION
