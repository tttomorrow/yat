-- @testpoint:数据类型转换 INT4 转换为 char
...
123.45,'2005-08-08','2000-01-01 15:12:21.11','2000-08-01 15:12:21.32',true,214748368);

CREATE OR REPLACE PROCEDURE FVT_PROC_SCALAR_TYPE_002()  AS
declare
V1 FVT_PROC_SCALAR_TYPE_table_002.T23%type;
BEGIN
alter table FVT_PROC_SCALAR_TYPE_table_002 modify (T23 char(20));
