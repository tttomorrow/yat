-- @testpoint: 测试仅带入参，入参类型为NUMBER(12,2)的存储过程
...
CREATE OR REPLACE PROCEDURE PROC_IN_PARAM_00005(P1 IN NUMBER) AS
V1 NUMBER;
BEGIN
SELECT T4 INTO V1 FROM TEST_001 WHERE T5=P1;
raise info 'V1:%',V1;
EXCEPTION
...
call PROC_IN_PARAM_00005(12345.68);

drop PROCEDURE PROC_IN_PARAM_00005;
drop table if exists test_001;
