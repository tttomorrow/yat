-- @testpoint: 测试仅带入参，入参类型为NUMBER DEFAULT 0.2332的存储过程
...
CREATE OR REPLACE PROCEDURE PROC_IN_PARAM_00002(P1 IN NUMBER DEFAULT 0.2332) AS
V1 INT;
BEGIN
...
--调用存储过程
call PROC_IN_PARAM_00002(1234567.89);
drop PROCEDURE PROC_IN_PARAM_00002;
drop table if exists test_001;