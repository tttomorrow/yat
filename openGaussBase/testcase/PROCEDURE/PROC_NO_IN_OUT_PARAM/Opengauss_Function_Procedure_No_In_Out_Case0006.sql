-- @testpoint: 测试无出入参存储过程（测试变量为NUMBER(12,2)型无入出参存储过程）
...
CREATE OR REPLACE PROCEDURE PROC_NO_IN_OUT_PARAM_005 AS

V_NUMBER1 NUMBER(12,2);
BEGIN

SELECT C_NUMBER1 INTO V_NUMBER1 FROM PROC_NO_IN_OUT_PARAM_001 WHERE C_INT=12;

raise info ':%',V_NUMBER1;
EXCEPTION
...
Call PROC_NO_IN_OUT_PARAM_005();
drop PROCEDURE PROC_NO_IN_OUT_PARAM_005;