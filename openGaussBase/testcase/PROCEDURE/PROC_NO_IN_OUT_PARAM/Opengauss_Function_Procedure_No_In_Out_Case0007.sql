-- @testpoint: 测试无出入参存储过程（测试变量为NNUMBER(12,6)型无入出参存储过程）
...
CREATE OR REPLACE PROCEDURE PROC_NO_IN_OUT_PARAM_006 AS

V_NUMBER2 NUMBER(12,6);
BEGIN

SELECT C_NUMBER2 INTO V_NUMBER2 FROM PROC_NO_IN_OUT_PARAM_001 WHERE C_INT=12;
raise info ':%',V_NUMBER2;
EXCEPTION
...
Call PROC_NO_IN_OUT_PARAM_006();

drop procedure PROC_NO_IN_OUT_PARAM_006;
