-- @testpoint: 仅带出参，出参类型为DATETIME的存储过程，合理报错
...
--仅带出参的存储过程测试（测试出参类型为DATETIME的存储过程）
CREATE OR REPLACE PROCEDURE PROC_OUT_PARAM_001(P1 OUT DATETIME) 
AS
BEGIN
SELECT T18 INTO P1 FROM TEST_001 WHERE T1=12;
