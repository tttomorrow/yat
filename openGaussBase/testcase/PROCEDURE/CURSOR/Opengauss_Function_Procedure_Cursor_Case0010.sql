-- @testpoint: 存储过程中游标使用 游标绑定的selectwhere后带like_
...
create or replace procedure syscur_010()
is
declare
    a emp%rowtype;
    cursor mycursor is  select * from emp where emp.ename like  'zhang___';
begin
    open mycursor;
    loop
