-- @testpoint: 存储过程中游标使用 游标绑定的selectwhere后带like%
...
insert into emp values(1,'zhansi','doctor1',10),(2,'lisiabc','doctor2',10),(123,'zhangwu123','doctor3',10);

create or replace procedure syscur_009()
is
declare
    a emp%rowtype;
    cursor mycursor is  select * from emp where emp.ename like  'zhang%' order by empno,ename,job,sal;
begin
    open mycursor;
    loop
