...
"""
Case Type   : GSC功能模块
Case Name   : global_syscache_threshold内存阈值修改后重启数据库，验证参数值是否正确生效
Description :
    1、修改enable_global_syscache为on;
    2、修改global_syscache_threshold为20MB并查询;
    3、重启数据库，使参数生效;
    4、查看syscache占用情况;
...
Expect      :
    ...
    2、修改global_syscache_threshold为20MB并查询; 成功
    3、重启数据库，使参数生效; 重启成功
...
class GscTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.table_num = 3000
        self.fun_create_name = 'fun_create_tb_gsc0011'
        self.fun_drop_name = 'fun_drop_tb_gsc0011'
        self.tb_ex_name = 'tb_gsc0011_'
        self.threshold = 20
    ...
    def test_main(self):
        ...
        step_txt = f'----step2:修改global_syscache_threshold为' \
        ...
        step_txt = '----step3:重启数据库，使参数生效; expect:重启成功----'
        self.log.info(step_txt)
