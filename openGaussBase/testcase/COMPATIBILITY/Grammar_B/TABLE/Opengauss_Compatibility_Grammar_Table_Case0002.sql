...
--step2:engine参数值为数字开头;expect:合理报错ERROR:  syntax error at
drop table if exists tb_b_grammar_0002_05;
create table tb_b_grammar_0002_05(a text(10),b tinytext,c mediumtext,d longtext) engine 1_er;

--step3:engine参数值为空;expect:成功
...
--step6:engine参数错误;expect:合理报错ERROR:  syntax error
