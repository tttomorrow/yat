...
drop table if exists t_Opengauss_ANY_VALUE_Case0027_1;
create table t_Opengauss_ANY_VALUE_Case0027_1(
col_int int,
col_integer integer,
...
-- 插入数据
insert into t_Opengauss_ANY_VALUE_Case0027_1(col_int,col_smallint,col_BINARY_DOUBLE,col_number1,col_number5,col_char1,col_nchar1,col_varchar_1,col_nvarchar2_1)values(100,100,100,100,100,100,100,'中国西安',100);
insert into t_Opengauss_ANY_VALUE_Case0027_1(col_int,col_smallint,col_BINARY_DOUBLE,col_number1,col_number5,col_char1,col_nchar1,col_varchar_1,col_nvarchar2_1)values(100,100,100,100,100,100,100,'中国西安',100);
insert into t_Opengauss_ANY_VALUE_Case0027_1(col_int,col_smallint,col_BINARY_DOUBLE,col_number1,col_number5,col_char1,col_nchar1,col_varchar_1,col_nvarchar2_1)values(100,100,100,100,100,100,100,'中国西安',100);
-- 查询
select col_smallint-col_BINARY_DOUBLE from t_Opengauss_ANY_VALUE_Case0027_1 group by col_char1-1;
select col_smallint-col_BINARY_DOUBLE,any_value(col_interval1-col_date) from t_Opengauss_ANY_VALUE_Case0027_1 group by col_char1-1;
-- 清理环境
drop table t_Opengauss_ANY_VALUE_Case0027_1;
