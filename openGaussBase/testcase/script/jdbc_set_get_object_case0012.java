...
/**
 **/
public class jdbc_set_get_object_case0012 {
    ...
    public static void main(String[] args) {
        ...
        if(conn==null){
            ...
            try{
                String sql = "drop table if exists jdbc_set_get_object_case0012;" +
                        "create table jdbc_set_get_object_case0012(t_TIMESTAMP TIMESTAMPTZ);";
                PreparedStatement ps_create=conn.prepareStatement(sql);
                ps_create.execute();
                ps_create.close();

                sql = "insert into jdbc_set_get_object_case0012 values(?)";
                ...
                sql = "select * from jdbc_set_get_object_case0012  ;";
