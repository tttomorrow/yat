...
/**
 **/
public class jdbc_set_get_object_case0006 {
    ...
    public static void main(String[] args) {
        ...
        if(conn==null){
            ...
            try{
                String sql = "drop table if exists jdbc_set_get_object_case0006;" +
                        "create table jdbc_set_get_object_case0006(t_date time with time zone);";
                PreparedStatement ps_create=conn.prepareStatement(sql);
                ps_create.execute();
                ps_create.close();

                sql = "insert into jdbc_set_get_object_case0006 values(?)";
