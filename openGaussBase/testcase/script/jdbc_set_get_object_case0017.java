...
/**
 **/
public class jdbc_set_get_object_case0017 {
    ...
    public static void main(String[] args) {
        ...
        if(conn==null){
            ...
            try{
                String sql = "select * from jdbc_set_get_object_case0017 order by 1 desc ;";
                PreparedStatement ps_select=conn.prepareStatement(sql);
                ResultSet rs=ps_select.executeQuery();
                int idx = 0;
                while(rs.next()){
                    LocalTime result1 = rs.getObject(1, LocalTime.class);
