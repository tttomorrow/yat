...
public class jdbc_PrepareStatement_Case0006_10 {
    ...
    public static void main(String[] args) {
        ...
        try {
            stmt_del = conn.prepareStatement("delete from "+tb_name+" where c_customer_sk=?");
            for (int i=0;i<1000;i++)
            {
				...
				if (i == 0 || i == 999)
                {
                	System.out.println("delete succeed!"+i);
                }
            }
