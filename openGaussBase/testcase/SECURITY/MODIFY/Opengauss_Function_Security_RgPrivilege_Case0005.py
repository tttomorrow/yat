...
"""
Case Type   : 防篡改
Case Name   : 三权分立打开时验证sysadmin用户public的权限
Description :
...
class ModifyCase(unittest.TestCase):
    def setUp(self):
        ...
        self.common = Common()
        self.user_name = 'u_security_rgprivilege_0005'
        self.table_name = 't_security_rgprivilege_0005'
        self.function_name = 'f_security_rgprivilege_0005'
