...
"""
Case Type   : 防篡改
Case Name   : 三权分立打开时验证用户对于私有模式下的普通表的列没有insert权限，赋予insert权限之后可以插入数据
Description :
...
class ModifyCase(unittest.TestCase):
    def setUp(self):
        ...
        self.common = Common()
        self.table_name = 't_security_insertprivilege_0001'
        self.user_name1 = 'u_security_insertprivilege_0001_01'
        self.user_name2 = 'u_security_insertprivilege_0001_02'
