...
"""
Case Type   : 防篡改
Case Name   : 三权分立打开时验证超级用户可以对用户私有模式下的局部临时表插入数据
Description :
...
class ModifyCase(unittest.TestCase):
    def setUp(self):
        ...
        self.common = Common()
        self.table_name = 't_security_insertprivilege_0011'
        self.user_name = 'u_security_insertprivilege_0011'
        self.file_path = os.path.join(macro.DB_INSTANCE_PATH,
                                      'security_insertprivilege_0011.txt')
