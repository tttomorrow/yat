...
"""
Case Type   : 防篡改
Case Name   : 三权分立关闭时验证auditadmin用户public的权限
Description :
...
class ModifyCase(unittest.TestCase):
    def setUp(self):
        ...
        self.common = Common()
        self.user_name = 'u_security_rgprivilege_0015'
        self.table_name = 't_security_rgprivilege_0015'
        self.function_name = 'f_security_rgprivilege_0015'
