...
"""
Case Type   : 防篡改
Case Name   : 三权分立关闭时验证sysadmin用户public的权限
Description :
...
class ModifyCase(unittest.TestCase):
    def setUp(self):
        ...
        self.common = Common()
        self.user_name = 'u_security_rgprivilege_0013'
        self.table_name = 't_security_rgprivilege_0013'
        self.function_name = 'f_security_rgprivilege_0013'
    ...
    def test_security(self):
        ...
        sql_cmd = self.primary_sh.execut_db_sql(f'''
            ...
            create user {self.user_name} sysadmin password 
        ...
        text = '----step4:新用户连接新数据库创建表并调用函数 expect:成功--'
        self.logger.info(text)
    ...
    def tearDown(self):
        ...
        self.logger.info(text)
        sql_cmd = self.primary_sh.execut_db_sql(f'''
            drop table public.{self.table_name};
