...
Case Name   : 表创建行访问控制策略，打开行访问控制开关，策略生效
Description :
    1.创建用户
    2.创建表，并给用户赋予访问权限
    3.打开行级访问开关，创建行级访问策略
...
class Security(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info(
            '---Opengauss_Function_Security_RowLevel_Case0001 start---')
        self.userNode = Node(node='PrimaryDbUser')
        self.sh_primy = CommonSH('PrimaryDbUser')
        self.common = Common()
        self.user01 = 'u01_security_rowlevel_0001'
        self.user02 = 'u02_security_rowlevel_0001'
        self.user03 = 'u03_security_rowlevel_0001'
        self.table = 'table_security_rowlevel_0001'
        self.rowlevel = 'rls_ecurity_rowlevel_0001'
    ...
    def test_masking(self):
        ...
        text = '----step3：打开行级访问开关，创建行级访问策略；expect：成功----'
        self.logger.info(text)
        ...
        self.common.equal_sql_mdg(msg5, 'data', 'bob data', '(1 row)',
                                  flag='1')
    ...
    def tearDown(self):
        ...
        self.logger.info(msg1)
        self.logger.info(
            '---Opengauss_Function_Security_RowLevel_Case0001 finish---')
