...
class Security(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info(
            '---Opengauss_Function_Security_RowLevel_Case0018 start---')
        self.userNode = Node(node='PrimaryDbUser')
        self.sh_primy = CommonSH('PrimaryDbUser')
        self.common = Common()
        self.user01 = 'u01_security_rowlevel_0018'
        self.user02 = 'u02_security_rowlevel_0018'
        self.user03 = 'u03_security_rowlevel_0018'
        self.table = 'table_security_rowlevel_0018'
        self.rowlevel = 'rls_ecurity_rowlevel_0018'
    ...
    def test_masking(self):
        ...
        text = '----step3：创建行级访问策略,指定存在的用户；expect：成功----'
        self.logger.info(text)
        ...
        text = '----step4：指定的用户执行select语句；expect：成功----'
        self.logger.info(text)
        ...
        self.common.equal_sql_mdg(msg4, 'data', 'alice data', '(1 row)',
                                  flag='1')
        text = '----step5：未指定的用户执行select语句；expect：失败----'
        self.logger.info(text)
    ...
    def tearDown(self):
        ...
        self.logger.info(msg1)
        self.logger.info(
            '---Opengauss_Function_Security_RowLevel_Case0018 finish---')
