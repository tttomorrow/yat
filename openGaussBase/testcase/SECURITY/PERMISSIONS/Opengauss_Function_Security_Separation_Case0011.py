...
Case Name   : 三权分立后系统管理员可以在自己的表上删除索引
Description :
    ...
    2.sysadmin01 用户执行：CREATE TABLE table03(co1_1 int, col_2 int);
                CREATE INDEX index01 ON table03(id1);
                DROP INDEX IF EXISTS index01;
Expect      :
    1.CREATE ROLE
    2.CREATE  INDEX
    DROP INDEX
...
class Policy(unittest.TestCase):
    def setUp(self):
        logger.info(
            '------Opengauss_Function_Security_Separation_Case0011 start----')
        self.common = Common()
    ...
    def test_policy(self):
        ...
        logger.info(msg2)
        self.assertIn(self.Constant.DROP_INDEX_SUCCESS_MSG, msg2)
    ...
    def tearDown(self):
        ...
        logger.info(msg1)
        logger.info(
            '----Opengauss_Function_Security_Separation_Case0011 finish----')
