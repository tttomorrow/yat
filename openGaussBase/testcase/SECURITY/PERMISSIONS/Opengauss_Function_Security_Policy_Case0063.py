...
class Security(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('Opengauss_Function_Security_Policy_Case0063 start')
    ...
    def test_policy(self):
        ...
        self.common.equal_sql_mdg(msg0, 'password_reuse_max', '0', '(1 row)',
                                flag='1')
        self.logger.info("------修改参数password_reuse_time值为59-------")
        excute_cmd2 = f'source {self.DB_ENV_PATH};' \
                      f'gs_guc reload -N all -I all ' \
                      f'-c "password_reuse_time=59"'
        ...
        self.logger.info(msg1)
        self.common.equal_sql_mdg(msg1, 'password_reuse_time', '59', '(1 row)',
                                flag='1')
        ...
        date_return_cmd = 'date -d "+1465 hour" "+%Y-%m-%d %H:%M:%S"'
    ...
    def tearDown(self):
        ...
        self.logger.info('Opengauss_Function_Security_Policy_Case0063 finish')
