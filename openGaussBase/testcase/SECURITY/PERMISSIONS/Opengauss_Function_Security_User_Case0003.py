...
class Privategrant(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('-------------Opengauss_Function_Security_User_Case0003 start--------------------')
    ...
    def tearDown(self):
        self.DB_ENV_PATH = macro.DB_ENV_PATH
        self.DB_INSTANCE_PATH = macro.DB_INSTANCE_PATH
        self.logger.info('-------------Opengauss_Function_Security_User_Case0003 end------------------')
        try:
            ...
            self.logger.info(msg1)
            self.logger.info(msg2)
        self.logger.info('------------------Opengauss_Function_Security_User_Case0003 finish--------------------')
