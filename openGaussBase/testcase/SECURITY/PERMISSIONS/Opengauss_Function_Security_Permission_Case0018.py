...
class Privategrant(unittest.TestCase):
    def setUp(self):
        logger.info(
            '-----Opengauss_Function_Security_Permission_Case0018 start----')
    ...
    def test_default_permission(self):
        ...
        sql_cmd1 = f'create user wf with password \'{macro.COMMON_PASSWD}\';' \
                   ...
                   f'grant revoke on security_table to wf;'
    ...
    def tearDown(self):
        ...
        logger.info(msg1)
        logger.info(
            '---Opengauss_Function_Security_Permission_Case0018 finish---')
