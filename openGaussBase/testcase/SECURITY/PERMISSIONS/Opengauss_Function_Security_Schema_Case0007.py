...
class Privategrant(unittest.TestCase):
    def setUp(self):
        logger.info('-----------Opengauss_Function_Security_Schema_Case0007 start--------------')
    ...
    def test_schema(self):
        ...
        logger.info(msg2)
        self.common.equal_sql_mdg(msg2, 'nspname', '---------', 'wf', '(1 row)')
    ...
    def tearDown(self):
        ...
        msg1 = self.userNode.sh(excute_cmd1).result()
        logger.info(msg1)
        logger.info('---------------Opengauss_Function_Security_Schema_Case0007 finish--------------')
