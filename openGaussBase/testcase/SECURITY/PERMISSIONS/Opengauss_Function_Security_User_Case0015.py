...
Case Name   : 修改普通用户为安全策略管理员用户，并进行DDL操作
Description :
    1.创建普通用户
    CREEATE USER poladmin WITH  PASSWORD 'QAZ2WSX@123'
    2.修改用户为运维管理员用户
    ALTER USER poladmin POLADMIN；
    3.安全策略管理员用户登录，执行DDL语句
...
class Privategrant(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info(
            '------Opengauss_Function_Security_User_Case0015 start-----')
    ...
    def test_default_permission(self):
        ...
        sql_cmd1 = f'CREATE USER poladmin WITH PASSWORD ' \
                   ...
                   f'ALTER USER poladmin POLADMIN;'
    ...
    def tearDown(self):
        ...
        self.logger.info(
            '----Opengauss_Function_Security_User_Case0015 finish----')
