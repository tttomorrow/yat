...
"""
Case Type   : policy
Case Name   : 密码少于最小长度要求password_min_length=6
Description :
...
class Policy(unittest.TestCase):
    def setUp(self):
        logger.info('==Opengauss_Function_Security_Policy_Case0047 start==')
        self.common = Common()
        ...
        self.new_password1 = str_passwd.capitalize() + "@" + "139"
        self.new_password2 = str_passwd.capitalize() + "@" + "13"
        self.DB_ENV_PATH = macro.DB_ENV_PATH
        self.Constant = Constant()
        self.configure = "password_min_length=6"
    ...
    def tearDown(self):
        ...
        msg1 = self.sh_primy.execut_db_sql(sql_cmd1)
        logger.info(msg1)
        logger.info('==Opengauss_Function_Security_Policy_Case0047 finish==')
