...
class Privategrant(unittest.TestCase):
    def setUp(self):
        logger.info(
            '---Opengauss_Function_Security_Permission_Case0003 start---')
    ...
    def test_default_permission(self):
        ...
        sql_cmd2 = 'alter table security_table add(id4 int);'
    ...
    def tearDown(self):
        ...
        logger.info(msg1)
        logger.info(
            '---Opengauss_Function_Security_Permission_Case0003 finish-----')
