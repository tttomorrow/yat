...
Case Name   : 修改普通用户为监控管理员用户，并进行DDL操作
Description :
    1.创建普通用户
...
class Privategrant(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info(
            '------Opengauss_Function_Security_User_Case0011 start-----')
    ...
    def test_default_permission(self):
        ...
        sql_cmd1 = f'CREATE USER monadmin WITH PASSWORD ' \
                   f'\'{macro.COMMON_PASSWD}\';' \
                   f'ALTER USER monadmin MONADMIN;'
    ...
    def tearDown(self):
        ...
        self.logger.info(
            '----Opengauss_Function_Security_User_Case0011 finish----')
