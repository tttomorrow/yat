...
class Privategrant(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('------------Opengauss_Function_Security_User_Case0009 start----------------')
    ...
    def test_default_permission(self):
        ...
        sql_cmd1 = f'''CREATE USER adminuser WITH password '{macro.COMMON_PASSWD}';
                        ALTER USER adminuser SYSADMIN;
                    '''
        excute_cmd1 = f'''
    ...
    def tearDown(self):
        self.DB_ENV_PATH = macro.DB_ENV_PATH
        self.DB_INSTANCE_PATH = macro.DB_INSTANCE_PATH
        self.logger.info('-------------Opengauss_Function_Security_User_Case0009 end-------------')
        try:
            ...
            msg1 = self.userNode.sh(excute_cmd1).result()
            self.logger.info(msg1)
        self.logger.info('----------------Opengauss_Function_Security_User_Case0009 finish----------------')
