...
class Privategrant(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info(
            '----Opengauss_Function_Security_Permission_Case0014 start----')
    ...
    def test_default_permission(self):
        ...
        sql_cmd1 = f'create user wf with password \'{macro.COMMON_PASSWD}\';' \
                   ...
                   f'grant drop on security_table to wf;'
    ...
    def tearDown(self):
        ...
        self.logger.info(msg1)
        self.logger.info(
            '----Opengauss_Function_Security_Permission_Case0014 finish----')
