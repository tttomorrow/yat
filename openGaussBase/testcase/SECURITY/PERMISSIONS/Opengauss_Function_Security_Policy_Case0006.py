...
"""
Case Type   : policy
Case Name   : 设置failed_login_attempts=-5,无效值报错
Description :
    1.gs_guc reload -N all -I all -c "failed_login_attempts=-5"，重启数据库生效
Expect      :
    1.报错，参数值无效
History     :
"""
...
class Policy(unittest.TestCase):
    def setUp(self):
        logger.info(
            '------Opengauss_Function_Security_Policy_Case0006 start------')
    ...
    def tearDown(self):
        ...
        logger.info(
            '-----Opengauss_Function_Security_Policy_Case0006 finish------')
