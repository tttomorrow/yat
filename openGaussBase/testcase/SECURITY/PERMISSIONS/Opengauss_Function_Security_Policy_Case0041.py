...
"""
Case Type   : policy
Case Name   : 密码为0-9数字的最少要求个数password_min_digital=999
Description :
    1.设置password_min_digital=3，重启数据库生效
...
class Policy(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Policy_Case0041 start---')
        self.common = Common()
        ...
        self.new_password1 = str_passwd.capitalize() + "@" + "9" * 998
        self.new_password2 = str_passwd + "@" + "9" * 999
        self.Constant = Constant()
        self.configure = 'password_min_digital=999'
    ...
    def test_policy(self):
        ...
        sql_cmd2 = f'create user user001 with password "{self.new_password2}";'
    ...
    def tearDown(self):
        ...
        logger.info(status_msg)
        self.assertTrue("Degraded" in status_msg or "Normal" in status_msg)
        sql_cmd1 = 'drop user if exists user001 cascade;'
        msg1 = self.sh_primy.execut_db_sql(sql_cmd1)
        logger.info(msg1)
        logger.info('Opengauss_Function_Security_Policy_Case0041 finish')
