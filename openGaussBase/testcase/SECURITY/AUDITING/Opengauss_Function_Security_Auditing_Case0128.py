...
Case Name   : 统一审计策略：用户user1对table对象的SELECT行为的审计
Description :
    1.系统管理员用户创建两个用户
...
class Security(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info(
            '---Opengauss_Function_Security_Auditing_Case0128 start---')
        self.userNode = Node(node='PrimaryDbUser')
        self.primary_root = Node(node='PrimaryRoot')
        self.sh_primy = CommonSH('PrimaryDbUser')
        self.common = Common()
        self.constant = Constant()
        self.user1 = 'u01_security_auditing_0128'
        self.user2 = 'u02_security_auditing_0128'
        self.table = 'table_security_auditing_0128'
        self.res_label = 'rl_security_auditing_0128'
        self.audit_policy = 'ap_security_auditing_0128'
    ...
    def tearDown(self):
        ...
        self.logger.info(
            '----Opengauss_Function_Security_Auditing_Case0128 finish----')
