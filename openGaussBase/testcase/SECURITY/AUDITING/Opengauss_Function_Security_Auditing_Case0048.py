...
Case Name   : 关闭数据库对象TABLESPACE的CREATE、DROP、ALTER操作审计功能，
...
class Auditing(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info(
            '-----Opengauss_Function_Security_Auditing_Case0048 start-----')
    ...
    def test_security(self):
        ...
        self.assertFalse(msg3.find('DROP TABLESPACE new_ds_location1') > -1)
    ...
    def tearDown(self):
        ...
        self.logger.info(
            '-----Opengauss_Function_Security_Auditing_Case0048 end----')
