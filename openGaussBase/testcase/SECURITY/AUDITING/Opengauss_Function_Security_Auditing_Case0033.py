...
Case Name   : 开启数据库对象database的CREATE、DROP、ALTER操作审计功能，
...
class Auditing(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info(
            '----Opengauss_Function_Security_Auditing_Case0033 start----')
    ...
    def test_security(self):
        ...
        self.assertTrue(msg3.find('create database unittest') > -1)
        self.assertTrue(
            msg3.find('alter database unittest rename to  unittest2') > -1)
        self.assertTrue(msg3.find('drop database unittest2') > -1)
    ...
    def tearDown(self):
        ...
        self.logger.info(
            '----Opengauss_Function_Security_Auditing_Case0033 end----')
