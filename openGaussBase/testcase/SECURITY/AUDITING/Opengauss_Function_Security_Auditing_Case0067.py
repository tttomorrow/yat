...
Case Name   : 开启数据库对象TEXT SEARCH的CREATE、DROP、ALTER操作审计功能，
...
class Security(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info(
            '====Opengauss_Function_Security_Auditing_Case0067 star====')
        self.common = Common()
    ...
    def test_policy(self):
        ...
        self.logger.info(msg2)
        self.assertTrue(msg2.find('CREATE TEXT SEARCH CONFIGURATION') > -1)
        self.assertTrue(msg2.find('ALTER TEXT SEARCH CONFIGURATION') > -1)
        self.assertTrue(
    ...
    def tearDown(self):
        ...
        self.logger.info(
            '====Opengauss_Function_Security_Auditing_Case0067 finish====')
