...
Case Name   : 开启数据库对象TYPE的CREATE、DROP、ALTER操作审计功能，
...
Description :
    ...
    3.修改TYPE对象
    4.删除TYPE对象
    5.登录数据库，查看审计SELECT * FROM pg_query_audit('$start_time',
...
class Security(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info(
            '====Opengauss_Function_Security_Auditing_Case0065 start====')
        self.common = Common()
    ...
    def test_policy(self):
        ...
        self.assertTrue(
            msg2.find('CREATE TYPE compfoo AS (f1 int, f2 text)') > -1)
        self.assertTrue(
            msg2.find('ALTER TYPE compfoo RENAME TO compfoo1') > -1)
        self.assertTrue(msg2.find('DROP TYPE compfoo1 cascade') > -1)
    ...
    def tearDown(self):
        ...
        self.logger.info(msg1)
        self.logger.info(
            '====Opengauss_Function_Security_Auditing_Case0065 finish=====')
