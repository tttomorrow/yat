...
Case Name   : 开启数据库对象CMK、CEK的CREATE、DROP操作审计功能
Description :
    1.设置audit_system_object=2097151
...
class Auditing(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info(
            '------Opengauss_Function_Security_Auditing_Case0151 start-----')
        self.sh_primy = CommonSH('PrimaryDbUser')
        self.userNode = Node('PrimaryDbUser')
        self.constant = Constant()
        self.common = Common()
        self.cmk = 'cmk_security_audit_0151'
        self.cek = 'cek_security_audit_0151'
        self.key_path = 'keypath_security_audit_0151'
    ...
    def test_security(self):
        ...
        text = 'step1:设置参数audit_system_object=2097151;expect:成功'
        self.logger.info(text)
        self.sh_primy.execute_gsguc('reload', self.constant.GSGUC_SUCCESS_MSG,
                                    f'audit_system_object=2097151')
    ...
    def tearDown(self):
        ...
        self.logger.info(
            '----Opengauss_Function_Security_Auditing_Case0151 end-----')
