...
Case Name   : 设置audit_login_logout=-1，不支持
Description :
...
class Auditing(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info(
            '----Opengauss_Function_Security_Auditing_Case0014 start----')
    ...
    def test_security(self):
        ...
        self.assertTrue(msg1.find(
            ...
            '"audit_login_logout" (0 .. 7)') > -1)

    def tearDown(self):
        self.logger.info(
            '-----Opengauss_Function_Security_Auditing_Case0014 finish------')
