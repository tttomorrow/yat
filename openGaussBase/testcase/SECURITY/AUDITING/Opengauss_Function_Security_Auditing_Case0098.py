...
class Auditing(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info(
            '------Opengauss_Function_Security_Auditing_Case0098 start-----')
    ...
    def test_security(self):
        ...
        sql_cmd2 = f'create table table01(id int);' \
        ...
        sql_cmd3 = f'select count(*) from pg_query_audit(\'{start_time}\',\
                   \'{end_time}\') where username = \'audit_admin\';'
        ...
        self.common.equal_sql_mdg(msg3,
    ...
    def tearDown(self):
        ...
        self.logger.info(msg1)
        self.logger.info(
            '-----Opengauss_Function_Security_Auditing_Case0098 end------')
