...
Case Name   : 关闭数据库对象TYPE的CREATE、DROP、ALTER操作审计功能，
...
class Security(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info(
            '====Opengauss_Function_Security_Auditing_Case0064 start====')
        self.common = Common()
    ...
    def test_policy(self):
        ...
        self.assertFalse(msg2.find('DROP TYPE compfoo1 cascade') > -1)
    ...
    def tearDown(self):
        ...
        self.logger.info(msg1)
        self.logger.info(
            '====Opengauss_Function_Security_Auditing_Case0064 finish====')
