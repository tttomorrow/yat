...
Case Name   : 修改加密表的数据，非密态客户端查看该加密表数据时是密文
Description :
...
class Equality(unittest.TestCase):
    def setUp(self):
        ...
        self.cmk = 'cmk_security_qualityquery_0049'
        self.cek = 'cek_security_qualityquery_0049'
        self.key_path = 'keypath_security_qualityquery_0049'
        self.table = 'table_security_qualityquery_0049'
    ...
    def test_security(self):
        ...
        text = '--step4:修改数据;expect:成功--'
        self.logger.info(text)
        sql_cmd4 = f'update {self.table} set name = \'lucy\' ' \
            f'where id_number = 1;'
        msg4 = self.sh_primy.execut_db_sql(sql_cmd4, sql_type='-C')
        self.logger.info(msg4)
        self.assertIn(self.constant.UPDATE_SUCCESS_MSG, msg4,
                         text + '执行失败')
