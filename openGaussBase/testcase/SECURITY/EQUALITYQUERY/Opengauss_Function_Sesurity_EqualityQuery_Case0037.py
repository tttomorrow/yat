...
Case Name   : 删除$LOCALKMS_FILE_PATH路径下的密钥，再删除cmk
Description :
...
class Auditing(unittest.TestCase):
    def setUp(self):
        ...
        self.cmk = 'cmk_security_qualityquery_0037'
        self.key_path = 'keypath_security_qualityquery_0037'
    ...
    def test_security(self):
        ...
        text = '---step3:先删除密钥文件，再删除cmk;expect:成功---'
        self.logger.info(text)
        clean_cmd = f"rm -rf " \
            f"{os.path.join(macro.DB_INSTANCE_PATH, f'{self.key_path}*')};"
