...
"""
Case Type   : 全密态
Case Name   : 正常启动数据库，创建主密钥cmk，cek是否能成功
Description :
    1、配置$GAUSSHOME/etc/localkms路径
    2、连接全密态数据库，分别创建cmk，cek，查看表的cmk及cek相关信息
    3、清理环境
Expect      :
    1、配置成功
    2、创建成功
...
class FullDensityState(unittest.TestCase):
    def setUp(self):
        ...
        self.cmk = 'cmk_security_qualityquery_0001'
        self.cek = 'cek_security_qualityquery_0001'
        self.key_path = 'keypath_security_qualityquery_0001'
