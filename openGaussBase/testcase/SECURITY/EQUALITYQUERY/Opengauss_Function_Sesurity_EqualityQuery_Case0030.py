...
Case Name   : 创建多个CMK，KEY_PATH不同，CMK名不同，创建成功
Description :
    1.gsql客户端-C连接数据库，创建cmk
    2.再次创建cmk，名称与前一个不同，KEY_PATH不同
Expect      :
    1.创建成功
    2.创建成功
History     :
...
class Auditing(unittest.TestCase):
    def setUp(self):
        ...
        self.cmk1 = 'cmk01_security_qualityquery_0030'
        self.cmk2 = 'cmk02_security_qualityquery_0030'
        self.key_path1 = 'keypath01_security_qualityquery_0030'
        self.key_path2 = 'keypath02_security_qualityquery_0030'
    ...
    def test_security(self):
        ...
        text = '---step2:再次创建cmk，名称与前一个不同，KEY_PATH不同;expect:成功---'
        self.logger.info(text)
    ...
    def tearDown(self):
        ...
        self.assertEqual(msg1.count(self.constant.drop_cmk_success), 2,
                         text1 + '执行失败')
