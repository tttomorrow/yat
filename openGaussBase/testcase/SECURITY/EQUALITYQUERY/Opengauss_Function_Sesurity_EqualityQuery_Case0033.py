...
Case Name   : 配置$GAUSSHOME/etc/localkms路径创建cmk，加密算法为SM2
Description :
    1.gsql客户端连接数据库加-C参数，创建cmk
Expect      :
    1.创建成功
History     :
"""
...
class Auditing(unittest.TestCase):
    def setUp(self):
        ...
        self.cmk = 'cmk_security_qualityquery_0033'
        self.key_path = 'keypath_security_qualityquery_0033'
