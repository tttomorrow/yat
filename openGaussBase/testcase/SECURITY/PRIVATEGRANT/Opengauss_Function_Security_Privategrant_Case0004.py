...
"""
Case Type   : security
Case Name   : 授予private用户对全表的insert权限
Description :
    ...
    2.private用户执行：CREATE TABLE granttest(W_WAREHOUSE_SK INTEGER NOT NULL,W_WAREHOUSE_ID CHAR(16) NOT NULL,
                    ...
                    GRANT insert ON granttest TO private;
...
class Privategrant(unittest.TestCase):
    def setUp(self):
        logger.info('-----------Opengauss_Function_Security_Privategrant_Case0004 start-------------')
    ...
    def tearDown(self):
        ...
        logger.info(msg1)
        logger.info(msg2)
        logger.info('-----------Opengauss_Function_Security_Privategrant_Case0004 finish-------------')
