...
"""
Case Type   : security
Case Name   : 收回private用户对全表的insert权限
Description :
...
class Privategrant(unittest.TestCase):
    def setUp(self):
        logger.info('----------Opengauss_Function_Security_Privategrant_Case0005 start---------------')
    ...
    def tearDown(self):
        ...
        logger.info(msg1)
        logger.info(msg2)
        logger.info('-----------Opengauss_Function_Security_Privategrant_Case0005 finish---------------')
