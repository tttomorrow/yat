...
Description :
    ...
    2.private用户执行：CREATE TABLE granttest(W_WAREHOUSE_SK INTEGER NOT NULL,W_WAREHOUSE_ID CHAR(16) NOT NULL,
                    ...
                    GRANT ALL PRIVILEGES (W_WAREHOUSE_SK, W_WAREHOUSE_ID, W_WAREHOUSE_NAME) ON granttest TO private;
                    INSERT INTO granttest(W_WAREHOUSE_SK, W_WAREHOUSE_ID, W_WAREHOUSE_NAME) VALUES (1, '1111', 'test1'),
                    (2, '2222','test2');
...
class Privategrant(unittest.TestCase):
    def setUp(self):
        logger.info('------------Opengauss_Function_Security_Privategrant_Case0006 start-----------------')
    ...
    def test_allcolumn(self):
        ...
        sql_cmd2 = '''CREATE TABLE granttest(W_WAREHOUSE_SK INTEGER NOT NULL,W_WAREHOUSE_ID CHAR(16) NOT NULL,
                    ...
                    INSERT INTO granttest(W_WAREHOUSE_SK, W_WAREHOUSE_ID, W_WAREHOUSE_NAME) VALUES (1, '1111', 'test1'),
                    (2, '2222','test2');
                    select w_warehouse_sk,w_warehouse_id,w_warehouse_name from granttest;
                    update granttest set w_warehouse_name='hehe1' where w_warehouse_name='test1';
                    '''
        excute_cmd1 = f'''
    ...
    def tearDown(self):
        ...
        logger.info(msg2)
        logger.info(
            '----------------------------Opengauss_Function_Security_Privategrant_Case0006 finish-----------------------------')
