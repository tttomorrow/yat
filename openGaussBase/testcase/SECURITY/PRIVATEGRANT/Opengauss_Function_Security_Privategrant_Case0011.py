...
"""
Case Type   : security
Case Name   : 授予private用户delete权限(同时授予select权限，才能delete删除)
Description :
    ...
    2.private用户执行：CREATE TABLE granttest(W_WAREHOUSE_SK INTEGER NOT NULL,W_WAREHOUSE_ID CHAR(16) NOT NULL,
                    ...
                    GRANT DELETE ON granttest TO private;
                    ...
                    delete from granttest where w_warehouse_name='test2';
                     GRANT select ON granttest TO private;
                       delete from granttest where w_warehouse_name='test2';
Expect      :
    1.CREATE ROLE
    2.REVOKE
...
class Privategrant(unittest.TestCase):
    def setUp(self):
        logger.info('-------Opengauss_Function_Security_Privategrant_Case0011 start------------')
    ...
    def tearDown(self):
        ...
        logger.info(msg1)
        logger.info(msg2)
        logger.info('-----------Opengauss_Function_Security_Privategrant_Case0011 finish---------------')
