...
class Privategrant(unittest.TestCase):
    def setUp(self):
        logger.info('-----------Opengauss_Function_Security_Privategrant_Case0008 start----------------')
    ...
    def tearDown(self):
        ...
        logger.info(msg1)
        logger.info(msg2)
        logger.info('-------------Opengauss_Function_Security_Privategrant_Case0008 finish------------')
