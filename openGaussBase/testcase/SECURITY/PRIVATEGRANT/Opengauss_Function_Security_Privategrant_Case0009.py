...
"""
Case Type   : security
Case Name   : 赋予private用户对全表的truncate权限
Description :
    ...
    2.private用户执行：CREATE TABLE granttest(W_WAREHOUSE_SK INTEGER NOT NULL,W_WAREHOUSE_ID CHAR(16) NOT NULL,
                    ...
                    GRANT truncate ON granttest TO private;
                    ...
                    truncate table granttest;
                    select * from granttest
Expect      :
    1.CREATE ROLE
    2.REVOKE
    GRANT
...
class Privategrant(unittest.TestCase):
    def setUp(self):
        logger.info('----------Opengauss_Function_Security_Privategrant_Case0009 start-----------------')
    ...
    def tearDown(self):
        ...
        logger.info(msg1)
        logger.info(msg2)
        logger.info('------------Opengauss_Function_Security_Privategrant_Case0009 finish---------------')
