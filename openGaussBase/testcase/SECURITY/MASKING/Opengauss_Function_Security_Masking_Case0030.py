...
Case Name   : 使用fullemailmasking脱密策略，对邮箱地址去掉‘.’符号的字符脱敏
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0030 start---')
    ...
    def test_masking(self):
        ...
        sql_cmd4 = '''create table public.person(id int,name char(10),email 
                ...
                insert into person values(1,'张三','5674764554@qq_com',
                'Shanxi,Xian,yuhuazhai'),(2,'李四','5443225677@qq_com',
                'Fujian');'''
        ...
        self.assertTrue(msg6_list[2].strip() == 'xxxxxxxxxx@xxxxxx' and
                        msg6_list[3].strip() == 'xxxxxxxxxx@xxxxxx')
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0030 finish---')
