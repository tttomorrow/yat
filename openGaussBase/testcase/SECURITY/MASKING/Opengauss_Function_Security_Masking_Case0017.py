...
Case Name   : 使用basicemailmasking脱密策略，对网易邮箱格式的数据进行脱敏
Description :
    1.poladmin用户创建表，并赋予表的所有操作权限给用户user001
    2.poladmin用户将敏感字段加到资源标签
    create resource label email_lable add column(person.email );
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0017 start---')
    ...
    def test_masking(self):
        ...
        sql_cmd4 = '''create table public.person(id int,name char(10),email 
                ...
                insert into person values(1,'张三','qazwsx12@163.com',
                'Shanxi,Xian,yuhuazhai'),(2,'李四','qazedc56@163.com',
                'Fujian');'''
        ...
        self.assertTrue(msg6_list[2].strip() == 'xxxxxxxx@163.com' and
                        msg6_list[3].strip() == 'xxxxxxxx@163.com')
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0017 finish---')
