...
Case Name   : 使用shufflemasking脱密策略，对不支持的数据类型进行脱敏
Description :
...
Expect      :
    ...
    3.string字段的信息脱敏为0（默认使用maskall方式）
History     :
"""
import unittest
...
class Security(unittest.TestCase):
    def setUp(self):
        text = '---Opengauss_Function_Security_Masking_Case0043 start---'
        logger.info(text)
        self.userNode = Node('PrimaryDbUser')
        self.sh_primy = CommonSH('PrimaryDbUser')
        self.common = Common()
        self.constant = Constant()
        self.poladmin = 'poladmin_security_masking_0043'
        self.com_user = 'com_security_masking_0043'
        self.resource_label = 'rl_security_masking_0043'
        self.masking_policy = 'mp_security_masking_0043'
        self.table = f'{self.poladmin}.table_security_masking_0043'
    ...
    def test_masking(self):
        ...
        sql_cmd4 = f'''drop table if exists {self.table};
                ...
                integer,address varchar(60));
                insert into {self.table} values(1,'张三',12345678,
                'Shanxi,Xian,yuhuazhai'),(2,'李四',87654321,'Fujian');'''
        ...
        assert_1 = msg6_list[2].strip() == '0' and \
                   msg6_list[3].strip() == '0'
    ...
    def tearDown(self):
        ...
        logger.info(msg4)
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0043 finish---')
