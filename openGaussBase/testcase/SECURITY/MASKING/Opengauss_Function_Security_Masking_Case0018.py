...
Case Name   : 使用basicemailmasking脱密策略，对有2个@的邮箱格式的数据进行脱敏
Description :
...
Expect      :
    ...
    3.脱敏策略添加成功
    4.查询到email字段的信息脱敏,仅对第一个‘@’之前的字符脱敏
History     :
"""
import unittest
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0018 start---')
    ...
    def test_masking(self):
        ...
        sql_cmd4 = '''create table public.person(id int,name char(10),email 
                ...
                insert into person values(1,'张三','qaz@wsx12@163.com',
                'Shanxi,Xian,yuhuazhai'),(2,'李四','qaz@edc56@163.com',
                'Fujian');'''
        ...
        self.assertTrue(msg6_list[2].strip() == 'xxx@wsx12@163.com' and
                        msg6_list[3].strip() == 'xxx@edc56@163.com')
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0018 finish---')
