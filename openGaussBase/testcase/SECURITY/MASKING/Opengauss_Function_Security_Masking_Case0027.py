...
Case Name   : 使用fullemailmasking脱密策略，对特殊符号+数字组成的邮箱格式的数据进行脱敏
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0027 start---')
    ...
    def test_masking(self):
        ...
        sql_cmd4 = '''create table public.person(id int,name char(10),email 
                ...
                insert into person values(1,'张三','2569_4452@qq.com',
                'Shanxi,Xian,yuhuazhai'),(2,'李四','4258&8526@qq.com',
                'Fujian');'''
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0027 finish---')
