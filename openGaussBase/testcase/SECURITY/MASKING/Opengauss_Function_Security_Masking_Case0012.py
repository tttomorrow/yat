...
Expect      :
    ...
    3.脱敏策略添加成功
    4.creditcard字段的信息已做脱敏处理
    5.person.creditcard字段移除脱敏策略成功
    6.creditcard字段还原成功，查询出来的内容显示完整
History     :
"""
import unittest
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0012 start---')
    ...
    def test_masking(self):
        ...
        sql_cmd4 = '''create table public.person(id int,name char(10),
                ...
                insert into person values(1,'张三','6236-0044-7120-1432-645',
                'Shanxi,Xian,yuhuazhai'),(2,'李四','5432-1502-0666-3215-663',
                'Fujian');'''
        ...
        logger.info(msg5)
        logger.info('------user001查看person表creditcard字段是否脱敏------')
        ...
        self.assertTrue(msg6_list[2].strip() == 'xxxx-xxxx-xxxx-xxxx-645' and
                        msg6_list[3].strip() == 'xxxx-xxxx-xxxx-xxxx-663')
        logger.info('------还原脱敏字段------')
        sql_cmd7 = 'alter resource label creditcard_lable remove column(' \
                   'public.person.creditcard);'
        ...
        self.assertTrue(msg8_list[2].strip() == '6236-0044-7120-1432-645' and
                        msg8_list[3].strip() == '5432-1502-0666-3215-663')
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0012 finish---')
