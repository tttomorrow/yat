...
Case Name   : 使用alldigitsmasking脱密策略，对不支持的数据类型进行脱敏
Description :
...
Expect      :
    ...
    3.脱敏策略添加成功
    4.查询到email字段的信息脱敏,文本中的数字均被脱敏处理
History     :
"""
import unittest
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0035 start---')
    ...
    def test_masking(self):
        ...
        sql_cmd4 = '''create table public.person(id int,name char(10),email 
                ...
                insert into person values(1,'张三','2147482000',
                'Shanxi,Xian,yuhuazhai'),(2,'李四','2147482001',
                'Fujian');'''
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0035 finish---')
