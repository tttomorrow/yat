...
Case Name   : 对使用basicemailmasking方式脱密的数据还原，查看数据还原成功
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0021 start---')
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0021 finish---')
