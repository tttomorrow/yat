...
Case Name   : 使用randommasking脱密策略，对邮箱格式的数据类型进行脱敏
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        text = '---Opengauss_Function_Security_Masking_Case0047 start---'
        logger.info(text)
        self.userNode = Node('PrimaryDbUser')
        self.sh_primy = CommonSH('PrimaryDbUser')
        self.common = Common()
        self.constant = Constant()
        self.poladmin = 'poladmin_security_masking_0047'
        self.com_user = 'com_security_masking_0047'
        self.resource_label = 'rl_security_masking_0047'
        self.masking_policy = 'mp_security_masking_0047'
        self.table = f'{self.poladmin}.table_security_masking_0047'
    ...
    def test_masking(self):
        ...
        sql_cmd4 = f'''drop table if exists {self.table};
                ...
                insert into {self.table} values(1,'张三','824547457@qq.com',
                'Shanxi,Xian,yuhuazhai'),(2,'李四','wangyi@163.com',
                'Fujian');'''
        ...
        assert_1 = (msg6_list[2].strip() != '824547457@qq.com' and
                    msg6_list[3].strip() != 'wangyi@163.com')
    ...
    def tearDown(self):
        ...
        logger.info(msg4)
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0047 finish---')
