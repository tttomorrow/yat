...
Case Name   : 使用regexpmasking方式脱敏，过滤多个用户
Description :
    1.poladmin用户创建表
    2.poladmin用户将敏感字段加到资源标签
    3.poladmin用户设置脱敏策略regexpmasking,过滤多个用户
...
class Security(unittest.TestCase):
    def setUp(self):
        ...
        self.poladmin = 'pol_security_masking_0081'
        self.user1 = 'u01_security_masking_0081'
        self.user2 = 'u02_security_masking_0081'
        self.table = f'{self.poladmin}.table_security_masking_0081'
        self.res_label = 'rl_security_masking_0081'
        self.masking_policy = 'mp_security_masking_0081'
        self.common = Common()
    ...
    def test_masking(self):
        ...
        text = '-----step3:poladmin用户设置脱敏策略regexpmasking,过滤多个用户;' \
               'expect:成功-----'
        self.logger.info(text)
        ...
        msg5 = self.sh_primy.execut_db_sql(sql_cmd5, sql_type=f'{content2}')
