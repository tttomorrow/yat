...
Case Name   : 使用shufflemasking方式脱密，存量数据和新增数据均被脱敏处理
Description :
...
Expect      :
    ...
    3.脱敏策略添加成功
    4.查询到string字段的信息脱敏，所有的字符顺序打乱
    5.查询到string字段的存量数据和新增数据均脱敏处理，所有的字符顺序打乱
History     :
"""
import unittest
...
class Security(unittest.TestCase):
    def setUp(self):
        text = '---Opengauss_Function_Security_Masking_Case0044 start---'
        logger.info(text)
        self.userNode = Node('PrimaryDbUser')
        self.sh_primy = CommonSH('PrimaryDbUser')
        self.common = Common()
        self.constant = Constant()
        self.poladmin = 'poladmin_security_masking_0044'
        self.com_user = 'com_security_masking_0044'
        self.resource_label = 'rl_security_masking_0044'
        self.masking_policy = 'mp_security_masking_0044'
        self.table = f'{self.poladmin}.table_security_masking_0044'
    ...
    def tearDown(self):
        ...
        logger.info(msg4)
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0044 finish---')
