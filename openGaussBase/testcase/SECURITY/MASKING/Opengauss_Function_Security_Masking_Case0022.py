...
Case Name   : 使用basicemailmasking方式脱密，未经过滤的用户不受脱敏策略限制
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0022 start---')
    ...
    def test_masking(self):
        ...
        logger.info('---------user002查看person表email字段未脱敏----------')
        ...
        self.assertTrue(msg7_list[2].strip() == '256914452@qq.com' and
                        msg7_list[3].strip() == '425878526@qq.com')
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0022 finish---')
