...
Case Name   : 使用alldigitsmasking方式脱密，未经过滤的用户不受脱敏策略限制
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0037 start---')
    ...
    def test_masking(self):
        ...
        self.assertTrue(msg7_list[2].strip() == 'qaz9176@qq.com' and
                        msg7_list[3].strip() == 'edc7896@qq.com')
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0037 finish---')