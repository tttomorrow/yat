...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0004 start---')
    ...
    def test_masking(self):
        ...
        self.common.equal_sql_mdg(msg3, 'enable_security_policy', 'on',
                                  '(1 row)', flag='1')
        logger.info('------poladmin用户创建表、资源标签------')
        ...
        logger.info('------普通用户创建脱敏策略------')
        sql_cmd5 = 'create masking policy mask_name_pol maskall on label(' \
                   'creditcard_lable);'
    ...
    def tearDown(self):
        logger.info('-------删除表及资源标签------')
        sql_cmd1 = 'drop resource label creditcard_lable;' \
                   'drop table person;'
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0004 finish---')
