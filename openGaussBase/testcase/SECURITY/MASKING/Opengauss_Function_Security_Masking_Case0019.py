...
Case Name   : 使用basicemailmasking脱密策略，对特殊符号+数字组成的邮箱格式的数据进行脱敏
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0019 start---')
    ...
    def test_masking(self):
        ...
        sql_cmd4 = '''create table public.person(id int,name char(10),email 
                ...
                insert into person values(1,'张三','qaz_sx12@163.com',
                'Shanxi,Xian,yuhuazhai'),(2,'李四','qaz&dc526@qq.com',
                'Fujian');'''
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0019 finish---')
