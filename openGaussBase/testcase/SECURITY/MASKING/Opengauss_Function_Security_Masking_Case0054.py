...
Case Name   : 使用maskall方式脱密，不支持的数据类型的文本脱敏为0
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        text = '---Opengauss_Function_Security_Masking_Case0054 start---'
        logger.info(text)
        self.userNode = Node('PrimaryDbUser')
        self.sh_primy = CommonSH('PrimaryDbUser')
        self.common = Common()
        self.constant = Constant()
        self.poladmin = 'poladmin_security_masking_0054'
        self.com_user = 'com_security_masking_0054'
        self.resource_label = 'rl_security_masking_0054'
        self.masking_policy = 'mp_security_masking_0054'
        self.table = f'{self.poladmin}.table_security_masking_0054'
    ...
    def test_masking(self):
        ...
        text = '---step1.2：poladmin用户创建表，数据类型bigint expect:创建表成功---'
        logger.info(text)
    ...
    def tearDown(self):
        ...
        logger.info(msg4)
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0054 finish---')
