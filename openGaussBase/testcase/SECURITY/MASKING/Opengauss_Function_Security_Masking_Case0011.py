...
Case Name   : 对数字+后四位为字母的字符串使用creditcardmasking方式脱密，查看数据脱敏成功
Description :
...
Expect      :
    ...
    3.脱敏策略添加成功
    4.creditcard字段的信息已做脱敏处理，仅对数字作了脱敏
History     :
"""
import unittest
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0011 start---')
    ...
    def test_masking(self):
        ...
        sql_cmd4 = '''create table public.person(id int,name char(10),
                ...
                insert into person values(1,'张三','ab26482abcd',
                'Shanxi,Xian,yuhuazhai'),(2,'李四','ab26456rfvg',
                'Fujian');'''
        ...
        self.assertTrue(msg6_list[2].strip() == 'abxxxxxabcd' and
                        msg6_list[3].strip() == 'abxxxxxrfvg')
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0011 finish---')
