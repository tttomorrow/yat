...
Case Name   : 对使用fullemailmasking方式脱密的数据还原，查看数据还原成功
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0032 start---')
    ...
    def test_masking(self):
        ...
        logger.info(msg7)
        logger.info('------user001查看person表email字段还原------')
        ...
        self.assertTrue(msg8_list[2].strip() == '8275425413@qq.com' and
                        msg8_list[3].strip() == '4534566788@qq.com')
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0032 finish---')
