...
class Security(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        text = '---Opengauss_Function_Security_Masking_Case0065 start---'
        self.logger.info(text)
        self.userNode = Node('PrimaryDbUser')
        self.sh_primy = CommonSH('PrimaryDbUser')
        self.common = Common()
        self.constant = Constant()
        self.poladmin = 'poladmin_security_masking_0065'
        self.com_user = 'com_security_masking_0065'
        self.resource_label = 'rl_security_masking_0065'
        self.masking_policy = 'mp_security_masking_0065'
        self.table = 'public.table_security_masking_0065'
    ...
    def test_masking(self):
        ...
        text = '---step4: user004用户连接数据库查看表creditcard字段' \
               '是否脱敏,expect:creditcard字段的信息，后四位之前的数字已脱敏---'
        self.logger.info(text)
        ...
        text = '---step5: 以脱敏后的数据为条件，删除数据,expect:未删除成功原数据---'
        self.logger.info(text)
        sql_cmd8 = f'delete from {self.table} where creditcard = ' \
        ...
        self.assertEqual(msg8, 'DELETE 0')
    ...
    def tearDown(self):
        ...
        self.logger.info(
            '---Opengauss_Function_Security_Masking_Case0065 finish---')