...
Case Name   : 对仅包含3位数字的字符串使用creditcardmasking方式脱密，查看数据脱敏失败
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0010 start---')
    ...
    def test_masking(self):
        ...
        sql_cmd4 = '''create table public.person(id int,name char(10),
                ...
                insert into person values(1,'张三','626',
                'Shanxi,Xian,yuhuazhai'),(2,'李四','426',
                'Fujian');'''
        ...
        self.assertTrue(msg6_list[2].strip() == '626' and
                        msg6_list[3].strip() == '426')
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0010 finish---')
