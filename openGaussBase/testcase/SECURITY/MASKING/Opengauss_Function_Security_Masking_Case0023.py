...
Case Name   : 使用basicemailmasking脱密策略，对邮箱地址去掉@符号的字符脱敏
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0023 start---')
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0023 finish---')
