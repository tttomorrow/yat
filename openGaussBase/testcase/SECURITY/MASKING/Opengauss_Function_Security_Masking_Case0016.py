...
Case Name   : 使用basicemailmasking脱密策略，对QQ邮箱格式的数据进行脱敏
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0016 start---')
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0016 finish---')
