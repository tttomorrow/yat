...
Case Name   : 具有poladmin权限的用户创建、删除资源标签
Description :
    1.安全策略管理员创建资源标签：
    2.安全策略管理员删除资源标签：
    drop resource label creditcard_lable;
Expect      :
    1.创建成功：CREATE RESOURCE LABEL
    2.删除成功：DROP RESOURCE LABEL
History     :
"""
import unittest
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0001 start---')
    ...
    def test_masking(self):
        ...
        logger.info(msg5)
        self.assertTrue('DROP RESOURCE LABEL' in msg5)
    ...
    def tearDown(self):
        ...
        self.common.equal_sql_mdg(msg3, 'enable_security_policy', 'off',
                                  '(1 row)', flag='1')
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0001 finish---')
