...
Case Name   : 使用regexpmasking方式脱敏，对信用卡格式的文本类型脱敏
Description :
    1.poladmin用户创建表
...
Expect      :
    ...
    3.脱敏策略添加成功
    4.查询到string字段的信息脱敏，第三位到第十位数字脱敏
History     :
"""
import os
import unittest
...
class Security(unittest.TestCase):
    def setUp(self):
        ...
        self.poladmin = 'pol_security_masking_0068'
        self.user = 'u_security_masking_0068'
        self.table = f'{self.poladmin}.table_security_masking_0068'
        self.res_label = 'rl_security_masking_0068'
        self.masking_policy = 'mp_security_masking_0068'
        self.common = Common()
