...
class Security(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        text = '---Opengauss_Function_Security_Masking_Case0063 start---'
        self.logger.info(text)
        self.userNode = Node('PrimaryDbUser')
        self.sh_primy = CommonSH('PrimaryDbUser')
        self.common = Common()
        self.constant = Constant()
        self.poladmin = 'poladmin_security_masking_0063'
        self.com_user = 'com_security_masking_0063'
        self.resource_label = 'rl_security_masking_0063'
        self.masking_policy = 'mp_security_masking_0063'
        self.table = 'public.table_security_masking_0063'
    ...
    def test_masking(self):
        ...
        assert_3 = self.constant.CREATE_TABLE_SUCCESS in msg2
        assert_4 = self.constant.INSERT_SUCCESS_MSG in msg2
        ...
        text = '---step4: user004用户连接数据库查看person表creditcard字段' \
        ...
        text = '---step5: 以脱敏后的数据为条件，查询数据 except: 未查询到原数据---'
        self.logger.info(text)
        sql_cmd8 = f'select * from {self.table} where creditcard = ' \
        ...
        self.common.equal_sql_mdg(msg8, 'id | name | creditcard | address',
                                  '(0 rows)', flag='1')
    ...
    def tearDown(self):
        ...
        self.logger.info(
            '---Opengauss_Function_Security_Masking_Case0063 finish---')