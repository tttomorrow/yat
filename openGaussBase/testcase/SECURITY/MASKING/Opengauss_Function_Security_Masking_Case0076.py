...
Case Name   : 使用regexpmasking方式脱敏，脱敏数据用指定字母代替
Description :
    1.poladmin用户创建表
...
class Security(unittest.TestCase):
    def setUp(self):
        ...
        self.poladmin = 'pol_security_masking_0076'
        self.user = 'u_security_masking_0076'
        self.table = f'{self.poladmin}.table_security_masking_0076'
        self.res_label = 'rl_security_masking_0076'
        self.masking_policy = 'mp_security_masking_0076'
        self.common = Common()
