...
Case Name   : 使用basicemailmasking脱密策略，对不支持的数据类型的数据进行脱敏
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0020 start---')
    ...
    def test_masking(self):
        ...
        sql_cmd4 = '''create table public.person(id int,name char(10),email 
                ...
                insert into person values(1,'张三','2147483640',
                'Shanxi,Xian,yuhuazhai'),(2,'李四','2147483645',
                'Fujian');'''
        ...
        self.assertTrue(msg6_list[2].strip() == '0' and
                        msg6_list[3].strip() == '0')
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0020 finish---')
