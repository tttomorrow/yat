...
Case Name   : 使用regexpmasking方式脱敏，脱敏数据用指定数字代替
Description :
    1.poladmin用户创建表
...
class Security(unittest.TestCase):
    def setUp(self):
        ...
        self.poladmin = 'pol_security_masking_0075'
        self.user = 'u_security_masking_0075'
        self.table = f'{self.poladmin}.table_security_masking_0075'
        self.res_label = 'rl_security_masking_0075'
        self.masking_policy = 'mp_security_masking_0075'
        self.common = Common()
    ...
    def test_masking(self):
        ...
        self.assertIn('1300-0000-0054-8988-123', msg4, '执行失败' + text)
        self.assertIn('6400-0000-0068-5477-580', msg4, '执行失败' + text)
