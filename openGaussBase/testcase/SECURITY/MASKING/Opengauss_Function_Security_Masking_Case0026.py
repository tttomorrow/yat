...
Expect      :
    ...
    3.脱敏策略添加成功
    4.查询到email字段的信息脱敏,最后一个‘.’之前的文本均被脱敏处理
History     :
"""
import unittest
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0026 start---')
    ...
    def test_masking(self):
        ...
        sql_cmd4 = '''create table public.person(id int,name char(10),email 
                ...
                insert into person values(1,'张三','2569.4452@qq.com',
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0026 finish---')
