...
Case Name   : 使用regexpmasking方式脱敏，被脱敏数据为数值类型
Description :
    1.poladmin用户创建表
...
class Security(unittest.TestCase):
    def setUp(self):
        ...
        self.poladmin = 'pol_security_masking_0071'
        self.user = 'u_security_masking_0071'
        self.table = f'{self.poladmin}.table_security_masking_0071'
        self.res_label = 'rl_security_masking_0071'
        self.masking_policy = 'mp_security_masking_0071'
        self.common = Common()
    ...
    def test_masking(self):
        ...
        sql_cmd1 = f'drop table if exists {self.table};' \
            ...
            f'bigint,address varchar(60));' \
            f'insert into {self.table} values(1,\'张三\',640233199512142423,' \
            f'\'Shanxi,Xian,yuhuazhai\'),' \
        ...
        self.common.equal_sql_mdg(msg4, 'string', '0', '0',
                                  '(2 rows)', flag='1')
