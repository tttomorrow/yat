...
class Security(unittest.TestCase):
    def setUp(self):
        text = '---Opengauss_Function_Security_Masking_Case0051 start---'
        logger.info(text)
        self.userNode = Node('PrimaryDbUser')
        self.sh_primy = CommonSH('PrimaryDbUser')
        self.common = Common()
        self.constant = Constant()
        self.poladmin = 'poladmin_security_masking_0051'
        self.com_user = 'com_security_masking_0051'
        self.resource_label = 'rl_security_masking_0051'
        self.masking_policy = 'mp_security_masking_0051'
        self.table = f'{self.poladmin}.table_security_masking_0051'
    ...
    def test_masking(self):
        ...
        self.assertTrue(assert_1 and assert_2, '执行失败:' + text)
        text = '---step4：登录用户1查看表的string字段脱敏 expect:脱敏成功---'
        logger.info(text)
    ...
    def tearDown(self):
        ...
        logger.info(msg4)
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0051 finish---')
