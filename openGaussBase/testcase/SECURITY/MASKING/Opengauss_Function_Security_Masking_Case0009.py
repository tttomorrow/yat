...
Expect      :
    ...
    3.脱敏策略添加成功
    4.creditcard字段的信息已做脱敏处理，4位数字未做脱敏处理
History     :
"""
import unittest
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0009 start---')
    ...
    def test_masking(self):
        ...
        sql_cmd4 = '''create table public.person(id int,name char(10),
                ...
                insert into person values(1,'张三','6236',
                'Shanxi,Xian,yuhuazhai'),(2,'李四','4236',
                'Fujian');'''
        ...
        self.assertTrue(msg6_list[2].strip() == '6236' and
                        msg6_list[3].strip() == '4236')
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0009 finish---')
