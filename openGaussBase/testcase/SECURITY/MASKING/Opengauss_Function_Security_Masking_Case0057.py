...
Case Name   : 对使用maskall方式脱密的数据还原，查看数据还原成功
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        text = '---Opengauss_Function_Security_Masking_Case0057 start---'
        logger.info(text)
        self.userNode = Node('PrimaryDbUser')
        self.sh_primy = CommonSH('PrimaryDbUser')
        self.common = Common()
        self.constant = Constant()
        self.poladmin = 'poladmin_security_masking_0057'
        self.com_user = 'com_security_masking_0057'
        self.resource_label = 'rl_security_masking_0057'
        self.masking_policy = 'mp_security_masking_0057'
        self.table = f'{self.poladmin}.table_security_masking_0057'
    ...
    def test_masking(self):
        ...
        assert_1 = msg8_list[2].strip() == '22337203685477580' and \
                   msg8_list[3].strip() == '13547676685489881'
    ...
    def tearDown(self):
        ...
        logger.info(msg4)
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0057 finish---')
