...
Case Name   : 对信用卡格式的文本类型使用creditcardmasking方式脱密，查看数据脱敏成功
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_Masking_Case0006 start---')
    ...
    def tearDown(self):
        ...
        logger.info(
            '---Opengauss_Function_Security_Masking_Case0006 finish---')
