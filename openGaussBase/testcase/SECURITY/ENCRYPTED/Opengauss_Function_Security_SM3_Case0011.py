...
Case Name   : 创建用户时的加密算法sm3，认证方式sha256，初始用户错误的密码连接数据库
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('--Opengauss_Function_Security_SM3_Case0011 start--')
    ...
    def tearDown(self):
        ...
        self.logger.info(msg2)
        self.logger.info(
            '----Opengauss_Function_Security_SM3_Case0011 finish----')
