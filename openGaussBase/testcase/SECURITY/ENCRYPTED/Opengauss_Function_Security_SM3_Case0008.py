...
Case Name   : 创建用户时的加密算法sha256，认证方式sm3,非初始用户正确的密码连接数据库
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_sm3_Case0008 start---')
    ...
    def tearDown(self):
        ...
        logger.info(msg3)
        logger.info('----Opengauss_Function_Security_sm3_Case0008 finish----')
