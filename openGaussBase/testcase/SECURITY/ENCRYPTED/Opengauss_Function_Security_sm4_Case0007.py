...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_sm4_Case0007 start---')
    ...
    def tearDown(self):
        ...
        logger.info('----Opengauss_Function_Security_sm4_Case0007 finish----')
