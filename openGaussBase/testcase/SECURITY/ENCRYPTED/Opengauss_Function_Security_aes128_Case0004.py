...
Case Name   : aes128加密数据，密码为数字+小写字母
Description :
    1.select gs_encrypt('shanxi.xian,yantaqu0569-5','wssx1234','aes128');
Expect      :
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_aes128_Case0004 start---')
        self.userNode = Node('PrimaryDbUser')
        self.sh_primy = CommonSH('PrimaryDbUser')

    def test_aes128(self):
        logger.info('----1.aes128加数据，密码为数字+小写字母----')
        sql_cmd1 = 'create table table001(name char(6),address text);' \
                   ...
                   '\'wssx1234\',\'aes128\')),(\'张三\',\'shanxi.xian,' \
    ...
    def tearDown(self):
        ...
        logger.info('---Opengauss_Function_Security_aes128_Case0004 finish---')
