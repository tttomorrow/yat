...
"""
Case Type   : Interface
Case Name   : 加密算法与认证方式均为sm3,初始用户错误的密码通过ODBC连接数据库
Description :
    1.安装unixODBC
    2.配置加密方式和认证方式为sm3
    3.配置数据源
...
class Security(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('--Opengauss_Function_Security_SM3_Case0059 start--')
    ...
    def tearDown(self):
        ...
        self.logger.info('--Opengauss_Function_Security_SM3_Case0059 finish--')
