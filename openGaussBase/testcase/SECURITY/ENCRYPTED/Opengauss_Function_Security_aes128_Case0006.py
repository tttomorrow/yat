...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_aes128_Case0006 start---')
    ...
    def tearDown(self):
        ...
        logger.info('---Opengauss_Function_Security_aes128_Case0006 finish---')