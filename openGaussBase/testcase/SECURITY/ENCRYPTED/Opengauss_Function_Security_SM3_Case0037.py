...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_sm3_Case0037 start---')
    ...
    def test_encrypted(self):
        logger.info('--------1.修改password_encryption_type=2--------')
    ...
    def tearDown(self):
        ...
        msg4 = self.sh_primy.execut_db_sql(sql_cmd4)
        logger.info(msg4)
        logger.info('----Opengauss_Function_Security_sm3_Case0037 finish----')
