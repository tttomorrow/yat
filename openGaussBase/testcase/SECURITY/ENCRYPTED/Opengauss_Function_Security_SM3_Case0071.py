...
"""
Case Type   : Interface
Case Name   : 创建用户时的加密算法sm3，认证方式md5，初始用户错误的密码通过ODBC连接数据库
Description :
    1.安装unixODBC
...
class Security(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('--Opengauss_Function_Security_SM3_Case0071 start--')
    ...
    def tearDown(self):
        ...
        self.logger.info('--Opengauss_Function_Security_SM3_Case0071 finish--')
