...
Case Name   : 创建用户时的加密算法sm3，认证方式md5，初始用户正确的密码通过JDBC连接数据库
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('--Opengauss_Function_Security_sm3_Case0042 start--')
    ...
    def tearDown(self):
        ...
        self.logger.info(msg3)
        self.logger.info('--Opengauss_Function_Security_sm3_Case0042 finish--')
