...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_sm3_Case0052 start---')
    ...
    def test_encrypted(self):
        logger.info('--------1.修改password_encryption_type=1--------')
        ...
        logger.info('--------4.1 写入配置文件，用户user001设置正确的密码-------')
    ...
    def tearDown(self):
        ...
        msg4 = self.sh_primy.execut_db_sql(sql_cmd4)
        logger.info(msg4)
        logger.info('----Opengauss_Function_Security_sm3_Case0052 finish----')
