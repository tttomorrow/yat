...
Case Name   : 表中插入数据时对数据使用aes128加密方式加密，数据插入后对加密数据解密
Description :
    1.创建表table001；
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_aes128_Case0001 start---')
    ...
    def tearDown(self):
        ...
        self.common.equal_sql_mdg(msg7, 'log_statement', f'{return_msg3}',
                                  '(1 row)', flag='1')
        logger.info('---Opengauss_Function_Security_aes128_Case0001 finish---')
