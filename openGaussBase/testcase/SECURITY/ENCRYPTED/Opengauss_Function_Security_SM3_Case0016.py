...
Case Name   : 创建用户时的加密算法sm3，认证方式md5，非初始用户正确的密码连接数据库
Description :
...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('---Opengauss_Function_Security_sm3_Case0016 start---')
    ...
    def test_masking(self):
        ...
        logger.info(msg2)
        insert_messages = f"local {self.userNode.db_name} user001 md5"
    ...
    def tearDown(self):
        ...
        logger.info(msg3)
        logger.info('----Opengauss_Function_Security_sm3_Case0016 finish----')
