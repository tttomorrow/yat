...
class Security(unittest.TestCase):
    def setUp(self):
        logger.info('----Opengauss_Function_Security_sm3_Case0088 start----')
    ...
    def test_encrypted(self):
        ...
        logger.info('--------5.使用默认端口连接数据库-------')
        exe_cmd5 = f'source {self.DB_ENV_PATH};' \
            f'gsql -d {self.dbname} -p 5432 -c "\\q"'
    ...
    def tearDown(self):
        ...
        logger.info(msg4)
        logger.info('----Opengauss_Function_Security_sm3_Case0088 finish----')
