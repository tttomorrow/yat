--  @testpoint:openGauss关键字dbcompatibility(非保留)，作为列名带引号并且删除时使用该列,建表成功，dbcompatibility列值是'hello'的删除成功
...
insert into dbcompatibility_test(c_id) values(2);
delete from dbcompatibility_test where "dbcompatibility"='hello';
