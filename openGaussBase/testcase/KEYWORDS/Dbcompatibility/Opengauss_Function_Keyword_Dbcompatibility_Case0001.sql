--  @testpoint:openGauss关键字Dbcompatibility(非保留),作为列名不带双引号，Dbcompatibility大小写混合，建表成功
...
--openGauss关键字dbcompatibility(非保留),作为列名不带双引号，dbcompatibility大小匹配，建表成功
