--  @testpoint:openGauss关键字precision(非保留)，作为列名带引号并且删除时使用该列,建表成功，precision列值是'hello'的删除成功
...
insert into precision_test(c_id) values(2);
delete from precision_test where "precision"='hello';
