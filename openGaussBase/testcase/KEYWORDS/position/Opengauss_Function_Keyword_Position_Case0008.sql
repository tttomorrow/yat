--  @testpoint:openGauss关键字position(非保留)，作为列名带引号并且删除时使用该列,建表成功，position列值是'hello'的删除成功
...
insert into position_test(c_id) values(2);
delete from position_test where "position"='hello';
