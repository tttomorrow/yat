--  @testpoint:openGauss关键字constraint_name(非保留)，作为列名带引号并且删除时使用该列,建表成功，constraint_name列值是'hello'的删除成功
...
insert into constraint_name_test(c_id) values(2);
delete from constraint_name_test where "constraint_name"='hello';
