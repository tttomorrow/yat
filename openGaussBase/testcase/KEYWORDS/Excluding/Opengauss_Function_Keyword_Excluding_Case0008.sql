--  @testpoint:openGauss关键字excluding(非保留)，作为列名带引号并且删除时使用该列,建表成功，excluding列值是'hello'的删除成功
...
insert into excluding_test(c_id) values(2);
delete from excluding_test where "excluding"='hello';
