--  @testpoint:openGauss关键字float(非保留)，作为列名带引号并且删除时使用该列,建表成功，float列值是'hello'的删除成功
...
insert into float_test(c_id) values(2);
delete from float_test where "float"='hello';
