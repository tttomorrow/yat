--  @testpoint:openGauss关键字percent(非保留)，作为列名带引号并且删除时使用该列,建表成功，percent列值是'hello'的删除成功
...
insert into percent_test(c_id) values(2);
delete from percent_test where "percent"='hello';
