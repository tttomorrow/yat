--  @testpoint:openGauss关键字privileges(非保留,作为列名不带双引号，privileges大小写混合，建表成功
...
select * from privileges_test;
drop table privileges_test;

--openGauss关键字privileges(非保留,作为列名不带双引号，privileges大小匹配，建表成功
