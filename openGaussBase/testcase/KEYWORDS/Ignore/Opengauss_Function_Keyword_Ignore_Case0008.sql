--  @testpoint:openGauss关键字Ignore(非保留)，作为列名带引号并且删除时使用该列,建表成功，Ignore列值是'hello'的删除成功
...
delete from explain_test where "Ignore"='hello';
select * from explain_test order by "Ignore";
