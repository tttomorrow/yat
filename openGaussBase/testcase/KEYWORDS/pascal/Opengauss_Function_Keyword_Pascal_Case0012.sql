--  @testpoint:openGauss关键字pascal(非保留)同时作为表名和列名带引号,并使用该列结合limit排序,pascal列的值按字母大小排序且只显示前2条数据
...
select "pascal" from "pascal" where "pascal"!='hello' order by "pascal" limit 2 ;
