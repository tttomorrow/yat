--  @testpoint:openGauss关键字prepared(非保留)，作为列名带引号并且删除时使用该列,建表成功，prepared列值是'hello'的删除成功
...
insert into prepared_test(c_id) values(2);
delete from prepared_test where "prepared"='hello';
