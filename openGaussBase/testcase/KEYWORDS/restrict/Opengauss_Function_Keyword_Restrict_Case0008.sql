--  @testpoint:openGauss关键字restrict(非保留)，作为列名带引号并且删除时使用该列,建表成功，restrict列值是'hello'的删除成功
...
insert into restrict_test(c_id) values(2);
delete from restrict_test where "restrict"='hello';
