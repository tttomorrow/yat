--  @testpoint:openGauss关键字transactions_rolled_back(非保留),作为列名不带双引号，transactions_rolled_back大小写混合，建表成功
...
--openGauss关键字transactions_rolled_back(非保留),作为列名不带双引号，transactions_rolled_back大小匹配，建表成功
