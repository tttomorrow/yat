--  @testpoint:openGauss关键字postfix(非保留)，作为列名带引号并且删除时使用该列,建表成功，postfix列值是'hello'的删除成功
...
insert into postfix_test(c_id) values(2);
delete from postfix_test where "postfix"='hello';
