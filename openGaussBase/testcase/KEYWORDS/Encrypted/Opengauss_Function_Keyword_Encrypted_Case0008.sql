--  @testpoint:openGauss关键字encrypted(非保留)，作为列名带引号并且删除时使用该列,建表成功，encrypted列值是'hello'的删除成功
...
insert into encrypted_test(c_id) values(2);
delete from encrypted_test where "encrypted"='hello';
