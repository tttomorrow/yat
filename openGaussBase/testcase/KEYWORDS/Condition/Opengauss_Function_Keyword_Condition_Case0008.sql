--  @testpoint:openGauss关键字condition(非保留)，作为列名带引号并且删除时使用该列,建表成功，condition列值是'hello'的删除成功
...
insert into condition_test(c_id) values(2);
delete from condition_test where "condition"='hello';
