--  @testpoint:openGauss关键字decode(非保留)，作为列名带引号并且删除时使用该列,建表成功，decode列值是'hello'的删除成功
...
insert into decode_test(c_id) values(2);
delete from decode_test where "decode"='hello';
