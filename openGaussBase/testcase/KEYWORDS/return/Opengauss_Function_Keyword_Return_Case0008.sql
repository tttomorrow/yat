--  @testpoint:openGauss关键字return(非保留)，作为列名带引号并且删除时使用该列,建表成功，return列值是'hello'的删除成功
...
insert into return_test(c_id) values(2);
delete from return_test where "return"='hello';
