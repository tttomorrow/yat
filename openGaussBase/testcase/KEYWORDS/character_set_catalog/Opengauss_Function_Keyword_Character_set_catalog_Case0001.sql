--  @testpoint:openGauss关键字character_set_catalog(非保留,作为列名不带双引号，character_set_catalog大小写混合，建表成功
--创建表
...
--openGauss关键字character_set_catalog(非保留,作为列名不带双引号，character_set_catalog大小匹配，建表成功
