-- @testpoint: opengauss关键字Hierarchy(非保留)，作为触发器名，部分测试点合理报错
...
CREATE TRIGGER Hierarchy BEFORE INSERT ON test_trigger_src_tbl FOR EACH ROW EXECUTE PROCEDURE tri_insert_func();
/
DROP TRIGGER Hierarchy ON test_trigger_src_tbl CASCADE;
