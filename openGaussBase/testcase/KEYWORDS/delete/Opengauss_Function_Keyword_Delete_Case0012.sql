--  @testpoint:openGauss关键字delete(非保留)同时作为表名和列名带引号,并使用该列结合limit排序,delete列的值按字母大小排序且只显示前2条数据
...
select "delete" from "delete" where "delete"!='hello' order by "delete" limit 2 ;
