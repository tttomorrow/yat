--  @testpoint:openGauss关键字public(非保留)，作为列名带引号并且删除时使用该列,建表成功，public列值是'hello'的删除成功
...
insert into public_test(c_id) values(2);
delete from public_test where "public"='hello';
