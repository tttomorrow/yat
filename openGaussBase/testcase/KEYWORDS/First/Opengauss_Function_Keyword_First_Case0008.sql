--  @testpoint:openGauss关键字first(非保留)，作为列名带引号并且删除时使用该列,建表成功，first列值是'hello'的删除成功
...
insert into first_test(c_id) values(2);
delete from first_test where "first"='hello';
