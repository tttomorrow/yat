--  @testpoint:openGauss关键字disconnect(非保留)，作为列名带引号并且删除时使用该列,建表成功，disconnect列值是'hello'的删除成功
...
insert into disconnect_test(c_id) values(2);
delete from disconnect_test where "disconnect"='hello';
