--  @testpoint:openGauss关键字generated(非保留),作为列名不带双引号，generated大小写混合，建表成功
...
--openGauss关键字generated(非保�?,作为列名不带双引号，generated大小匹配，建表成�?drop table if exists Collation_Catalog_test;
