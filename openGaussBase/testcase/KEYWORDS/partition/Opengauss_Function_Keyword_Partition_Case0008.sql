--  @testpoint:openGauss关键字partition(非保留)，作为列名带引号并且删除时使用该列,建表成功，partition列值是'hello'的删除成功
...
insert into partition_test(c_id) values(2);
delete from partition_test where "partition"='hello';
