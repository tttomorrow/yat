--  @testpoint:openGauss关键字constraint_catalog(非保留)，作为列名带引号并且更新时使用该列，建表成功，constraint_catalog的值更新为100
...
update constraint_catalog_test set "constraint_catalog"=100;
