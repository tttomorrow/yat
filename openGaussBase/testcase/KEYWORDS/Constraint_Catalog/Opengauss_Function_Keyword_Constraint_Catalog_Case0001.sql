-- @testpoint: openGauss关键字Constraint_Catalog(非保留),作为列名不带双引号，Constraint_Catalog大小写混合，建表成功
...
--openGauss关键字constraint_catalog(非保留),作为列名不带双引号，constraint_catalog大小匹配，建表成功
