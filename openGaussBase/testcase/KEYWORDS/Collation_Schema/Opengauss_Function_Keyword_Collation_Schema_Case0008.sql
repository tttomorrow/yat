--  @testpoint:openGauss关键字collation_schema(非保留)，作为列名带引号并且删除时使用该列,建表成功，collation_schema列值是'hello'的删除成功
...
insert into collation_schema_test(c_id) values(2);
delete from collation_schema_test where "collation_schema"='hello';
