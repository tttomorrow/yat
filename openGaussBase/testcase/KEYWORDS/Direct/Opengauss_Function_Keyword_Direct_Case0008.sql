--  @testpoint:openGauss关键字direct(非保留)，作为列名带引号并且删除时使用该列,建表成功，direct列值是'hello'的删除成功
...
insert into direct_test(c_id) values(2);
delete from direct_test where "direct"='hello';
