--  @testpoint:openGauss关键字quote(非保留)，作为列名带引号并且删除时使用该列,建表成功，quote列值是'hello'的删除成功
...
insert into quote_test(c_id) values(2);
delete from quote_test where "quote"='hello';
