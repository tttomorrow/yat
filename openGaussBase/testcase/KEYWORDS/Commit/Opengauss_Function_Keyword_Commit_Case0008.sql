--  @testpoint:openGauss关键字commit(非保留)，作为列名带引号并且删除时使用该列,建表成功，commit列值是'hello'的删除成功
...
insert into commit_test(c_id) values(2);
delete from commit_test where "commit"='hello';
