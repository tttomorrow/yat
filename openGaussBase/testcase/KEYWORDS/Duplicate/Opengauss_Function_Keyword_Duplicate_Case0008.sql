--  @testpoint:openGauss关键字duplicate(非保留)，作为列名带引号并且删除时使用该列,建表成功，duplicate列值是'hello'的删除成功
...
insert into duplicate_test(c_id) values(2);
delete from duplicate_test where "duplicate"='hello';
