--  @testpoint:openGauss关键字deref(非保留)，作为列名带引号并且删除时使用该列,建表成功，deref列值是'hello'的删除成功
...
insert into deref_test(c_id) values(2);
delete from deref_test where "deref"='hello';
