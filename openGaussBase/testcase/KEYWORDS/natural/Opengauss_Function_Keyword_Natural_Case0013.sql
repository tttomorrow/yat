--  @testpoint:openGauss保留关键字natural同时作为表名和列名带引号，与union结合查询合并两个SELECT 语句查询
...
select "natural" from "natural" where "natural"='hello'
union all (select "natural" from "natural" where "natural"!='hello' order by "natural" limit 2);
