--  @testpoint:openGauss关键字collation_catalog(非保留)，作为列名带引号并且删除时使用该列,建表成功，collation_catalog列值是'hello'的删除成功
...
insert into collation_catalog_test(c_id) values(2);
delete from collation_catalog_test where "collation_catalog"='hello';
