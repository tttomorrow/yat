--  @testpoint:openGauss关键字parser(非保留)，作为列名带引号并且删除时使用该列,建表成功，parser列值是'hello'的删除成功
...
insert into parser_test(c_id) values(2);
delete from parser_test where "parser"='hello';
