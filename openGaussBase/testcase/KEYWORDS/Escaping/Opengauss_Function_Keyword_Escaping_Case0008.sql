--  @testpoint:openGauss关键字escaping(非保留)，作为列名带引号并且删除时使用该列,建表成功，escaping列值是'hello'的删除成功
...
insert into escaping_test(c_id) values(2);
delete from escaping_test where "escaping"='hello';
