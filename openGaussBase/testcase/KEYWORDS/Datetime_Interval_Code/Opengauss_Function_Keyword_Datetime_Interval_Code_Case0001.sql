--  @testpoint:openGauss关键字Datetime_Interval_Code(非保留),作为列名不带双引号，Datetime_Interval_Code大小写混合，建表成功
...
--openGauss关键字datetime_interval_code(非保留),作为列名不带双引号，datetime_interval_code大小匹配，建表成功
