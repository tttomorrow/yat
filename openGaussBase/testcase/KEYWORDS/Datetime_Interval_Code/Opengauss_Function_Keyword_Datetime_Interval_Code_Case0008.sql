--  @testpoint:openGauss关键字datetime_interval_code(非保留)，作为列名带引号并且删除时使用该列,建表成功，datetime_interval_code列值是'hello'的删除成功
...
insert into datetime_interval_code_test(c_id) values(2);
delete from datetime_interval_code_test where "datetime_interval_code"='hello';
