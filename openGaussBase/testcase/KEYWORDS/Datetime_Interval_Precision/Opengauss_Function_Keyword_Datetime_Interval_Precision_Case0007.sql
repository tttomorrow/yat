--  @testpoint:openGauss关键字datetime_interval_precision(非保留)，作为列名带引号并且更新时使用该列，建表成功，datetime_interval_precision的值更新为100
...
update datetime_interval_precision_test set "datetime_interval_precision"=100;
