--  @testpoint:openGauss关键字depth(非保留)，作为列名带引号并且删除时使用该列,建表成功，depth列值是'hello'的删除成功
...
insert into depth_test(c_id) values(2);
delete from depth_test where "depth"='hello';
