--  @testpoint:openGauss关键字execute(非保留)，作为列名带引号并且删除时使用该列,建表成功，execute列值是'hello'的删除成功
...
insert into execute_test(c_id) values(2);
delete from execute_test where "execute"='hello';
