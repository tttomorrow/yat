--  @testpoint:openGauss关键字database(非保留)，作为列名带引号并且删除时使用该列,建表成功，database列值是'hello'的删除成功
...
insert into database_test(c_id) values(2);
delete from database_test where "database"='hello';
