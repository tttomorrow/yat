-- @testpoint: opengauss关键字Hold(非保留)，作为触发器名，部分测试点合理报错
...
CREATE TRIGGER Hold BEFORE INSERT ON test_trigger_src_tbl FOR EACH ROW EXECUTE PROCEDURE tri_insert_func();
/
DROP TRIGGER Hold ON test_trigger_src_tbl CASCADE;
