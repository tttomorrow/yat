--  @testpoint:openGauss关键字Parameter_specific_name(非保留),作为列名不带双引号，Parameter_specific_name大小写混合，建表成功
...
--openGauss关键字parameter_specific_name(非保留),作为列名不带双引号，parameter_specific_name大小匹配，建表成功
