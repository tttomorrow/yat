--  @testpoint:openGauss关键字exchange(非保留)，作为列名带引号并且删除时使用该列,建表成功，exchange列值是'hello'的删除成功
...
insert into exchange_test(c_id) values(2);
delete from exchange_test where "exchange"='hello';
