--  @testpoint:openGauss关键字command_function_code(非保留)，作为列名带引号并且更新时使用该列，建表成功，command_function_code的值更新为100
...
update command_function_code_test set "command_function_code"=100;
