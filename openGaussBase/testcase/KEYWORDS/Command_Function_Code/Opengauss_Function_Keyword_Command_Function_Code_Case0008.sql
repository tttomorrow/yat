--  @testpoint:openGauss关键字command_function_code(非保留)，作为列名带引号并且删除时使用该列,建表成功，command_function_code列值是'hello'的删除成功
...
insert into command_function_code_test(c_id) values(2);
delete from command_function_code_test where "command_function_code"='hello';
