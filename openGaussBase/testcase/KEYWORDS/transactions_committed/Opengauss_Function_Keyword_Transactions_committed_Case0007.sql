--  @testpoint:openGauss关键字transactions_committed(非保留)，作为列名带引号并且更新时使用该列，建表成功，transactions_committed的值更新为100
...
update explain_test set "transactions_committed"=100;
