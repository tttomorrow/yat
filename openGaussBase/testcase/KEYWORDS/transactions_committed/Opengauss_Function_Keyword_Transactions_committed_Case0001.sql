--  @testpoint:openGauss关键字transactions_committed(非保留),作为列名不带双引号，transactions_committed大小写混合，建表成功
...
--openGauss关键字transactions_committed(非保留),作为列名不带双引号，transactions_committed大小匹配，建表成功
