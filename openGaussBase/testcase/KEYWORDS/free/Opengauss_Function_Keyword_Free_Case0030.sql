-- @testpoint: opengauss关键字free(非保留)，作为触发器名，合理报错
...
CREATE TRIGGER free BEFORE INSERT ON test_trigger_src_tbl FOR EACH ROW EXECUTE PROCEDURE tri_insert_func();
/
drop TRIGGER free on test_trigger_src_tbl cascade;
