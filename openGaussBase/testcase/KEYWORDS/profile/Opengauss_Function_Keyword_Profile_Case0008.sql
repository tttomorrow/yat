--  @testpoint:openGauss关键字profile(非保留)，作为列名带引号并且删除时使用该列,建表成功，profile列值是'hello'的删除成功
...
insert into profile_test(c_id) values(2);
delete from profile_test where "profile"='hello';
