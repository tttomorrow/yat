--  @testpoint:openGauss关键字equals(非保留)，同时作为表名和列名带引号，与union结合查询合并两个SELECT 语句查询
...
select "equals" from "equals" where "equals"='hello'
union all (select "equals" from "equals" where "equals"!='hello' order by "equals" limit 2);
