--  @testpoint:openGauss关键字equals(非保留)，作为列名带引号并且删除时使用该列,建表成功，equals列值是'hello'的删除成功
...
insert into equals_test(c_id) values(2);
delete from equals_test where "equals"='hello';
