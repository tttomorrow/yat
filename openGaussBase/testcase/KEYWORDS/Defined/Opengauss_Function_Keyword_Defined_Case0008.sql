--  @testpoint:openGauss关键字defined(非保留)，作为列名带引号并且删除时使用该列,建表成功，defined列值是'hello'的删除成功
...
insert into defined_test(c_id) values(2);
delete from defined_test where "defined"='hello';
