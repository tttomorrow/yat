--  @testpoint:openGauss关键字domain(非保留)，作为列名带引号并且删除时使用该列,建表成功，domain列值是'hello'的删除成功
...
insert into domain_test(c_id) values(2);
delete from domain_test where "domain"='hello';
