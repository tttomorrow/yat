--  @testpoint:openGauss关键字exclusive(非保留)，作为列名带引号并且删除时使用该列,建表成功，exclusive列值是'hello'的删除成功
...
insert into exclusive_test(c_id) values(2);
delete from exclusive_test where "exclusive"='hello';
