--  @testpoint:openGauss关键字declare(非保留)，同时作为表名和列名带引号，与union结合查询合并两个SELECT 语句查询
...
select "declare" from "declare" where "declare"='hello'
union all (select "declare" from "declare" where "declare"!='hello' order by "declare" limit 2);
