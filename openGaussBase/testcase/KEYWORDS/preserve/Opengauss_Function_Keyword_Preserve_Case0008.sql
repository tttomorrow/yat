--  @testpoint:openGauss关键字preserve(非保留)，作为列名带引号并且删除时使用该列,建表成功，preserve列值是'hello'的删除成功
...
insert into preserve_test(c_id) values(2);
delete from preserve_test where "preserve"='hello';
