--  @testpoint:openGauss关键字document(非保留)，作为列名带引号并且删除时使用该列,建表成功，document列值是'hello'的删除成功
...
insert into document_test(c_id) values(2);
delete from document_test where "document"='hello';
