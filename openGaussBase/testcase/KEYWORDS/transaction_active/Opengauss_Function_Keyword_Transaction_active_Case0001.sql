--  @testpoint:openGauss关键字transaction_active(非保留),作为列名不带双引号，transaction_active大小写混合，建表成功
...
--openGauss关键字transaction_active(非保留),作为列名不带双引号，transaction_active大小匹配，建表成功
