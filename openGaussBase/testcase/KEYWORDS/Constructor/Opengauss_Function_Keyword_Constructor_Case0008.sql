--  @testpoint:openGauss关键字constructor(非保留)，作为列名带引号并且删除时使用该列,建表成功，constructor列值是'hello'的删除成功
...
insert into constructor_test(c_id) values(2);
delete from constructor_test where "constructor"='hello';
