--  @testpoint:openGauss关键字constructor(非保留)，同时作为表名和列名带引号，与union结合查询合并两个SELECT 语句查询
...
select "constructor" from "constructor" where "constructor"='hello'
union all (select "constructor" from "constructor" where "constructor"!='hello' order by "constructor" limit 2);
