--  @testpoint:openGauss关键字returned_octet_length(非保留)，作为列名带引号并且删除时使用该列,建表成功，returned_octet_length列值是'hello'的删除成功
...
insert into returned_octet_length_test(c_id) values(2);
delete from returned_octet_length_test where "returned_octet_length"='hello';
