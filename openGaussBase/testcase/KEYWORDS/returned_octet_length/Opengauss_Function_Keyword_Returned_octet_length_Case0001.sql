--  @testpoint:openGauss关键字returned_octet_length(非保留,作为列名不带双引号，returned_octet_length大小写混合，建表成功
...
--openGauss关键字returned_octet_length(非保留,作为列名不带双引号，returned_octet_length大小匹配，建表成功
