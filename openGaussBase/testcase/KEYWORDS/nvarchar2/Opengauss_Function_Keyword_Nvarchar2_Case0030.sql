-- @testpoint: opengauss关键字nvarchar2(非保留)，作为触发器名,部分测试点合理报错
...
CREATE TRIGGER nvarchar2 BEFORE INSERT ON test_trigger_src_tbl FOR EACH ROW EXECUTE PROCEDURE tri_insert_func();
/
drop TRIGGER nvarchar2 on test_trigger_src_tbl cascade;
