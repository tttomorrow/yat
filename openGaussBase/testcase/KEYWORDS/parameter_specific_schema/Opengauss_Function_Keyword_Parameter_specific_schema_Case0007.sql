--  @testpoint:openGauss关键字parameter_specific_schema(非保留)，作为列名带引号并且更新时使用该列，建表成功，parameter_specific_schema的值更新为100
...
update explain_test set "parameter_specific_schema"=100;
