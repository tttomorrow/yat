--  @testpoint:openGauss关键字Parameter_specific_schema(非保留),作为列名不带双引号，Parameter_specific_schema大小写混合，建表成功
...
create table Explain_test(
	...
	Parameter_specific_schema text
)
...
--openGauss关键字parameter_specific_schema(非保留),作为列名不带双引号，parameter_specific_schema大小匹配，建表成功
