--  @testpoint:openGauss关键字contains(非保留)，作为列名带引号并且删除时使用该列,建表成功，contains列值是'hello'的删除成功
...
insert into contains_test(c_id) values(2);
delete from contains_test where "contains"='hello';
