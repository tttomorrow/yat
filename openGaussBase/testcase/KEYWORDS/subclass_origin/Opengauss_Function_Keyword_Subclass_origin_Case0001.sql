--  @testpoint:openGauss关键字subclass_origin(非保留),作为列名不带双引号，subclass_origin大小写混合，建表成功
...
--openGauss关键字subclass_origin(非保留),作为列名不带双引号，subclass_origin大小匹配，建表成功
