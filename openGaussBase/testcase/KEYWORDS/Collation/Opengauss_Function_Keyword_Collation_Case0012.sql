--  @testpoint:openGauss保留关键字Collation同时作为表名和列名带引号,并使用该列结合limit排序,Collation列的值按字母大小排序且只显示前2条数据
...
--查看表数据
select "Collation" from "Collation" where "Collation"!='hello' order by "Collation" limit 2 ;
