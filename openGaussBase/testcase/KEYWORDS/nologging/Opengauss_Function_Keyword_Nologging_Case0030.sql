-- @testpoint: opengauss关键字nologging(非保留)，作为触发器名,部分测试点合理报错
...
CREATE TRIGGER nologging BEFORE INSERT ON test_trigger_src_tbl FOR EACH ROW EXECUTE PROCEDURE tri_insert_func();
/
drop TRIGGER nologging on test_trigger_src_tbl cascade;
