--  @testpoint:openGauss关键字prepare(非保留)，作为列名带引号并且删除时使用该列,建表成功，prepare列值是'hello'的删除成功
...
insert into prepare_test(c_id) values(2);
delete from prepare_test where "prepare"='hello';
