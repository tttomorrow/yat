--  @testpoint:openGauss关键字resize(非保留)，作为列名带引号并且删除时使用该列,建表成功，resize列值是'hello'的删除成功
...
insert into resize_test(c_id) values(2);
delete from resize_test where "resize"='hello';
