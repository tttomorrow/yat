...
class LogicalReplication(unittest.TestCase):
    def setUp(self):
        ...
        LOG.info(
            '---Opengauss_Function_Logical_Replication_Case0005开始执行-----')
        self.com = Common()
    ...
    def test_logical_replication(self):
        ...
        msg = self.comsh.execut_db_sql('''
            ...
            delete from warehouse_t where W_WAREHOUSE_SK = 2;
                                        ''')
        LOG.info(msg)
    ...
    def tearDown(self):
        ...
        LOG.info(startmsg)
        LOG.info(
            '-----Opengauss_Function_Logical_Replication_Case0005执行完成---')
