...
class LogicalReplication(unittest.TestCase):
    def setUp(self):
        ...
        self.decode_file = os.path.join(macro.DB_INSTANCE_PATH,
                                        'logical13.txt')
        self.us_name = "us_logical_replication_case0013"
        self.slot_name = "slot_logical_replication_case0013"
        self.tb_name = "tb_logical_replication_case0013"
    ...
    def test_standby_logical(self):
        ...
        text = '--step8:创建MOT表并进行DML操作;expect:创建成功--'
        self.log.info(text)
        sql_cmd = Pri_SH.execut_db_sql(f'''drop foreign table if exists 
            {self.tb_name};
