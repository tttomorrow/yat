...
class LogicalReplication(unittest.TestCase):
    ...
    def test_standby_logical(self):
        ...
        if 'slot_test005' in check_res.split('\n')[-2].strip():
        ...
        self.assertIn('slot_test005', query_cmd)
        ...
        sql_cmd = Primary_SH.execut_db_sql('''drop table if exists test005;
            create table test005(c_1 integer primary key,
            c_2 bigint,
            c_3 smallint,
            c_4 tinyint,
            c_5 serial,
            ...
            c_16 blob,
            c_17 bytea);
            insert into test005 values(1,10,5,25,default,default,default,\
            1237.127,123456.1234,date '12-10-2010','21:21:21','2010-12-12',\
            '测试','测试工程师','西安',empty_blob(),E'\\xDEADBEEF');
            UPDATE test005 SET c_1 = 666;
            UPDATE test005 SET c_15 = '陕西';
            delete from test005 where c_16 = empty_blob();''')
        self.log.info(sql_cmd)
