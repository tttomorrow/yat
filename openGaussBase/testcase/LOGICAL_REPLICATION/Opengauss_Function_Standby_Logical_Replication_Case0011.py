...
class LogicalReplication(unittest.TestCase):
    def setUp(self):
        ...
        self.decode_file = os.path.join(macro.DB_INSTANCE_PATH,
                                        'logical11.txt')
        self.us_name = "us_logical_replication_case0011"
        self.slot_name = "slot_logical_replication_case0011"
        self.tb_name = "tb_logical_replication_case0011"
    ...
    def test_standby_logical(self):
        ...
        text = '--step8:创建列存表并进行DML操作;expect:创建成功--'
        self.log.info(text)
