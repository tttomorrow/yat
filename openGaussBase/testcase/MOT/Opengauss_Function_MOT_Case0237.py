...
"""
Case Type   : MOT
Case Name   : MOT设置enable_gc=false进行SQL语句测试
Description :
    1、修改配置文件mot.conf中enable_gc=false
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0237开始执行======")
        LOG.info("======步骤1：修改配置文件设置enable_gc=false启动数据库======")
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0237执行结束======')
