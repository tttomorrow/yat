...
"""
Case Type   : MOT
Case Name   : MOT设置session_max_huge_object_size=-1MB进行SQL语句测试
Description :
    1、修改配置文件mot.conf中session_max_huge_object_size=-1MB
...
CONFIG_PARAM = 'session_max_huge_object_size = -1MB'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0234开始执行======")
        LOG.info("====步骤1：修改配置文件设置session_max_huge_object_size=-1MB启动数据库====")
        ...
        self.assertIn('Configuration of '
                      'session_max_huge_object_size=17592186044415'
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0234执行结束======')
