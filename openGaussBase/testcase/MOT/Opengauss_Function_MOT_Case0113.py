...
"""
Case Type   : MOT
Case Name   : MOT设置enable_group_commit= 进行SQL语句测试
Description :
    1、修改配置文件mot.conf中enable_group_commit=
...
CONFIG_PARAM = 'enable_group_commit = '
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_dump(self):
        LOG.info("======Opengauss_Function_MOT_Case0113开始执行======")
        LOG.info("===步骤1：修改mot.conf配置文件，设置enable_group_commit= ,重启数据库===")
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0113执行结束======')
