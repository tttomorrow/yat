...
"""
Case Type   : MOT
Case Name   : MOT设置mot_codegen_limit= 进行SQL语句测试
Description :
    1、修改配置文件mot.conf中mot_codegen_limit=
...
CONFIG_PARAM = 'mot_codegen_limit =  '
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0268开始执行======")
        LOG.info("======步骤1：修改配置文件设置mot_codegen_limit= 启动数据库======")
        ...
        self.assertIn('Empty value specified for configuration'
                      ' item mot_codegen_limit', cmd_msg)
    ...
    def tearDown(self):
        ...
        LOG.info("======Opengauss_Function_MOT_Case0268执行结束======")
