...
"""
Case Type   : MOT
Case Name   : MOT设置session_large_buffer_store_max_object_size=10%进行SQL语句测试
Description :
    1、修改配置文件mot.conf中session_large_buffer_store_max_object_size=10%
...
CONFIG_PARAM = 'session_large_buffer_store_max_object_size = 10%'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0230开始执行======")
        ...
        self.assertIn('Invalid session_large_buffer_store_max_object_size'
                      ' memory value format: 10%', cmd_msg)
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0230执行结束======')
