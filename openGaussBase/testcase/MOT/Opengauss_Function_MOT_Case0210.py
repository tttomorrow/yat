...
"""
Case Type   : MOT
Case Name   : MOT设置min_mot_local_memory=0MB进行SQL语句测试
Description :
    1、修改配置文件mot.conf中min_mot_local_memory=0MB
...
CONFIG_PARAM = 'min_mot_local_memory = 0MB'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0210开始执行======")
        LOG.info("======步骤1：修改配置文件，设置min_mot_local_memory=0MB启数据库======")
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0210执行结束======')
