...
"""
Case Type   : MOT
Case Name   : MOT设置max_mot_session_memory=-1MB进行SQL语句测试
Description :
    1、修改配置文件mot.conf中max_mot_session_memory=-1MB
...
CONFIG_PARAM = 'max_mot_session_memory = -1MB'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0216开始执行======")
        LOG.info("======步骤1：修改配置文件，设置max_mot_session_memory=-1MB启数据库======")
        ...
        self.assertIn(
            'Configuration of max_mot_session_memory=18014398509480960'
            ' is out of bounds [0, 536870912]', cmd_msg)
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0216执行结束======')
