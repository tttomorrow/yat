...
"""
Case Type   : MOT
Case Name   : MOT设置session_large_buffer_store_size=10%进行SQL语句测试
Description :
    1、修改配置文件mot.conf中session_large_buffer_store_size=10%
...
CONFIG_PARAM = 'session_large_buffer_store_size = 10%'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0273开始执行======")
        LOG.info("===步骤1：修改配置文件设置session_large_buffer_store_size=10%启动数据库==")
