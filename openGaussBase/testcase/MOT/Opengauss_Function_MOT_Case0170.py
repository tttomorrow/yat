...
"""
Case Type   : MOT
Case Name   : MOT设置affinity_mode= 进行SQL语句测试
Description :
    1、修改配置文件mot.conf中affinity_mode=
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0170开始执行======")
        LOG.info("步骤1：修改mot.conf配置文件，设置affinity_mode= ,重启数据库")
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0170执行结束======')
