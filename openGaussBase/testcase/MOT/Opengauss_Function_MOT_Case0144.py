...
"""
Case Type   : MOT
Case Name   : MOT设置print_full_stats_period=-1进行SQL语句测试
Description :
    1、修改配置文件mot.conf中print_full_stats_period=-1
...
CONFIG_PARAM = 'print_full_stats_period = -1'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0144开始执行======")
        LOG.info("==步骤1：修改mot.conf配置文件，设置print_full_stats_period=-1,重启数据库===")
        ...
        self.assertIn('Configuration of print_full_stats_period=18446744073709'
                      ' is out of bounds [1, 86400]', cat_msg)
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0144执行结束======')
