...
"""
Case Type   : MOT
Case Name   : MOT设置session_max_huge_object_size=0MB进行SQL语句测试
Description :
    1、修改配置文件mot.conf中session_max_huge_object_size=0MB
...
CONFIG_PARAM = 'session_max_huge_object_size = 0MB'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0233开始执行======")
        LOG.info("====步骤1：修改配置文件，设置session_max_huge_object_size=0MB启动数据库====")
        ...
        self.assertIn('Configuration of session_max_huge_object_size=0'
                      ' is out of bounds [8, 8192]', cmd_msg)
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0233执行结束======')
