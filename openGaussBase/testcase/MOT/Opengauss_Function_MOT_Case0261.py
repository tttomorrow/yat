...
"""
Case Type   : MOT
Case Name   : MOT设置enable_mot_codegen_print=true进行SQL语句测试
Description :
    1、修改配置文件mot.conf中enable_mot_codegen_print=true
...
CONFIG_PARAM = 'enable_mot_codegen_print = true'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0261开始执行======")
        LOG.info("=====步骤1：修改配置文件设置enable_mot_codegen_print=true启动数据库=====")
        ...
        LOG.info("======步骤3：查看pg_log日志，不存在参数无效信息======")
    ...
    def tearDown(self):
        ...
        LOG.info("======Opengauss_Function_MOT_Case0261执行结束======")
