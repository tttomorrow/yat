...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0227开始执行======")
        LOG.info("====步骤1：修改配置文件，"
        ...
        self.assertIn(
            'Configuration of'
            ' session_large_buffer_store_max_object_size=17592186044415'
            ' is out of bounds [0, 1024]', cmd_msg)
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0227执行结束======')
