...
Description :
    1、修改配置文件mot.conf中group_commit_size=2
...
CONFIG_PARAM = 'group_commit_size = 2'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_dump(self):
        LOG.info("======Opengauss_Function_MOT_Case0115开始执行======")
        LOG.info("======步骤1：修改mot.conf配置文件，设置group_commit_size=2,重启数据库======")
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0115执行结束======')
