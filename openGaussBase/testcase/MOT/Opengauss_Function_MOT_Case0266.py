...
"""
Case Type   : MOT
Case Name   : MOT设置mot_codegen_limit=-1进行SQL语句测试
Description :
    1、修改配置文件mot.conf中mot_codegen_limit=-1
...
CONFIG_PARAM = 'mot_codegen_limit = -1'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0266开始执行======")
        LOG.info("======步骤1：修改配置文件设置mot_codegen_limit=-1启动数据库======")
        ...
        self.assertIn('Configuration of mot_codegen_limit=4294967295'
                      ' is out of bounds [1, 1000]', cmd_msg)
    ...
    def tearDown(self):
        ...
        LOG.info("======Opengauss_Function_MOT_Case0266执行结束======")
