...
'''
Case Type： mot不支持DDL
Case Name： mot不支持的DDL，创建可延迟约束主键（DEFERRABLE)
'''
...
class Mot_DDL_test(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        # self.assertTrue(stopmsg)
        # self.assertTrue(startmsg)
        logger.info('---------------Opengauss_Function_MOT_Case0052执行结束---------------')
