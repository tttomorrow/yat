...
"""
Case Type   : MOT
Case Name   : MOT设置reclaim_batch_size=0进行SQL语句测试
Description :
    1、修改配置文件mot.conf中reclaim_batch_size=0
...
CONFIG_PARAM = 'reclaim_batch_size = 0'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0246开始执行======")
        LOG.info("======步骤1：修改配置文件设置reclaim_batch_size=0启动数据库======")
        ...
        self.assertIn('Configuration of reclaim_batch_size=0'
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0246执行结束======')
