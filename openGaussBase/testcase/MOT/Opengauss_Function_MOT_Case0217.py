...
"""
Case Type   : MOT
Case Name   : MOT设置max_mot_session_memory=10%进行SQL语句测试
Description :
    1、修改配置文件mot.conf中max_mot_session_memory=10%
...
CONFIG_PARAM = 'max_mot_session_memory = 10%'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0217开始执行======")
        LOG.info("======步骤1：修改配置文件，设置max_mot_session_memory=10%启数据库======")
        ...
        self.assertIn('Invalid max_mot_session_memory memory '
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0217执行结束======')
