...
"""
Case Type   : MOT
Case Name   : MOT设置enable_mot_codegen_print= 进行SQL语句测试
Description :
    1、修改配置文件mot.conf中enable_mot_codegen_print=
...
CONFIG_PARAM = 'enable_mot_codegen_print =  '
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0263开始执行======")
        LOG.info("======步骤1：修改配置文件设置enable_mot_codegen_print= 启动数据库======")
        ...
        self.assertIn('Empty value specified for configuration'
                      ' item enable_mot_codegen_print', cmd_msg)
    ...
    def tearDown(self):
        ...
        LOG.info("======Opengauss_Function_MOT_Case0263执行结束======")
