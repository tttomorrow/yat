...
class Mot_index_test(unittest.TestCase):
    ...
    def test_mot_none_index(self):
        logger.info("------------------Opengauss_Function_MOT_Case0070开始执行------------------")
        ...
        self.sql_cmd = f'''
                        ...
                        CREATE FOREIGN TABLE {self.schema}.mixindex1(t1 varchar(100) not null,t2 varchar(100) not null,t3 varchar(1) not null);
                        --总列宽216
                        CREATE INDEX index1 ON {self.schema}.mixindex1(t1,t2);
                        --对列t1,t3创建唯一索引
                        CREATE FOREIGN TABLE {self.schema}.mixindex2(t1 varchar(200) not null,t2 varchar(1) not null,t3 varchar(1) not null);
                        --总列宽209
    ...
    def tearDown(self):
        ...
        # self.assertTrue(stopmsg)
        # self.assertTrue(startmsg)
        logger.info('---------------Opengauss_Function_MOT_Case0070执行结束---------------')
