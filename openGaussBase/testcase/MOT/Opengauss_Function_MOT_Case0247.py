...
"""
Case Type   : MOT
Case Name   : MOT设置reclaim_batch_size=-1进行SQL语句测试
Description :
    1、修改配置文件mot.conf中reclaim_batch_size=-1
...
CONFIG_PARAM = 'reclaim_batch_size = -1'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0247开始执行======")
        LOG.info("======步骤1：修改配置文件设置reclaim_batch_size=-1启动数据库======")
        ...
        self.assertIn('Configuration of reclaim_batch_size=4294967295'
                      ' is out of bounds [128, 1048576]', cmd_msg)
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0247执行结束======')
