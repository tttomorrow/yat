...
"""
Case Type   : MOT
Case Name   : MOT设置chunk_prealloc_worker_count=2000进行SQL语句测试
Description :
    1、修改配置文件mot.conf中chunk_prealloc_worker_count=2000
...
CONFIG_PARAM = 'chunk_prealloc_worker_count = 2000'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0193开始执行======")
        LOG.info("===步骤1：修改配置文件，设置chunk_prealloc_worker_count=2000,重启数据库===")
        ...
        self.assertIn('Configuration of chunk_prealloc_worker_count=2000'
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0193执行结束======')
