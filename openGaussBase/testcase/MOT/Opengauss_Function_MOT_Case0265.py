...
"""
Case Type   : MOT
Case Name   : MOT设置mot_codegen_limit=0进行SQL语句测试
Description :
    1、修改配置文件mot.conf中mot_codegen_limit=0
...
CONFIG_PARAM = 'mot_codegen_limit = 0'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0265开始执行======")
        LOG.info("======步骤1：修改配置文件设置mot_codegen_limit=0启动数据库======")
        ...
        self.assertIn('Configuration of mot_codegen_limit=0'
    ...
    def tearDown(self):
        ...
        LOG.info("======Opengauss_Function_MOT_Case0265执行结束======")
