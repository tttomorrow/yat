...
"""
Case Type   : MOT
Case Name   : MOT设置min_mot_session_memory=xxx进行SQL语句测试
Description :
    1、修改配置文件mot.conf中min_mot_session_memory=xxx
...
CONFIG_PARAM = 'min_mot_session_memory = xxx'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0222开始执行======")
        LOG.info("======步骤1：修改配置文件，设置min_mot_session_memory=xxx启数据库======")
        ...
        self.assertIn('Invalid min_mot_session_memory memory'
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0222执行结束======')
