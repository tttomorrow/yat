...
"""
Case Type   : MOT
Case Name   : MOT设置reclaim_threshold=xxx进行SQL语句测试
Description :
    1、修改配置文件mot.conf中reclaim_threshold=xxx
...
CONFIG_PARAM = 'reclaim_threshold = xxx'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0243开始执行======")
        LOG.info("======步骤1：修改配置文件设置reclaim_threshold=xxx启动数据库======")
        ...
        self.assertIn('Invalid reclaim_threshold memory '
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0243执行结束======')
