...
"""
Case Type   : MOT
Case Name   : MOT设置reclaim_batch_size= 进行SQL语句测试
Description :
    1、修改配置文件mot.conf中reclaim_batch_size=
...
CONFIG_PARAM = 'reclaim_batch_size =  '
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0249开始执行======")
        ...
        self.assertIn('Empty value specified for configuration'
                      ' item reclaim_batch_size', cmd_msg)
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0249执行结束======')
