...
"""
Case Type   : MOT
Case Name   : MOT设置force_mot_pseudo_codegen=true进行SQL语句测试
Description :
    1、修改配置文件mot.conf中force_mot_pseudo_codegen=true
...
CONFIG_PARAM = 'force_mot_pseudo_codegen = true'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0258开始执行======")
        LOG.info("=====步骤1：修改配置文件设置force_mot_pseudo_codegen=true启动数据库=====")
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0258执行结束======')
