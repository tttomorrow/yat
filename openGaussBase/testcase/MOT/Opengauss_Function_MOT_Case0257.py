...
"""
Case Type   : MOT
Case Name   : MOT设置enable_mot_codegen= 进行SQL语句测试
Description :
    1、修改配置文件mot.conf中enable_mot_codegen=
...
CONFIG_PARAM = 'enable_mot_codegen =  '
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0257开始执行======")
        LOG.info("======步骤1：修改配置文件设置enable_mot_codegen= 启动数据库======")
        ...
        self.assertIn(
            'Empty value specified for configuration item'
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0257执行结束======')
