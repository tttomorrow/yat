...
"""
Case Type   : MOT
Case Name   : MOT设置checkpoint_segsize=-1进行SQL语句测试
Description :
    1、修改配置文件mot.conf中checkpoint_segsize=-1
...
CONFIG_PARAM = 'checkpoint_segsize = -1'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_dump(self):
        LOG.info("======Opengauss_Function_MOT_Case0125开始执行======")
        LOG.info("=====步骤1：修改mot.conf配置文件，设置checkpoint_segsize=-1,重启数据库=====")
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0125执行结束======')
