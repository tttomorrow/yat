...
"""
Case Type   : MOT
Case Name   : MOT设置session_large_buffer_store_size=1022KB进行SQL语句测试
Description :
    1、修改配置文件mot.conf中session_large_buffer_store_size=1022KB
...
CONFIG_PARAM = 'session_large_buffer_store_size = 1022KB'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0270开始执行======")
        LOG.info("=步骤1：修改配置文件设置session_large_buffer_store_size=1022KB启动数据库=")
    ...
    def tearDown(self):
        ...
        LOG.info("======Opengauss_Function_MOT_Case0270执行结束======")
