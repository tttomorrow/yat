...
"""
Case Type   : MOT
Case Name   : MOT设置enable_mot_codegen=false进行SQL语句测试
Description :
    1、修改配置文件mot.conf中enable_mot_codegen=false
...
CONFIG_PARAM = 'enable_mot_codegen = false'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0255开始执行======")
        LOG.info("======步骤1：修改配置文件设置enable_mot_codegen=false启动数据库======")
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0255执行结束======')
