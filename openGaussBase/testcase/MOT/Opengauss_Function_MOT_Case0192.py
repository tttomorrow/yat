...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0192开始执行======")
        LOG.info("步骤1：修改mot.conf配置文件，设置chunk_prealloc_worker_count=-1,重启数据库")
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0192执行结束======')
