...
"""
Case Type   : MOT
Case Name   : MOT设置checkpoint_workers=0进行SQL语句测试
Description :
    1、修改配置文件mot.conf中checkpoint_workers=0
...
CONFIG_PARAM = 'checkpoint_workers = 0'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0130开始执行======")
        LOG.info("======步骤1：修改mot.conf配置文件，设置checkpoint_workers=0,重启数据库=====")
        ...
        self.assertIn('Configuration of checkpoint_workers=0 '
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0130执行结束======')
