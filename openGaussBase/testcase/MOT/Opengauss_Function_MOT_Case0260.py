...
"""
Case Type   : MOT
Case Name   : MOT设置force_mot_pseudo_codegen= 进行SQL语句测试
Description :
    1、修改配置文件mot.conf中force_mot_pseudo_codegen=
...
CONFIG_PARAM = 'force_mot_pseudo_codegen =  '
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0260开始执行======")
        LOG.info("======步骤1：修改配置文件设置force_mot_pseudo_codegen= 启动数据库======")
        ...
        self.assertIn('Empty value specified for configuration'
                      ' item force_mot_pseudo_codegen', cmd_msg)
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0260执行结束======')
