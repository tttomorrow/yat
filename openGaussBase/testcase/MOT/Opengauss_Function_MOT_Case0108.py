...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_dump(self):
        LOG.info("======Opengauss_Function_MOT_Case0108开始执行======")
        ...
        LOG.info("======步骤2：gs_dump以自定义归档格式导出多个内存表======")
        ...
        LOG.info("======步骤3：gs_restore导入多个自定义归档格式内存表======")
        sql_cmd = f'''source {macro.DB_ENV_PATH};                    
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0108执行结束======')
