...
"""
Case Type   : MOT
Case Name   : MOT设置session_max_huge_object_size=xxx进行SQL语句测试
Description :
    1、修改配置文件mot.conf中session_max_huge_object_size=xxx
...
CONFIG_PARAM = 'session_max_huge_object_size = xxx'
...
class MotParamTest(unittest.TestCase):
    ...
    def test_mot_param(self):
        LOG.info("======Opengauss_Function_MOT_Case0235开始执行======")
        LOG.info("====步骤1：修改配置文件设置session_max_huge_object_size=xxx启动数据库====")
        ...
        self.assertIn('Invalid session_max_huge_object_size'
    ...
    def tearDown(self):
        ...
        LOG.info('======Opengauss_Function_MOT_Case0235执行结束======')
