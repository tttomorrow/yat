...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.com_pub = Common()
        self.subname1 = "sub_case163_1"
        self.pubname1 = "pub_case163_1"
        ...
        self.user_name1 = "u_case163_1"
        self.user_name2 = "u_case163_2"
    ...
    def test_pubsub(self):
        ...
        text = "--step3:发布端创建超级用户 expect:成功--"
        self.log.info(text)
        ...
        text = "--step4:创建订阅，订阅信息中发布用户为超级用户(订阅端执行，端口只能是DN端口+1) expect:成功--"
        self.log.info(text)
