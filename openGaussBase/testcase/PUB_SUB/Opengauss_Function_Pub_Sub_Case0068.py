...
"""
Case Type   : 基础功能
Case Name   : 发布端使用gs_basebackup备份后并恢复
Description :
    1.在两个集群创建表
    2.发布端打开增量备份开关
    3.发布端备份
...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info("-Opengauss_Function_Pub_Sub_Case0068 start-")
        ...
        self.com_pub = Common()
        self.tb_name1 = 'tb_pubsub_case068_1'
        self.tb_name2 = 'tb_pubsub_case068_2'
        self.tbs_name = 'tps_pubsub_case068'
        self.schema_name1 = 's_pubsub_case068_1'
        self.subname1 = "sub_case068_1"
        self.pubname1 = "pub_case068_1"
    ...
    def test_pubsub(self):
        ...
        result = self.commsh_pub.exec_gs_basebackup(
            self.backup_path, self.pri_userdb_pub.ssh_host,
            self.pri_userdb_pub.db_port,
            cmd=f'-T {self.tbs_path}={self.tbs_path}_new')
        self.assertTrue(result, '执行失败:' + text)
    ...
    def tearDown(self):
        ...
        self.assertIn(self.constant.drop_sub_succ_msg, drop_sub_result,
                      '执行失败' + text)
        self.log.info("-Opengauss_Function_Pub_Sub_Case0068 end-")
