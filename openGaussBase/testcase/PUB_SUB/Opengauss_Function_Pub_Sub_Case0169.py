...
"""
Case Type   : 基础功能
Case Name   : 发布用户无流复制权限
Description :
    1.两个集群创建用户,且该用户无流复制权限
    2.创建发布
...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.com_pub = Common()
        self.subname1 = "sub_case169_1"
        self.pubname1 = "pub_case169_1"
    ...
    def test_pubsub(self):
        ...
        text = "--step1:两个集群创建用户,且该用户无流复制权限 expect:成功--"
        self.log.info(text)
