...
Expect      :
    ...
    3.成功
    4.成功
    5.tb_pubsub_case003_1、tb_pubsub_case003_2更新，tb_pubsub_case003_3未更新
    6.创建时失败
History     :
"""
import unittest
...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.com_pub = Common()
        self.tb_name1 = 'tb_pubsub_case003_1'
        self.tb_name2 = 'tb_pubsub_case003_2'
        self.tb_name3 = 'tb_pubsub_case003_3'
        self.subname = "sub_case003"
        self.pubname = "pub_case003"
    ...
    def test_pubsub(self):
        ...
        text = '--step2:创建发布端并指定only，无* expect:成功--'
        self.log.info(text)        
        sql = f"CREATE PUBLICATION {self.pubname} FOR TABLE only " \
            f"{self.tb_name1}, only {self.tb_name2};"
        ...
        text = '--step5:查询是否同步 expect:tb_pubsub_case003_1、' \
               'tb_pubsub_case003_2更新，tb_pubsub_case003_3未更新--'
        self.log.info(text)
