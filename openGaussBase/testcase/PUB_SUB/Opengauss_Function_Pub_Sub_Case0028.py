...
"""
Case Type   : 基础功能
Case Name   : 创建发布，仅发布insert,delete操作
Description :
    1.在两个集群创建表
    2.创建发布端
    3.创建订阅
...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.com_pub = Common()
        self.tb_name1 = 'tb_pubsub_case028_1'
        self.tb_name2 = 'tb_pubsub_case028_2'
        self.subname = "sub_case028"
        self.pubname = "pub_case028"
    ...
    def test_pubsub(self):
        ...
        self.assertEqual(result.count(self.constant.UPDATE_SUCCESS_MSG),
                         2, '执行失败' + text)
        self.assertEqual(result.count('1 | update'), 2, '执行失败' + text)
