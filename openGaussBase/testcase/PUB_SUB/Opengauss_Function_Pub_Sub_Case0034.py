...
"""
Case Type   : 基础功能
Case Name   : 同一数据库创建多个发布内容不全相同且publish相同的订阅发布
Description :
    1.在两个集群创建表
...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.com_pub = Common()
        self.tb_name1 = 'tb_pubsub_case034_1'
        self.tb_name2 = 'tb_pubsub_case034_2'
        self.schema_name1 = 's_pubsub_case034_1'
        self.schema_name2 = 's_pubsub_case034_2'
        self.tbs_name = 'tbs_pubsub_case034'
        self.subname1 = "sub_case034_1"
        self.subname2 = "sub_case034_2"
        self.pubname1 = "pub_case034_1"
        self.pubname2 = "pub_case034_2"
    ...
    def test_pubsub(self):
        ...
        sql = f"create schema {self.schema_name1};" \
            ...
            f"values (1, 's_pubsub_case034_2', '%一', '[]');" \
        ...
        self.assertIn('1 | s_pubsub_case034_2 | update123 | []',
                      result, '执行失败' + text)
