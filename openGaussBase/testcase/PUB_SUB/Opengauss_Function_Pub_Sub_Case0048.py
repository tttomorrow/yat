...
"""
Case Type   : 基础功能
Case Name   : max_replication_slots小于物理+逻辑(激活的发布)
Description :
...
Expect      :
    ...
    5.成功
    6.成功
    7.tb_pubsub_case048_1/tb_pubsub_case048_2更新，其余未更新
History     :
"""
import unittest
import os
...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info("-Opengauss_Function_Pub_Sub_Case0048 start-")
        ...
        self.com = Common()
        self.tb_name = ['tb_pubsub_case048_1', 'tb_pubsub_case048_2',
                        'tb_pubsub_case048_3']
        self.subname = ["sub_case048_1", "sub_case048_2", "sub_case048_3"]
        self.pubname = ["pub_case048_1", "pub_case048_2", "pub_case048_3"]
        self.slot_name = "slot_case048"
    ...
    def test_pubsub(self):
        ...
        self.log.info(text)
        for i in range(3):
            sql_table = f"CREATE TABLE {self.tb_name[i]}(id NUMBER(7) " \
        ...
        text = '--step4:创建发布端订阅端（假设集群为1主2备，则需再逻辑复制槽3个） expect:sub3失败，其余成功--'
        self.log.info(text)
        for i in range(3):
        ...
        for i in range(3):
            ...
            if i < 2:
                ...
                self.assertIn('FATAL:  all replication slots are in use',
                              result, '执行失败:' + text)
        ...
        text = "--step6:读取复制槽slot1解码结果  " \
               "expect:成功,tb_pubsub_case048_1/tb_pubsub_case048_2存在于解码记录中--"
        self.log.info(text)
        ...
        text = '--step7:查看数据是否更新 ' \
               'expect:tb_pubsub_case048_1/tb_pubsub_case048_2更新，其余未更新--'
        self.log.info(text)
        for i in range(3):
    ...
    def tearDown(self):
        ...
        self.assertIn(self.constant.drop_sub_succ_msg, drop_sub_result,
                      '执行失败' + text)
        self.log.info("-Opengauss_Function_Pub_Sub_Case0048 end-")
