...
"""
Case Type   : 基础功能
Case Name   : 发布内容为二级分区（hash-range）
Description :
    1.在两个集群创建表
    2.创建发布端
    3.创建订阅
...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.com_pub = Common()
        self.tb_name1 = 'tb_pubsub_case141_1'
        self.subname1 = "sub_case141_1"
        self.pubname1 = "pub_case141_1"
    ...
    def test_pubsub(self):
        ...
        create_sql = f"CREATE TABLE {self.tb_name1}(" \
            ...
            f"    sales_amt  int)PARTITION BY hash (month_code)" \
            f" SUBPARTITION BY range (dept_code)(  PARTITION p_201901  (" \
            f"    SUBPARTITION p_201901_a VALUES LESS THAN ( '2' )," \
            f"    SUBPARTITION p_201901_b VALUES LESS THAN ( '3' )  )," \
            f"  PARTITION p_201902  (" \
            f"    SUBPARTITION p_201902_a VALUES LESS THAN ( '2' )," \
            f"   SUBPARTITION p_201902_b VALUES LESS THAN ( '3' )  ));"
        ...
        sql = f"insert into {self.tb_name1} values('201901', '1', '1', 1);" \
            f"insert into {self.tb_name1} values('201901', '2', '1', 1);" \
