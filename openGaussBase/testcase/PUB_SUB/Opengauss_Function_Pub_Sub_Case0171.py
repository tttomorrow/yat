...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.tb_name1 = 'tb_pubsub_case171_1'
        self.tb_name2 = 'tb_pubsub_case171_2'
        self.subname = "sub_case171"
        self.pubname = "pub_case171"
    ...
    def test_pubsub(self):
        ...
        text = '--step3:创建订阅指定二进制传输模式 expect:成功--'
        self.log.info(text)
        ...
        text = '--step5:查询是否同步 expect:仅更新tb_pubsub_case171_1'
        self.log.info(text)
