...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.replication_type = self.com_sub.show_param(
            "replication_type", macro.DB_ENV_PATH_REMOTE1)
        self.hot_standby = self.com_sub.show_param(
            "hot_standby", macro.DB_ENV_PATH_REMOTE1)
        self.recovery_redo_workers = self.com_sub.show_param(
            "recovery_redo_workers", macro.DB_ENV_PATH_REMOTE1)
        self.recovery_parse_workers = self.com_sub.show_param(
    ...
    def test_pubsub(self):
        ...
        text = '--step1:订阅端开启极致RTO expect:成功--'
        self.log.info(text)
