...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.com_pub = Common()
        self.tb_name1 = 'tb_pubsub_case142_1'
        self.subname1 = "sub_case142_1"
        self.pubname1 = "pub_case142_1"
    ...
    def test_pubsub(self):
        ...
        create_sql = f"CREATE TABLE {self.tb_name1}(" \
            ...
            f"    SUBPARTITION p_201901_b VALUES ( default )  )," \
        ...
        sql = f"insert into {self.tb_name1} values('201902', '1', '1', 1);" \
            f"insert into {self.tb_name1} values('201903', '1', '1', 1);" \
        ...
        self.log.info(text)
        sql = f"update {self.tb_name1} set dept_code='2';"
        result = self.commsh_pub.execut_db_sql(sql,
                                               sql_type=self.user_param_pub)
        self.log.info(result)
