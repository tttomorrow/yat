...
"""
Case Type   : 基础功能
Case Name   : 发布指定表存在关联表，创建发布订阅后，修改发布端&订阅端表结构
Description :
    1.在两个集群创建表
    2.创建发布端
    3.创建订阅
...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.com_pub = Common()
        self.tb_name1 = 'tb_pubsub_case022_1'
        self.tb_name2 = 'tb_pubsub_case022_2'
        self.subname = "sub_case022"
        self.pubname = "pub_case022"
