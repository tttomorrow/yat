...
Expect      :
    ...
    3.成功
    4.成功
    5.tb_pubsub_case011_3/4更新，其余表格不更新，视图可正常查询，
...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.tb_name = []
        for i in range(5):
            self.tb_name.append(f'tb_pubsub_case011_{i}')
        self.mv_name1 = 'mv_pubsub_case011_1'
        self.mv_name2 = 'mv_pubsub_case011_2'
        self.subname = "sub_case011"
        self.pubname = "pub_case011"
    ...
    def test_pubsub(self):
        ...
        sql_create = f"create UNLOGGED table {self.tb_name[0]}" \
            ...
            f"(i int primary key, id int, t text);" \
        ...
        text = '--step5:查询是否同步 ' \
               'expect:tb_pubsub_case011_3/4更新，' \
