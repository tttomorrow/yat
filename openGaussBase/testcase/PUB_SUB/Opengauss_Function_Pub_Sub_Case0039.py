...
Expect      :
    ...
    4.成功
    5.数据均更新
    6.失败，DETAIL:  Tables cannot be added to or
...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.com_pub = Common()
        self.tb_name1 = 'tb_pubsub_case039_1'
        self.tb_name2 = 'tb_pubsub_case039_2'
        self.tb_name3 = 'tb_pubsub_case039_3'
        self.subname1 = "sub_case039_1"
        self.pubname1 = "pub_case039_1"
