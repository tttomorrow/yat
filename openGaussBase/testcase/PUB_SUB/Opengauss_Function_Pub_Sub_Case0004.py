...
Expect      :
    ...
    3.成功
    4.成功
    5.tb_pubsub_case004_1、tb_pubsub_case004_2未更新
    6.创建时失败
History     :
"""
import unittest
...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.com_pub = Common()
        self.tb_name1 = 'tb_pubsub_case004_1'
        self.tb_name2 = 'tb_pubsub_case004_2'
        self.subname = "sub_case004"
        self.pubname = "pub_case004"
    ...
    def test_pubsub(self):
        ...
        sql = f"CREATE PUBLICATION {self.pubname} " \
            f"FOR TABLE only {self.tb_name1}"
        ...
        text = '--step5:查询是否同步 expect:tb_pubsub_case004_1、' \
               'tb_pubsub_case004_2未更新--'
        self.log.info(text)
        ...
        text = '--step6:创建发布并指定only，有* expect:失败--'
        self.log.info(text)
