...
"""
Case Type   : 基础功能
Case Name   : 发布内容为二级分区（range-hash）
Description :
    1.在两个集群创建表
    2.创建发布端
    3.创建订阅
...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.tb_name1 = 'tb_pubsub_case137_1'
        self.subname1 = "sub_case137_1"
        self.pubname1 = "pub_case137_1"
        ...
        self.wal_level_sub = self.com_sub.show_param(
    ...
    def test_pubsub(self):
        ...
        sql = f"insert into {self.tb_name1} values('201902', '1', '1', 1);" \
            f"insert into {self.tb_name1} values('201902', '9', '1', 1);"
        result = self.commsh_pub.execut_db_sql(sql,
                                               sql_type=self.user_param_pub)
        self.log.info(result)
        ...
        sql = f"update {self.tb_name1} set " \
            f"month_code='201903' where month_code='201902';"
        result = self.commsh_pub.execut_db_sql(sql,
                                               sql_type=self.user_param_pub)
        self.log.info(result)
