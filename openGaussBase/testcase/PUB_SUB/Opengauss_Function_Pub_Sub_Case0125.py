...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.com_pub = Common()
        self.tb_name1 = 'tb_pubsub_case125_1'
        self.subname = "sub_case125"
        self.pubname = "pub_case125"
    ...
    def test_pubsub(self):
        ...
        self.log.info(text)
        sql = f"insert into {self.tb_name1} values(1),(3),(1),(1);"
        result = self.commsh_pub.execut_db_sql(sql,
                                               self.user_param_pub)
        self.log.info(result)
        ...
        sql = f"alter table {self.tb_name1} REPLICA IDENTITY full;" \
            f"select pg_sleep(1);" \
            f"delete from {self.tb_name1} where i=1;" \
            f"update {self.tb_name1} set i=999 where i=3;"
        result = self.commsh_pub.execut_db_sql(sql,
