...
class Pubsubclass(unittest.TestCase):
    def setUp(self):
        ...
        self.com_pub = Common()
        self.tb_name1 = 'tb_pubsub_case027_1'
        self.tb_name2 = 'tb_pubsub_case027_2'
        self.subname = "sub_case027"
        self.pubname = "pub_case027"
    ...
    def test_pubsub(self):
        ...
        text = "--step7:查询是否同步 expect:数据未同步--"
        self.log.info(text)
        result = self.commsh_sub.execut_db_sql(sql_select,
                                               self.user_param_sub,
                                               None,
    ...
    def tearDown(self):
        ...
        sql = f"DROP table if exists {self.tb_name2},{self.tb_name1};"
        result = self.commsh_sub.execut_db_sql(sql, self.user_param_sub, None,
                                               macro.DB_ENV_PATH_REMOTE1)
        self.log.info(result)
        result = self.commsh_pub.execut_db_sql(sql, 
