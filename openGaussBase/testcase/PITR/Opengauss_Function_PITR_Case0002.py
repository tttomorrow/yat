...
"""
Case Type   : 基础功能
Case Name   : 使用归档文件恢复到recovery_target_name节点
Description :
    1.主节点开启归档
    2.创建表
    3.备份
...
class Pitrclass(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info("--------Opengauss_Function_PITR_Case0002 start-------")
    ...
    def test_backup0026(self):
        ...
        text = '----step6: 恢复数据到point1时刻 expect:成功----'
        self.log.info(text)
    ...
    def tearDown(self):
        ...
        result = self.primary_user_node.sh(cmd).result()
        self.log.info(result)
        self.log.info("-Opengauss_Function_PITR_Case0002 end-")
