...
"""
Case Type   : GUC
Case Name   : 使用gs_guc reload方法设置参数deadlock_timeout为5 ,观察预期结果
Description :
...
class ClientConnection(unittest.TestCase):
    def setUp(self):
        LOG.info(
            '----Opengauss_Function_Guc_ClientConnection_Case0169start----')
    ...
    def tearDown(self):
        ...
        LOG.info(sql_cmd)
        LOG.info(
            '---Opengauss_Function_Guc_ClientConnection_Case0169执行完成----')
