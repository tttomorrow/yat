...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数max_locks_per_transaction为10 ,
             观察预期结果
Description :
...
class ClientConnection(unittest.TestCase):
    def setUp(self):
        LOG.info(
            '-----Opengauss_Function_Guc_ClientConnection_Case0186start----')
    ...
    def tearDown(self):
        ...
        LOG.info(sql_cmd)
        LOG.info(
            '---Opengauss_Function_Guc_ClientConnection_Case0186执行完成---')
