...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数check_function_bodies为无效值,合理报错
Description :
...
class ClientConnection(unittest.TestCase):
    def setUp(self):
        LOG.info(
            '----Opengauss_Function_Guc_ClientConnection_Case0053start-----')
    ...
    def tearDown(self):
        ...
        LOG.info(sql_cmd)
        LOG.info(
            '--Opengauss_Function_Guc_ClientConnection_Case0053执行完成----')
