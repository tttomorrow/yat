...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数default_transaction_deferrable为无效值,
              合理报错
Description :
...
class ClientConnection(unittest.TestCase):
    def setUp(self):
        LOG.info(
            '----Opengauss_Function_Guc_ClientConnection_Case0074start--')
    ...
    def tearDown(self):
        ...
        LOG.info(sql_cmd)
        LOG.info(
            '----Opengauss_Function_Guc_ClientConnection_Case0074执行完成---')
