...
"""
Case Type   : GUC
Case Name   : 使用gs_guc reload方法设置参数default_text_search_config为pg_catalog.simple ,观察预期结果
Description :
...
class ClientConnection(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info(
            '--Opengauss_Function_Guc_ClientConnection_Case0158start-----')
    ...
    def test_default_text_search_config(self):
        ...
        self.log.info('--步骤2:设置参数值为pg_catalog.simple--')
    ...
    def tearDown(self):
        ...
        if self.res not in sql_cmd:
            ...
            self.log.info(msg)
        self.log.info(
            '---Opengauss_Function_Guc_ClientConnection_Case0158执行完成-----')
