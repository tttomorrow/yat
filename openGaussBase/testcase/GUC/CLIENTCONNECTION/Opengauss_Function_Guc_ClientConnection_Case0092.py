...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数vacuum_freeze_table_age为10000 ,
              观察预期结果
Description :
...
class ClientConnection(unittest.TestCase):
    def setUp(self):
        LOG.info(
            '--Opengauss_Function_Guc_ClientConnection_Case0092start-----')
    ...
    def tearDown(self):
        ...
        LOG.info(sql_cmd)
        LOG.info(
            '---Opengauss_Function_Guc_ClientConnection_Case0092执行完成---')
