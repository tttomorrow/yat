...
"""
Case Type   : GUC
Case Name   : 使用gs_guc reload方法设置参数partition_lock_upgrade_timeout为
              3000 ,观察预期结果
Description :
...
class ClientConnection(unittest.TestCase):
    def setUp(self):
        LOG.info(
            '----Opengauss_Function_Guc_ClientConnection_Case0195start----')
    ...
    def tearDown(self):
        ...
        LOG.info(sql_cmd)
        LOG.info(
            '--Opengauss_Function_Guc_ClientConnection_Case0195执行完成---')
