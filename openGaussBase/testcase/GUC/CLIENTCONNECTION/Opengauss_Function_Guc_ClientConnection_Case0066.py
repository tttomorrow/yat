...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数default_transaction_read_only为
              无效值,合理报错
Description :
...
class ClientConnection(unittest.TestCase):
    def setUp(self):
        LOG.info(
            '---Opengauss_Function_Guc_ClientConnection_Case0066start----')
    ...
    def tearDown(self):
        ...
        LOG.info(sql_cmd)
        LOG.info(
            '--Opengauss_Function_Guc_ClientConnection_Case0066执行完成-')
