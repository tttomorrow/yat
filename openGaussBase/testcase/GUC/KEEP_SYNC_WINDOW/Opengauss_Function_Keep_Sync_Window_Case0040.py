...
class GucParameters(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info('-Opengauss_Function_Keep_Sync_Window_Case0040 start-')
        ...
        self.tb_name = "tb_keep_sync_window_0040"
    ...
    def test_keep_sync_window(self):
        ...
        text = '--step9:同步时间窗口内kill -18主机;expect:不会进入最大可用' \
               '模式，主节点事务自动提交成功--'
        self.log.info(text)
    ...
    def tearDown(self):
        ...
        self.log.info('-Opengauss_Function_Keep_Sync_Window_Case0040 finish-')
