...
Case Name   : 1主2备环境下，1主1同步1异步，wal_sender_timeout小于
              keep_sync_window值，时间窗内，同步备kill -19
Description :
        1.设置以下guc参数
...
class GucParameters(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info('-Opengauss_Function_Keep_Sync_Window_Case0022 start-')
        ...
        self.tb_name = "tb_keep_sync_window_0022"
    ...
    def test_keep_sync_window(self):
        ...
        self.log.info('获取step6插入前以及插入成功后阻塞时间,阻塞时间近似于'
                      'keep_sync_window+wal_swnder_tineout值，即4min')
        ...
        self.assertGreaterEqual(f'{num}', '03:30', '执行失败:' + text)
    ...
    def tearDown(self):
        ...
        self.log.info('-Opengauss_Function_Keep_Sync_Window_Case0022 finish-')
