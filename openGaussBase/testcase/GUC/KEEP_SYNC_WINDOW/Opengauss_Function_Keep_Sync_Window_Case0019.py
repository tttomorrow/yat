...
Case Name   : 1主2备环境下，1主1同步1异步，同步备为备2节点，同步备异常，
              测试时间窗是否生效
Description :
        1.设置以下guc参数
...
class GucParameters(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info('-Opengauss_Function_Keep_Sync_Window_Case0019 start-')
        ...
        self.tb_name = "tb_keep_sync_window_0019"
    ...
    def tearDown(self):
        ...
        self.log.info('-Opengauss_Function_Keep_Sync_Window_Case0019 finish-')
