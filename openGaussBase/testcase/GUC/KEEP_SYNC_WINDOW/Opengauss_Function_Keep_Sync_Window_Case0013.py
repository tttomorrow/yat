...
Case Name   : 1主2备环境下，1主1同步1异步，异步备异常，测试时间窗是否生效
Description :
        1.设置以下四个guc参数
...
class GucParameters(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info('-Opengauss_Function_Keep_Sync_Window_Case0013 start-')
        ...
        self.tb_name = "tb_keep_sync_window_0013"
    ...
    def test_keep_sync_window(self):
        ...
        text = '--step6:gs_ctl方式启动备2节点;expect:启动成功--'
        self.log.info(text)
    ...
    def tearDown(self):
        ...
        self.log.info('-Opengauss_Function_Keep_Sync_Window_Case0013 finish-')
