...
"""
Case Type   : GUC
Case Name   : 1主2备 主机不开启归档，1同步+1异步备机开启归档模式 期望：1主2备按照archive_timeout归档成功
Description :
    1.主备查询参数默认值
...
class Guctestcase(unittest.TestCase):
    def setUp(self):
        LOGGER.info("==Opengauss_Function_Guc_WAL_Case0093 start==")
    ...
    def tearDown(self):
        ...
        status = COMMONSH.get_db_cluster_status("detail")
        self.assertTrue("Normal" in status or "Degraded" in status)
        LOGGER.info("==Opengauss_Function_Guc_WAL_Case0093 finish==")
