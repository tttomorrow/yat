...
class Guctestcase(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info(
            "----Opengauss_Function_Guc_Archive_Command_Case0007_开始----")
    ...
    def test_guc(self):
        ...
        echo_cmd = f'echo \'cd --remove-destination $1 ' \
            f'{self.archive_path}/$2\'>{self.script_path}'
