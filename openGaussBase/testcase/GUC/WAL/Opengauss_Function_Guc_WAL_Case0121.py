...
"""
Case Type   : GUC
Case Name   : 1+2failover后，新主机开启归档模式，设置2同步备机归档 期望：2备机归档成功
Description :
    1.1主2备创建xlog归档地址
    rm -rf /home/$user/xlog
    mkdir /home/$user/xlog
    2.备1上执行failover 进行主备切换
...
class Guctestcase(unittest.TestCase):
    def setUp(self):
        LOGGER.info("==Opengauss_Function_Guc_WAL_Case0121 start==")
        ...
        self.test_com_list = [COMMONSH, self.s_com1]
    ...
    def tearDown(self):
        ...
        status = COMMONSH.get_db_cluster_status("detail")
        self.assertTrue("Normal" in status or "Degraded" in status)
        LOGGER.info("==Opengauss_Function_Guc_WAL_Case0121 finish==")
