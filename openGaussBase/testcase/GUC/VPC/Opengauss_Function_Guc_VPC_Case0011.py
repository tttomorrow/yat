...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数transform_null_equals为无效值,合理报错
Description :
...
class ClientConnection(unittest.TestCase):
    def setUp(self):
        LOG.info(
            '-----Opengauss_Function_Guc_VPC_Case0011start-----')
    ...
    def tearDown(self):
        ...
        LOG.info(
            '-----Opengauss_Function_Guc_VPC_Case0011finish----')
