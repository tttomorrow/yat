...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数backslash_quote为无效值,合理报错
Description :
        1.查询backslash_quote默认值
        2.修改参数值为test
        3.修改参数值为123546
        4.修改参数值为空串
        5.修改参数值为null
...
class ClientConnection(unittest.TestCase):
    def setUp(self):
        LOG.info(
            '---Opengauss_Function_Guc_VPC_Case0004start---')
    ...
    def tearDown(self):
        ...
        LOG.info(
            '---Opengauss_Function_Guc_VPC_Case0004finish---')
