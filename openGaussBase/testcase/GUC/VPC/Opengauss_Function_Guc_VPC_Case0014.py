...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数support_extended_features为无效值,
              合理报错
Description :
...
class ClientConnection(unittest.TestCase):
    def setUp(self):
        LOG.info(
            '-----Opengauss_Function_Guc_VPC_Case0014start-----')
    ...
    def tearDown(self):
        ...
        LOG.info(
            '-----Opengauss_Function_Guc_VPC_Case0014finish----')
