...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数standard_conforming_strings为无效值,
              合理报错
Description :
...
class ClientConnection(unittest.TestCase):
    def setUp(self):
        LOG.info(
            '-----Opengauss_Function_Guc_VPC_Case0017start-----')
    ...
    def test_standard_conforming_strings(self):
        ...
        for i in invalid_value:
            result = commonsh.execute_gsguc('set',
                                            ...
                                            f"standard_conforming_strings={i}")
    ...
    def tearDown(self):
        ...
        LOG.info(
            '-----Opengauss_Function_Guc_VPC_Case0017finish----')
