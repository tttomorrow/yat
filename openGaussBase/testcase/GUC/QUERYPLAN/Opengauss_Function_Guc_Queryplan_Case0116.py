...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数log_executor_stats为无效值,合理报错
Description :
...
class QueryPlan(unittest.TestCase):
    ...
    def setUp(self):
        ...
        LOG.info(
            '-------Opengauss_Function_Guc_Queryplan_Case0116start------')
    ...
    def tearDown(self):
        ...
        LOG.info(sql_cmd)
        LOG.info(
            '-----Opengauss_Function_Guc_Queryplan_Case0116执行完成-------')
