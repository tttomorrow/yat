...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数cost_param为1,观察预期结果
Description :
        1.查询cost_param默认值
        2.修改参数值为1并重启数据库
        3.恢复参数默认值
...
class DeveloperOptions(unittest.TestCase):
    def setUp(self):
        LOG.info(
            '-----Opengauss_Function_DeveloperOptions_Case0044start-------')
    ...
    def tearDown(self):
        ...
        LOG.info(sql_cmd)
        LOG.info(
            '-----Opengauss_Function_DeveloperOptions_Case0044finish---')
