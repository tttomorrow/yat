...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数convert_string_to_digit为无效值,合理报错
Description :
...
class DeveloperOption(unittest.TestCase):
    def setUp(self):
        LOG.info(
            '----Opengauss_Function_DeveloperOptions_Case0047start-----')
    ...
    def test_convert_string_to_digit(self):
        ...
        for i in invalid_value:
            msg = commonsh.execute_gsguc('set',
                                         ...
                                         f'show convert_string_to_digit = {i}')
    ...
    def tearDown(self):
        ...
        LOG.info(sql_cmd)
        LOG.info(
            '------Opengauss_Function_DeveloperOptions_Case0047执行完成-----')
