...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数allow_system_table_mods为无效值,
              合理报错
Description :
...
class DeveloperOptions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        LOG.info(
            '-----Opengauss_Function_DeveloperOptions_Case0008start-----')
    ...
    def tearDown(self):
        ...
        LOG.info(sql_cmd)
        LOG.info(
            '-----Opengauss_Function_DeveloperOptions_Case0008执行完成-----')
