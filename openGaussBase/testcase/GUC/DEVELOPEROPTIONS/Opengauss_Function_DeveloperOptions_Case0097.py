...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数enable_thread_pool为on,观察预期结果
Description :
...
class DeveloperOptions(unittest.TestCase):
    def setUp(self):
        LOG.info(
            '-----Opengauss_Function_DeveloperOptions_Case0097start-----')
    ...
    def tearDown(self):
        ...
        LOG.info(sql_cmd)
        LOG.info(
            '----Opengauss_Function_DeveloperOptions_Case0097finish------')
