...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数max_user_defined_exception为1000,
              观察预期结果
Description :
...
class DeveloperOptions(unittest.TestCase):
    def setUp(self):
        LOG.info(
            '-----Opengauss_Function_DeveloperOptions_Case0053start-----')
    ...
    def tearDown(self):
        ...
        LOG.info(sql_cmd)
        LOG.info(
            '-----Opengauss_Function_DeveloperOptions_Case0053finish------')
