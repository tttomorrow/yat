...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数enable_debug_vacuum为无效值,合理报错
Description :
...
class DeveloperOption(unittest.TestCase):
    def setUp(self):
        LOG.info(
            '---Opengauss_Function_DeveloperOptions_Case0056start----')
    ...
    def tearDown(self):
        ...
        LOG.info(sql_cmd)
        LOG.info(
            '------Opengauss_Function_DeveloperOptions_Case0056执行完成---')
