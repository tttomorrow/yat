...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数ignore_checksum_failure为无效值,
              合理报错
Description :
...
class DeveloperOptions(unittest.TestCase):
    ...
    def setUp(self):
        LOG.info(
            '----Opengauss_Function_DeveloperOptions_Case0013start------')
    ...
    def tearDown(self):
        ...
        LOG.info(sql_cmd)
        LOG.info(
            '-----Opengauss_Function_DeveloperOptions_Case0013执行完成----')
