...
Case Name   : 参数log_file_mode的值设置为0000
Description :
    1.参数log_file_mode的值设置为0000,查看修改后的值：show log_file_mode;
Expect      :
    1.返回默认值0000
History     :
"""
...
class Errorlog(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('--Opengauss_Function_Guc_ErrorLog_Case0019 start--')
    ...
    def test_errorlog(self):
        ...
        excute_cmd1 = f'source {self.DB_ENV_PATH};' \
                      f'gs_guc reload -N all -I all -c "log_file_mode=0000"'
        ...
        msg0 = self.sh_primy.execut_db_sql(sql_cmd0)
        self.logger.info(msg0)
        self.common.equal_sql_mdg(msg0, 'log_file_mode', '0000', '(1 row)',
                                flag='1')
        msg1 = self.userNode.sh(excute_cmd1).result()
        self.logger.info(msg1)
    ...
    def tearDown(self):
        ...
        msg1 = self.userNode.sh(excute_cmd1).result()
        self.logger.info(msg1)
        self.logger.info('--Opengauss_Function_Guc_ErrorLog_Case0019 finish--')
