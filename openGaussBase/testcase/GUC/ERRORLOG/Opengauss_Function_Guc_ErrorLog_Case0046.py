...
Case Name   : 设置参数syslog_facility值为local5
Description :
    1.设置参数syslog_facility值为local1：gs_guc reload -N all -I all -c
    "syslog_facility=local5"
    2.修改系统配置文件，/etc/rsyslog.conf文件：local1.* /var/log/postgresql5,
...
class Errorlog(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('--Opengauss_Function_Guc_ErrorLog_Case0046 start--')
    ...
    def test_errorlog(self):
        ...
        self.logger.info('-----设置参数l设置参数syslog_facility值为local5----')
    ...
    def tearDown(self):
        ...
        self.logger.info('--Opengauss_Function_Guc_ErrorLog_Case0046 finish--')
