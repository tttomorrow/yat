...
class ErrorLog(unittest.TestCase):
    def setUp(self):
        ...
        self.match_msg1 = 'checkpoint starting: immediate force wait time'
    ...
    def test_main(self):
        ...
        step_txt = '----step1:查询log_checkpoints参数默认值 expect:为off----'
        self.log.info(step_txt)
        ...
        step_txt = '----step3: 查看pg日志 expect:不打印检查点和重启点的统计----'
