...
Case Name   : 参数log_file_mode的值设置为7
Description :
...
class Errorlog(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('--Opengauss_Function_Guc_ErrorLog_Case0021 start--')
    ...
    def test_errorlog(self):
        ...
        excute_cmd1 = f'source {self.DB_ENV_PATH};' \
                      f'gs_guc reload -N all -I all -c "log_file_mode=7"'
        self.logger.info(excute_cmd1)
        msg1 = self.userNode.sh(excute_cmd1).result()
        self.logger.info(msg1)
        self.logger.info('--------------查看 log_file_mode修改后的值----------')
        sql_cmd2 = 'show log_file_mode;'
        msg2 = self.sh_primy.execut_db_sql(sql_cmd2)
        self.logger.info(msg2)
        self.common.equal_sql_mdg(msg2, 'log_file_mode', '0007', '(1 row)',
                                flag='1')
    ...
    def tearDown(self):
        ...
        msg2 = self.sh_primy.execut_db_sql(sql_cmd2)
        self.logger.info(msg2)
        self.common.equal_sql_mdg(msg2, 'log_file_mode', '0600', '(1 row)',
                                flag='1')
        self.logger.info('--Opengauss_Function_Guc_ErrorLog_Case0021 finish--')
