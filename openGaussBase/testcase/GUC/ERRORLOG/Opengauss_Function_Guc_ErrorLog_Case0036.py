...
Description :
    1.设置参数log_rotation_size值为0：gs_guc reload -N all -I all -c
    "log_rotation_size=0"
...
class Security(unittest.TestCase):
    def setUp(self):
        Logger.info('----Opengauss_Function_Guc_ErrorLog_Case0036 start----')
    ...
    def test_errorlog(self):
        ...
        self.common.equal_sql_mdg(sql_msg0, 'log_statement', 'mod',
                                  '(1 row)', flag='1')
        Logger.info('-------修改log_rotation_size的值为0------')
    ...
    def tearDown(self):
        ...
        Logger.info('--Opengauss_Function_Guc_ErrorLog_Case0036 finish--')
