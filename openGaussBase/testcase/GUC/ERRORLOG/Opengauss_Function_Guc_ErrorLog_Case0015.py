...
Case Name   : 设置参数log_filename的值为postgresql-%Y-%m-%d.log格式
Description :
    1.gs_guc reload -N all -I all -c  "log_filename='postgresql-%Y-%m-%d.log'"
...
class Errorlog(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('==Opengauss_Function_Guc_ErrorLog_Case0015 start==')
    ...
    def test_errorlog(self):
        ...
        msg4_list = msg4.split('_')
        self.assertFalse(len(msg4_list) == 2)
    ...
    def tearDown(self):
        ...
        sql_cmd2 = 'show log_filename;'
        msg2 = self.sh_primy.execut_db_sql(sql_cmd2)
        self.logger.info(msg2)
        msg2_list = msg2.splitlines()[-2].split("_")
        self.logger.info(msg2_list)
        self.assertTrue(len(msg2_list) == 2)
        ...
        self.logger.info('--Opengauss_Function_Guc_ErrorLog_Case0015 finish--')
