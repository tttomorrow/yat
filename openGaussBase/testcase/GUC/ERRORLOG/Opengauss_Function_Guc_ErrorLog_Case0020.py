...
Case Name   : 参数log_file_mode的值设置为0777
Description :
...
class Errorlog(unittest.TestCase):
    def setUp(self):
        self.logger = Logger()
        self.logger.info('--Opengauss_Function_Guc_ErrorLog_Case0020 start--')
    ...
    def test_errorlog(self):
        ...
        excute_cmd1 = f'source {self.DB_ENV_PATH};' \
                      f'gs_guc reload -N all -I all -c "log_file_mode=0777"'
    ...
    def tearDown(self):
        ...
        msg1 = self.userNode.sh(excute_cmd1).result()
        self.logger.info(msg1)
        self.logger.info('--Opengauss_Function_Guc_ErrorLog_Case0020 finish--')
