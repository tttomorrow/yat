...
Case Name   : 设置参数log_rotation_size值为设置值1KB
Description :
    1.设置参数log_rotation_size值为1：gs_guc reload -N all -I all -c
    "log_rotation_size=1"
...
class Security(unittest.TestCase):
    def setUp(self):
        Logger.info('----Opengauss_Function_Guc_ErrorLog_Case0038 start----')
    ...
    def test_errorlog(self):
        ...
        self.common.equal_sql_mdg(sql_msg0, 'log_statement', 'mod',
                                  '(1 row)', flag='1')
        Logger.info('-------修改log_rotation_size的值为1kB------')
        excute_cmd1 = f'source {self.DB_ENV_PATH};' \
                      f'gs_guc reload -N all -I all -c ' \
                      f'\'log_rotation_size=1kB\''
        ...
        self.common.equal_sql_mdg(sql_msg1, 'log_rotation_size', '1kB',
                                  '(1 row)', flag='1')
        ...
        self.assertTrue(len(excute_msg3.split()) >= 3)
    ...
    def tearDown(self):
        ...
        Logger.info('--Opengauss_Function_Guc_ErrorLog_Case0038 finish--')
