...
Case Name   : 查看参数debug_print_plan的默认值为off
Description :
    1.查看参数debug_print_plan的默认值
    2.进行简单的SQL操作，查看pg日志
Expect      :
    1.查看参数debug_print_plan的默认值,结果为off
    2.进行简单的SQL操作，查看pg日志，未打印执行计划关键信息“LOG:  plan”
History     :
...
class ErrorLog(unittest.TestCase):
    ...
    def test_main(self):
        ...
        step_txt = '----step1:查看参数debug_print_plan的默认值expect：结果为off----'
        self.log.info(step_txt)
        ...
        step_txt = '----step2:进行简单的SQL操作，查看pg日志 expect:未打印执行计划关键信息----'
        self.log.info(step_txt)
