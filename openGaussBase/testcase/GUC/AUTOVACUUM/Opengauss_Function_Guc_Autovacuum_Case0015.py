...
"""
Case Type   : GUC
Case Name   : 修改autovacuum_vacuum_threshold，观察其预期结果
Description :
            1、查询autovacuum_vacuum_threshold默认值；
            show autovacuum_vacuum_threshold；
            2、修改autovacuum_vacuum_threshold为0，重启使其生效，观察预期结果；
            gs_guc set -D {cluster/dn1}  -c "autovacuum_vacuum_threshold=100"
            3、恢复默认值；
Expect      :
            1、显示默认值；
            2、修改成功并生效
...
class GuctestCase(unittest.TestCase):
    def setUp(self):
        LOGGER.info("==Guc_Autovacuum_Case0015开始执行==")
    ...
    def test_guc(self):
        ...
        LOGGER.info("修改autovacuum_vacuum_threshold为100"
                    "重启生效，期望设置成功")
    ...
    def tearDown(self):
        ...
        LOGGER.info("==Guc_Autovacuum_Case0015执行结束==")
