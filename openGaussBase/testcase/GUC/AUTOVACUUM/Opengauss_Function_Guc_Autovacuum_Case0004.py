...
Description :
            ...
            2、修改autovacuum_mode为2147483648，'test'，观察预期结果；
            gs_guc set -D {cluster/dn1}  -c "autovacuum_mode=2147483648"
...
class GucTest(unittest.TestCase):
    ...
    def test_guc(self):
        ...
        LOGGER.info("==修改autovacuum_mode为2147483648，"
                    "期望：合理报错==")
        LOGGER.info("==期望：修改失败，show参数为默认值==")
        result = COMMONSH.execute_gsguc(
            'set', self.constant.GSGUC_SUCCESS_MSG,
            "autovacuum_mode=2147483648")
