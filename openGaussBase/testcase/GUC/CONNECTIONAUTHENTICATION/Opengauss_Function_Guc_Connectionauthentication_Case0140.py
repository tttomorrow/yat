...
"""
Case Type   : GUC
Case Name   : auth_iteration_count参数使用gs_guc set设置
Description : 1、查看auth_iteration_count默认值；
              ...
              gs_guc set -D {cluster/dn1} -c "auth_iteration_count=11111"
              3、校验是否修改成功；
...
class GucTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info('==Guc_Connectionauthentication_Case0140开始==')
    ...
    def tearDown(self):
        ...
        status = COMMONSH.get_db_cluster_status()
        self.assertTrue("Normal" in status or "Degraded" in status)
        self.log.info('==Guc_Connectionauthentication_Case0140完成==')
