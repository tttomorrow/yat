...
"""
Case Type   : GUC
Case Name   : unix_socket_directory参数使用gs_guc reload设置为空值
Description :
              ...
              gs_guc reload -D {cluster/dn1} -c "unix_socket_directory=' '"
Expect      :
              1、显示默认值；
              2、创建成功；
              3、参数修改失败；
...
class GucTest(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info('==Guc_Connectionauthentication_Case0091开始==')
    ...
    def tearDown(self):
        ...
        status = COMMONSH.get_db_cluster_status()
        self.assertTrue("Degraded" in status or "Normal" in status)
        self.log.info('==Guc_Connectionauthentication_Case0091完成==')
