...
"""
Case Type   : GUC
Case Name   : unix_socket_directory参数使用gs_guc reload设置
Description : 
...
class GucTest(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info('==Guc_Connectionauthentication_Case0081开始==')
    ...
    def tearDown(self):
        ...
        self.log.info('==Guc_Connectionauthentication_Case0080完成==')
