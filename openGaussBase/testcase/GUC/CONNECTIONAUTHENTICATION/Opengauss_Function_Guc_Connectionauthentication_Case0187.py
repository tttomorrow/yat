...
"""
Case Type   : GUC
Case Name   : ssl_renegotiation_limit参数使用gs_guc reload设置
Description : 1、查看ssl_renegotiation_limit默认值；
              ...
              gs_guc reload -D {cluster/dn1} -c "ssl_renegotiation_limit=1"
              3、校验是否修改成功；
...
class GucTest(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info('==Guc_Connectionauthentication_Case0187开始==')
    ...
    def tearDown(self):
        ...
        status = COMMONSH.get_db_cluster_status()
        self.assertTrue("Normal" in status or "Degraded" in status)
        self.log.info('==Guc_Connectionauthentication_Case0187完成==')
