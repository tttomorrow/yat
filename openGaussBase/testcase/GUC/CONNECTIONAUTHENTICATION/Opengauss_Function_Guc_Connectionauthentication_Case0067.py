...
"""
Case Type   : GUC
Case Name   : sysadmin_reserved_connections参数使用gs_guc reload设置
Description : 1、查看sysadmin_reserved_connections默认值；
              ...
              2、使用设置gs_guc reload设置sysadmin_reserved_connections
...
class Deletaduit(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info('==Connectionauthentication_Case0067.py start==')
        self.rootNode = Node()
    ...
    def test_startdb(self):
        ...
        self.log.info("设置sysadmin_reserved_connections，重启使其生效")
        result = COMMONSH.execute_gsguc('reload',
                                        self.constant.GSGUC_SUCCESS_MSG,
                                        f'sysadmin_reserved_connections=11')
        self.assertTrue(result)
    ...
    def tearDown(self):
        ...
        status = COMMONSH.get_db_cluster_status()
        self.assertTrue("Degraded" in status or "Normal" in status)
        self.log.info('==Connectionauthentication_Case0067.py finish==')
