...
class Deletaduit(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info('==Connectionauthentication_Case0029.py start==')
        self.rootNode = Node()
    ...
    def tearDown(self):
        ...
        self.log.info('==Connectionauthentication_Case0029.py finish==')
