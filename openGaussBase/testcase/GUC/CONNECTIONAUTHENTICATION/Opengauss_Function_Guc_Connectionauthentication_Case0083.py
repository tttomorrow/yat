...
"""
Case Type   : GUC
Case Name   : 使用ALTER SYSTEM SET修改数据库参数unix_socket_directory
Description :
...
class GucTest(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info('==Guc_Connectionauthentication_Case0083开始==')
    ...
    def tearDown(self):
        ...
        self.log.info('==Guc_Connectionauthentication_Case0083完成==')
