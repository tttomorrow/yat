...
"""
Case Type   : GUC
Case Name   : unix_socket_directory参数使用gs_guc reload设置为问题路径
Description : 
              ...
              -c "unix_socket_directory='/home/testdn/cluster\tmp'"
...
class GucTest(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info('==Guc_Connectionauthentication_Case0085开始==')
    ...
    def tearDown(self):
        ...
        self.log.info('==Guc_Connectionauthentication_Case0084完成==')
