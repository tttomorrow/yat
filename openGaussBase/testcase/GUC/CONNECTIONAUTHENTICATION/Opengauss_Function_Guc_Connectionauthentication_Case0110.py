...
"""
Case Type   : GUC
Case Name   : unix_socket_permissions参数使用gs_guc reload设置为其他数据类型
...
class Deletaduit(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info('==Connectionauthentication_Case0110.py start==')
        self.rootNode = Node()
    ...
    def tearDown(self):
        ...
        status = COMMONSH.get_db_cluster_status()
        self.assertTrue("Degraded" in status or "Normal" in status)
        self.log.info('==Connectionauthentication_Case0110.py finish==')
