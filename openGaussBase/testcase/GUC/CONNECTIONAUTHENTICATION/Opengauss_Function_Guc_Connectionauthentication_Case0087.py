...
"""
Case Type   : GUC
Case Name   : unix_socket_directory参数使用gs_guc set设置为其他数据类型
Description : 
              ...
              gs_guc set -D {cluster/dn1} -c "unix_socket_directory=12345"
...
class GucTest(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info('==Guc_Connectionauthentication_Case0087开始==')
    ...
    def tearDown(self):
        ...
        status = COMMONSH.get_db_cluster_status()
        self.assertTrue("Degraded" in status or "Normal" in status)
        self.log.info('==Guc_Connectionauthentication_Case0087完成==')
