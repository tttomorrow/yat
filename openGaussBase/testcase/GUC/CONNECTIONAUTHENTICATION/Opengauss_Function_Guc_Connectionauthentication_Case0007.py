...
class Deletaduit(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info('==Connectionauthentication_Case0007.py start==')
        self.rootNode = Node()
    ...
    def test_startdb(self):
        ...
        self.log.info("使用aLTER SYSTEM SET设置port为非整形值")
        sql_cmd = COMMONSH.execut_db_sql(
            f'''ALTER SYSTEM set port to 'test';''')
    ...
    def tearDown(self):
        ...
        self.log.info('==Connectionauthentication_Case0007.py finish==')
