...
"""
Case Type   : GUC
Case Name   : 修改指定数据库，用户，会话级别的参数ssl_renegotiation_limit为空值
Description : 1、查看ssl_renegotiation_limit默认值；
              ...
              alter database postgres set ssl_renegotiation_limit to ' ';
              alter user env109 set ssl_renegotiation_limit to ' ';
              set ssl_renegotiation_limit to ' ';
Expect      : 1、显示默认值；
              2、参数修改成功；
History     :
"""
...
class GucTest(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info('==Guc_Connectionauthentication_Case0195开始==')
    ...
    def test_startdb(self):
        ...
        self.log.info("设置ssl_renegotiation_limit为空值，校验预期结果")
        ...
        sql_cmd2 = COMMONSH.execut_db_sql(
            f'''set ssl_renegotiation_limit to ' ';''')
    ...
    def tearDown(self):
        ...
        status = COMMONSH.get_db_cluster_status()
        self.assertTrue("Normal" in status or "Degraded" in status)
        self.log.info('==Guc_Connectionauthentication_Case0195完成==')
