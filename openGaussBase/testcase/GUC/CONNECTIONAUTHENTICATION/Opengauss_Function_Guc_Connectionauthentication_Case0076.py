...
"""
Case Type   : GUC
Case Name   : sysadmin_reserved_connections参数使用gs_guc set设置为空值
...
class Deletaduit(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info('==Connectionauthentication_Case0076.py start==')
        self.rootNode = Node()
    ...
    def tearDown(self):
        ...
        status = COMMONSH.get_db_cluster_status()
        self.assertTrue("Degraded" in status or "Normal" in status)
        self.log.info('==Connectionauthentication_Case0076.py finish==')
