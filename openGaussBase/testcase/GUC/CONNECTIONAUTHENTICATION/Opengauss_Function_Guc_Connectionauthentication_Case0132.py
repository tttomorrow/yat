...
"""
Case Type   : GUC
Case Name   : authentication_timeout参数使用gs_guc reload设置为其他数据类型
Description :
              ...
              gs_guc reload -D {cluster/dn1} -c "authentication_timeout='test'"
Expect      : 
              1、显示默认值；
              2、参数修改失败；
History     :
...
class GucTest(unittest.TestCase):
    ...
    def test_startdb(self):
        ...
        self.log.info("设置authentication_timeout为其他类型，重启生效")
