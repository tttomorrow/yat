...
"""
Case Type   : GUC
Case Name   : 修改指参数ssl_renegotiation_limit为其他数据类型
Description :
              ...
              alter database postgres set ssl_renegotiation_limit to 'test';
              alter user env109 set ssl_renegotiation_limit to 'test';
              set ssl_renegotiation_limit to 'test';
Expect      :
              1、显示默认值；
              2、参数修改失败；
History     :
...
class GucTest(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info('==Guc_Connectionauthentication_Case0192开始==')
    ...
    def test_startdb(self):
        ...
        self.log.info(
            "设置ssl_renegotiation_limit为其他数据类型，校验预期结果")
        ...
        sql_cmd2 = COMMONSH.execut_db_sql(
            f'''set ssl_renegotiation_limit to 'test';''')
    ...
    def tearDown(self):
        ...
        status = COMMONSH.get_db_cluster_status()
        self.assertTrue("Normal" in status or "Degraded" in status)
        self.log.info('==Guc_Connectionauthentication_Case0192完成==')
