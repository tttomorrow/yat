...
class GucTest(unittest.TestCase):
    def setUp(self):
        ...
        self.log.info('==Guc_FileLocation_Case0059开始==')
    ...
    def test_startdb(self):
        ...
        self.log.info("external_pid_file参数gs_guc set设置为非字符类型")
    ...
    def tearDown(self):
        ...
        status = COMMONSH.get_db_cluster_status()
        self.assertTrue("Normal" in status or "Degraded" in status)
        self.log.info('==Guc_FileLocation_Case0059完成==')
