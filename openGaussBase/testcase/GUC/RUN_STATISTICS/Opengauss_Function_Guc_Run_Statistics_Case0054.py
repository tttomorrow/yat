...
"""
Case Type   : GUC
Case Name   : 方式二修改参数stats_temp_directory为pg_stat_tmp1,设置成功并生效
Description :
    步骤1:查询stats_temp_directory默认值
    show stats_temp_directory;
    步骤2:数据库用户在dn1下创建目录pg_stat_tmp1
    mkdir dn1/pg_stat_tmp1
...
Expect      :
    ...
    步骤4:DML无报错，查询pg_stat_tmp1下有临时文件生成
    步骤5:恢复默认值成功
History     :
"""
...
class GucTestCase(unittest.TestCase):
    def setUp(self):
        LOGGER.info("==Opengauss_Function_Guc_Run_Statistics_Case0054"
                    "开始执行==")
    ...
    def test_guc(self):
        ...
        LOGGER.info("步骤2:数据库用户在dn1下创建目录pg_stat_tmp1")
