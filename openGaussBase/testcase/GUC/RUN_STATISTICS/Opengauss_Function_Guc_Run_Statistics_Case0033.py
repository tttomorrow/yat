...
"""
Case Type   : GUC
Case Name   : 修改参数track_activities设置为空 浮点数 字母 NULL等,报错不生效
Description :
    1、查询track_activities默认值
    show track_activities;
    2、修改参数track_activities设置为空 浮点数 字母 NULL等
    show track_activities;
    3、恢复默认值
Expect      :
    1、显示默认值on
...
class GucTestCase(unittest.TestCase):
    def setUp(self):
        LOGGER.info("==Opengauss_Function_Guc_Run_Statistics_Case0033"
                    "开始执行==")
    ...
    def test_guc(self):
        ...
        LOGGER.info("2、修改track_activities设置为空 浮点数 字母 NULL等")
