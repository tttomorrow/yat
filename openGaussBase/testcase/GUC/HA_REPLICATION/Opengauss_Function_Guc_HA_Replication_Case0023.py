...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数data_replicate_buffer_size为5000,
             观察预期结果
Description :
...
class HAReplication(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info(
            '---Opengauss_Function_Guc_HA_Replication_Case0023start-----')
        self.commonsh = CommonSH('PrimaryDbUser')

    def test_data_replicate_buffer_size(self):
        ...
        sql_cmd = self.commonsh.execut_db_sql(
            'show data_replicate_buffer_size;')
        self.log.info(sql_cmd)
    ...
    def tearDown(self):
        ...
        self.log.info(sql_cmd)
        self.log.info(
            '---Opengauss_Function_Guc_HA_Replication_Case0023finish---')
