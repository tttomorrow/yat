...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数catchup2normal_wait_time为0,
              观察预期结果
Description :
...
class HAReplication(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info(
            '---Opengauss_Function_Guc_HA_Replication_Case0035start-----')
    ...
    def test_catchup2normal_wait_time(self):
        ...
        self.log.info('--步骤2:修改参数值为0并重启数据库--')
    ...
    def tearDown(self):
        ...
        self.log.info(sql_cmd)
        self.log.info(
            '---Opengauss_Function_Guc_HA_Replication_Case0035finish---')
