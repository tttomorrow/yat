...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数max_standby_archive_delay为无效值,
             合理报错
Description :
...
class HAReplication(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info(
            '--Opengauss_Function_Guc_HA_Replication_Case0040start----')
    ...
    def tearDown(self):
        ...
        self.log.info(sql_cmd)
        self.log.info(
            '---Opengauss_Function_Guc_HA_Replication_Case0040执行完成-----')
