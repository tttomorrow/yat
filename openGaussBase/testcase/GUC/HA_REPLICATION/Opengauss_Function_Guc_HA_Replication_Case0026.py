...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数walsender_max_send_size为无效值,
              合理报错
Description :
...
class HAReplication(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info(
            '--Opengauss_Function_Guc_HA_Replication_Case0026start----')
        self.commonsh = CommonSH('PrimaryDbUser')
        self.expect_result = '8MB'
    ...
    def test_walsender_max_send_size(self):
        ...
        self.log.info('步骤2:修改参数值test,7, "''",2147483648,125.255')
        invalid_value = ['test', 7, "''", 2147483648, 125.255]
    ...
    def tearDown(self):
        ...
        self.log.info(sql_cmd)
        self.log.info(
            '---Opengauss_Function_Guc_HA_Replication_Case0026执行完成-----')
