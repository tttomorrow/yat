...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数max_changes_in_memory为5000,
             观察预期结果
Description :
...
class HAReplication(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info(
            '---Opengauss_Function_Guc_HA_Replication_Case0009start----')
    ...
    def tearDown(self):
        ...
        self.log.info(sql_cmd)
        self.log.info(
            '---Opengauss_Function_Guc_HA_Replication_Case0009finish------')
