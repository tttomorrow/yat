...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数wal_receiver_connect_timeout为7s,
              观察预期结果
Description :
...
class HAReplication(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info(
            '----Opengauss_Function_Guc_HA_Replication_Case0049start-----')
    ...
    def test_wal_receiver_connect_timeout(self):
        ...
        msg = self.commonsh.execute_gsguc('set',
                                          ...
                                          'wal_receiver_connect_timeout =7s')
        self.log.info(msg)
        self.assertTrue(msg)
    ...
    def tearDown(self):
        ...
        self.log.info(sql_cmd)
        self.log.info(
            '--Opengauss_Function_Guc_HA_Replication_Case0049finish----')
