...
"""
Case Type   : GUC
Case Name   : 使用gs_guc set方法设置参数max_standby_streaming_delay为4s,
              观察预期结果
Description :
...
class HAReplication(unittest.TestCase):
    def setUp(self):
        self.log = Logger()
        self.log.info(
            '---Opengauss_Function_Guc_HA_Replication_Case0041start-----')
    ...
    def tearDown(self):
        ...
        self.log.info(sql_cmd)
        self.log.info(
            '---Opengauss_Function_Guc_HA_Replication_Case0041finish---')
