...
class GucTestCase(unittest.TestCase):
    def setUp(self):
        logger.info("======Opengauss_Function_Guc_Query_Case0014开始执行======")
    ...
    def test_guc(self):
        ...
        logger.info("======步骤二：使用gs_guc reload方式修改为off,重启校验是否生效======")
    ...
    def tearDown(self):
        ...
        status = self.comsh.get_db_cluster_status()
        self.assertTrue("Degraded" in status or "Normal" in status)
        logger.info("======Opengauss_Function_Guc_Query_Case0014执行结束======")
