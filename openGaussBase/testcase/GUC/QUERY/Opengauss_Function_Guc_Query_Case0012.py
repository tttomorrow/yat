...
class Guctestcase(unittest.TestCase):
    def setUp(self):
        logger.info("==Opengauss_Function_Guc_Query_Case0012开始执行==")
    ...
    def test_guc(self):
        ...
        logger.info("方式一修改enable_instr_cpu_timer为12345，"
                    "重启使其生效，期望：设置成功")
        result = COMMONSH.execute_gsguc("set",
                                        self.constant.GSGUC_SUCCESS_MSG,
                                       "enable_instr_cpu_timer=12345")
    ...
    def tearDown(self):
        ...
        is_started = COMMONSH.get_db_cluster_status()
        self.assertTrue("Degraded" in is_started or "Normal" in is_started)
        logger.info("==Opengauss_Function_Guc_Query_Case0012执行结束==")
