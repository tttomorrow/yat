...
"""
Case Type   : 数据库系统
Case Name   : 1主1备1级联，备节点事务提交方式为remote_receive
Description :
    1.将备节点1切换为级联备
...
class RecoveryDelay(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.info("---Opengauss_Function_Recovery_Delay_Case0013 start---")
    ...
    def tearDown(self):
        ...
        self.log.info("---Opengauss_Function_Recovery_Delay_Case0013 end--")