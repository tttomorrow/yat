...
class QueryDopCase(unittest.TestCase):
    ...
    def setUp(self):
        self.logger = Logger()
        self.logger.info(
            "---Opengauss_Function_Tools_Query_Dop_Case0003开始执行---")
    ...
    def test_query_dop(self):
        step1_text = "---step1:更改query_dop参数的值为1;expect:更改参数成功---"
    ...
    def tearDown(self):
        ...
        self.logger.info(
            "---Opengauss_Function_Tools_Query_Dop_Case0003执行结束---")
