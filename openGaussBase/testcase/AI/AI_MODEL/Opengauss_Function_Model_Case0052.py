...
Case Name   : predict by使用使用model的modename为特殊字符_
Description :
    1.建表并插入数据
    2.创建model
...
class SQL(unittest.TestCase):
    ...
    def test_ai(self):
        ...
        step = 'step2:创建model,modename为特殊字符_ expect:创建成功'
        self.logger.info(step)
        ...
        step = 'step4:预测数据表数据 expect:返回预测的表数据'
        self.logger.info(step)
