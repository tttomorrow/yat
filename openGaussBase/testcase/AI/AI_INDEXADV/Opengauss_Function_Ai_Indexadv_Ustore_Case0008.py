...
Case Name   : 创建ustore表,组合使用where条件,比较运算符,right join...using,
              order by排序,逻辑运算符与范围查询in进行查询索引推荐
Description :
...
class SQL(unittest.TestCase):
    def setUp(self):
        ...
        self.common = Common()
        self.Con = Constant()
        self.table1 = 't_table_ai_indexadv_ustore_0008'
        self.table2 = 't_table_ai_indexadv1_ustore_0008'
        self.procedure1 = 'p_procedure_ustore_insert_0008'
        self.procedure2 = 'p_procedure_ustore1_insert_0008'
    ...
    def test_ai(self):
        ...
        self.assertIn('p_procedure_ustore_insert_0008', insert_data,
                      text + step)
        self.assertIn('p_procedure_ustore1_insert_0008', insert_data,
                      text + step)
